(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const u of l)if(u.type==="childList")for(const h of u.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&s(h)}).observe(document,{childList:!0,subtree:!0});function i(l){const u={};return l.integrity&&(u.integrity=l.integrity),l.referrerPolicy&&(u.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?u.credentials="include":l.crossOrigin==="anonymous"?u.credentials="omit":u.credentials="same-origin",u}function s(l){if(l.ep)return;l.ep=!0;const u=i(l);fetch(l.href,u)}})();var Rh={exports:{}},ko={};var l_;function gy(){if(l_)return ko;l_=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(s,l,u){var h=null;if(u!==void 0&&(h=""+u),l.key!==void 0&&(h=""+l.key),"key"in l){u={};for(var d in l)d!=="key"&&(u[d]=l[d])}else u=l;return l=u.ref,{$$typeof:o,type:s,key:h,ref:l!==void 0?l:null,props:u}}return ko.Fragment=t,ko.jsx=i,ko.jsxs=i,ko}var u_;function _y(){return u_||(u_=1,Rh.exports=gy()),Rh.exports}var me=_y(),Ch={exports:{}},re={};var c_;function vy(){if(c_)return re;c_=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),g=Symbol.for("react.activity"),x=Symbol.iterator;function M(z){return z===null||typeof z!="object"?null:(z=x&&z[x]||z["@@iterator"],typeof z=="function"?z:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,y={};function v(z,at,gt){this.props=z,this.context=at,this.refs=y,this.updater=gt||b}v.prototype.isReactComponent={},v.prototype.setState=function(z,at){if(typeof z!="object"&&typeof z!="function"&&z!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,z,at,"setState")},v.prototype.forceUpdate=function(z){this.updater.enqueueForceUpdate(this,z,"forceUpdate")};function U(){}U.prototype=v.prototype;function L(z,at,gt){this.props=z,this.context=at,this.refs=y,this.updater=gt||b}var D=L.prototype=new U;D.constructor=L,T(D,v.prototype),D.isPureReactComponent=!0;var B=Array.isArray;function O(){}var P={H:null,A:null,T:null,S:null},k=Object.prototype.hasOwnProperty;function C(z,at,gt){var Tt=gt.ref;return{$$typeof:o,type:z,key:at,ref:Tt!==void 0?Tt:null,props:gt}}function w(z,at){return C(z.type,at,z.props)}function V(z){return typeof z=="object"&&z!==null&&z.$$typeof===o}function J(z){var at={"=":"=0",":":"=2"};return"$"+z.replace(/[=:]/g,function(gt){return at[gt]})}var it=/\/+/g;function dt(z,at){return typeof z=="object"&&z!==null&&z.key!=null?J(""+z.key):at.toString(36)}function ct(z){switch(z.status){case"fulfilled":return z.value;case"rejected":throw z.reason;default:switch(typeof z.status=="string"?z.then(O,O):(z.status="pending",z.then(function(at){z.status==="pending"&&(z.status="fulfilled",z.value=at)},function(at){z.status==="pending"&&(z.status="rejected",z.reason=at)})),z.status){case"fulfilled":return z.value;case"rejected":throw z.reason}}throw z}function F(z,at,gt,Tt,Ft){var nt=typeof z;(nt==="undefined"||nt==="boolean")&&(z=null);var ut=!1;if(z===null)ut=!0;else switch(nt){case"bigint":case"string":case"number":ut=!0;break;case"object":switch(z.$$typeof){case o:case t:ut=!0;break;case _:return ut=z._init,F(ut(z._payload),at,gt,Tt,Ft)}}if(ut)return Ft=Ft(z),ut=Tt===""?"."+dt(z,0):Tt,B(Ft)?(gt="",ut!=null&&(gt=ut.replace(it,"$&/")+"/"),F(Ft,at,gt,"",function(It){return It})):Ft!=null&&(V(Ft)&&(Ft=w(Ft,gt+(Ft.key==null||z&&z.key===Ft.key?"":(""+Ft.key).replace(it,"$&/")+"/")+ut)),at.push(Ft)),1;ut=0;var wt=Tt===""?".":Tt+":";if(B(z))for(var Gt=0;Gt<z.length;Gt++)Tt=z[Gt],nt=wt+dt(Tt,Gt),ut+=F(Tt,at,gt,nt,Ft);else if(Gt=M(z),typeof Gt=="function")for(z=Gt.call(z),Gt=0;!(Tt=z.next()).done;)Tt=Tt.value,nt=wt+dt(Tt,Gt++),ut+=F(Tt,at,gt,nt,Ft);else if(nt==="object"){if(typeof z.then=="function")return F(ct(z),at,gt,Tt,Ft);throw at=String(z),Error("Objects are not valid as a React child (found: "+(at==="[object Object]"?"object with keys {"+Object.keys(z).join(", ")+"}":at)+"). If you meant to render a collection of children, use an array instead.")}return ut}function H(z,at,gt){if(z==null)return z;var Tt=[],Ft=0;return F(z,Tt,"","",function(nt){return at.call(gt,nt,Ft++)}),Tt}function st(z){if(z._status===-1){var at=z._result;at=at(),at.then(function(gt){(z._status===0||z._status===-1)&&(z._status=1,z._result=gt)},function(gt){(z._status===0||z._status===-1)&&(z._status=2,z._result=gt)}),z._status===-1&&(z._status=0,z._result=at)}if(z._status===1)return z._result.default;throw z._result}var yt=typeof reportError=="function"?reportError:function(z){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var at=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof z=="object"&&z!==null&&typeof z.message=="string"?String(z.message):String(z),error:z});if(!window.dispatchEvent(at))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",z);return}console.error(z)},xt={map:H,forEach:function(z,at,gt){H(z,function(){at.apply(this,arguments)},gt)},count:function(z){var at=0;return H(z,function(){at++}),at},toArray:function(z){return H(z,function(at){return at})||[]},only:function(z){if(!V(z))throw Error("React.Children.only expected to receive a single React element child.");return z}};return re.Activity=g,re.Children=xt,re.Component=v,re.Fragment=i,re.Profiler=l,re.PureComponent=L,re.StrictMode=s,re.Suspense=m,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=P,re.__COMPILER_RUNTIME={__proto__:null,c:function(z){return P.H.useMemoCache(z)}},re.cache=function(z){return function(){return z.apply(null,arguments)}},re.cacheSignal=function(){return null},re.cloneElement=function(z,at,gt){if(z==null)throw Error("The argument must be a React element, but you passed "+z+".");var Tt=T({},z.props),Ft=z.key;if(at!=null)for(nt in at.key!==void 0&&(Ft=""+at.key),at)!k.call(at,nt)||nt==="key"||nt==="__self"||nt==="__source"||nt==="ref"&&at.ref===void 0||(Tt[nt]=at[nt]);var nt=arguments.length-2;if(nt===1)Tt.children=gt;else if(1<nt){for(var ut=Array(nt),wt=0;wt<nt;wt++)ut[wt]=arguments[wt+2];Tt.children=ut}return C(z.type,Ft,Tt)},re.createContext=function(z){return z={$$typeof:h,_currentValue:z,_currentValue2:z,_threadCount:0,Provider:null,Consumer:null},z.Provider=z,z.Consumer={$$typeof:u,_context:z},z},re.createElement=function(z,at,gt){var Tt,Ft={},nt=null;if(at!=null)for(Tt in at.key!==void 0&&(nt=""+at.key),at)k.call(at,Tt)&&Tt!=="key"&&Tt!=="__self"&&Tt!=="__source"&&(Ft[Tt]=at[Tt]);var ut=arguments.length-2;if(ut===1)Ft.children=gt;else if(1<ut){for(var wt=Array(ut),Gt=0;Gt<ut;Gt++)wt[Gt]=arguments[Gt+2];Ft.children=wt}if(z&&z.defaultProps)for(Tt in ut=z.defaultProps,ut)Ft[Tt]===void 0&&(Ft[Tt]=ut[Tt]);return C(z,nt,Ft)},re.createRef=function(){return{current:null}},re.forwardRef=function(z){return{$$typeof:d,render:z}},re.isValidElement=V,re.lazy=function(z){return{$$typeof:_,_payload:{_status:-1,_result:z},_init:st}},re.memo=function(z,at){return{$$typeof:p,type:z,compare:at===void 0?null:at}},re.startTransition=function(z){var at=P.T,gt={};P.T=gt;try{var Tt=z(),Ft=P.S;Ft!==null&&Ft(gt,Tt),typeof Tt=="object"&&Tt!==null&&typeof Tt.then=="function"&&Tt.then(O,yt)}catch(nt){yt(nt)}finally{at!==null&&gt.types!==null&&(at.types=gt.types),P.T=at}},re.unstable_useCacheRefresh=function(){return P.H.useCacheRefresh()},re.use=function(z){return P.H.use(z)},re.useActionState=function(z,at,gt){return P.H.useActionState(z,at,gt)},re.useCallback=function(z,at){return P.H.useCallback(z,at)},re.useContext=function(z){return P.H.useContext(z)},re.useDebugValue=function(){},re.useDeferredValue=function(z,at){return P.H.useDeferredValue(z,at)},re.useEffect=function(z,at){return P.H.useEffect(z,at)},re.useEffectEvent=function(z){return P.H.useEffectEvent(z)},re.useId=function(){return P.H.useId()},re.useImperativeHandle=function(z,at,gt){return P.H.useImperativeHandle(z,at,gt)},re.useInsertionEffect=function(z,at){return P.H.useInsertionEffect(z,at)},re.useLayoutEffect=function(z,at){return P.H.useLayoutEffect(z,at)},re.useMemo=function(z,at){return P.H.useMemo(z,at)},re.useOptimistic=function(z,at){return P.H.useOptimistic(z,at)},re.useReducer=function(z,at,gt){return P.H.useReducer(z,at,gt)},re.useRef=function(z){return P.H.useRef(z)},re.useState=function(z){return P.H.useState(z)},re.useSyncExternalStore=function(z,at,gt){return P.H.useSyncExternalStore(z,at,gt)},re.useTransition=function(){return P.H.useTransition()},re.version="19.2.3",re}var f_;function hp(){return f_||(f_=1,Ch.exports=vy()),Ch.exports}var Jt=hp(),wh={exports:{}},Wo={},Dh={exports:{}},Uh={};var h_;function xy(){return h_||(h_=1,(function(o){function t(F,H){var st=F.length;F.push(H);t:for(;0<st;){var yt=st-1>>>1,xt=F[yt];if(0<l(xt,H))F[yt]=H,F[st]=xt,st=yt;else break t}}function i(F){return F.length===0?null:F[0]}function s(F){if(F.length===0)return null;var H=F[0],st=F.pop();if(st!==H){F[0]=st;t:for(var yt=0,xt=F.length,z=xt>>>1;yt<z;){var at=2*(yt+1)-1,gt=F[at],Tt=at+1,Ft=F[Tt];if(0>l(gt,st))Tt<xt&&0>l(Ft,gt)?(F[yt]=Ft,F[Tt]=st,yt=Tt):(F[yt]=gt,F[at]=st,yt=at);else if(Tt<xt&&0>l(Ft,st))F[yt]=Ft,F[Tt]=st,yt=Tt;else break t}}return H}function l(F,H){var st=F.sortIndex-H.sortIndex;return st!==0?st:F.id-H.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],_=1,g=null,x=3,M=!1,b=!1,T=!1,y=!1,v=typeof setTimeout=="function"?setTimeout:null,U=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;function D(F){for(var H=i(p);H!==null;){if(H.callback===null)s(p);else if(H.startTime<=F)s(p),H.sortIndex=H.expirationTime,t(m,H);else break;H=i(p)}}function B(F){if(T=!1,D(F),!b)if(i(m)!==null)b=!0,O||(O=!0,J());else{var H=i(p);H!==null&&ct(B,H.startTime-F)}}var O=!1,P=-1,k=5,C=-1;function w(){return y?!0:!(o.unstable_now()-C<k)}function V(){if(y=!1,O){var F=o.unstable_now();C=F;var H=!0;try{t:{b=!1,T&&(T=!1,U(P),P=-1),M=!0;var st=x;try{e:{for(D(F),g=i(m);g!==null&&!(g.expirationTime>F&&w());){var yt=g.callback;if(typeof yt=="function"){g.callback=null,x=g.priorityLevel;var xt=yt(g.expirationTime<=F);if(F=o.unstable_now(),typeof xt=="function"){g.callback=xt,D(F),H=!0;break e}g===i(m)&&s(m),D(F)}else s(m);g=i(m)}if(g!==null)H=!0;else{var z=i(p);z!==null&&ct(B,z.startTime-F),H=!1}}break t}finally{g=null,x=st,M=!1}H=void 0}}finally{H?J():O=!1}}}var J;if(typeof L=="function")J=function(){L(V)};else if(typeof MessageChannel<"u"){var it=new MessageChannel,dt=it.port2;it.port1.onmessage=V,J=function(){dt.postMessage(null)}}else J=function(){v(V,0)};function ct(F,H){P=v(function(){F(o.unstable_now())},H)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(F){F.callback=null},o.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):k=0<F?Math.floor(1e3/F):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(F){switch(x){case 1:case 2:case 3:var H=3;break;default:H=x}var st=x;x=H;try{return F()}finally{x=st}},o.unstable_requestPaint=function(){y=!0},o.unstable_runWithPriority=function(F,H){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var st=x;x=F;try{return H()}finally{x=st}},o.unstable_scheduleCallback=function(F,H,st){var yt=o.unstable_now();switch(typeof st=="object"&&st!==null?(st=st.delay,st=typeof st=="number"&&0<st?yt+st:yt):st=yt,F){case 1:var xt=-1;break;case 2:xt=250;break;case 5:xt=1073741823;break;case 4:xt=1e4;break;default:xt=5e3}return xt=st+xt,F={id:_++,callback:H,priorityLevel:F,startTime:st,expirationTime:xt,sortIndex:-1},st>yt?(F.sortIndex=st,t(p,F),i(m)===null&&F===i(p)&&(T?(U(P),P=-1):T=!0,ct(B,st-yt))):(F.sortIndex=xt,t(m,F),b||M||(b=!0,O||(O=!0,J()))),F},o.unstable_shouldYield=w,o.unstable_wrapCallback=function(F){var H=x;return function(){var st=x;x=H;try{return F.apply(this,arguments)}finally{x=st}}}})(Uh)),Uh}var d_;function Sy(){return d_||(d_=1,Dh.exports=xy()),Dh.exports}var Lh={exports:{}},On={};var p_;function yy(){if(p_)return On;p_=1;var o=hp();function t(m){var p="https://react.dev/errors/"+m;if(1<arguments.length){p+="?args[]="+encodeURIComponent(arguments[1]);for(var _=2;_<arguments.length;_++)p+="&args[]="+encodeURIComponent(arguments[_])}return"Minified React error #"+m+"; visit "+p+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function i(){}var s={d:{f:i,r:function(){throw Error(t(522))},D:i,C:i,L:i,m:i,X:i,S:i,M:i},p:0,findDOMNode:null},l=Symbol.for("react.portal");function u(m,p,_){var g=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:l,key:g==null?null:""+g,children:m,containerInfo:p,implementation:_}}var h=o.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function d(m,p){if(m==="font")return"";if(typeof p=="string")return p==="use-credentials"?p:""}return On.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,On.createPortal=function(m,p){var _=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!p||p.nodeType!==1&&p.nodeType!==9&&p.nodeType!==11)throw Error(t(299));return u(m,p,null,_)},On.flushSync=function(m){var p=h.T,_=s.p;try{if(h.T=null,s.p=2,m)return m()}finally{h.T=p,s.p=_,s.d.f()}},On.preconnect=function(m,p){typeof m=="string"&&(p?(p=p.crossOrigin,p=typeof p=="string"?p==="use-credentials"?p:"":void 0):p=null,s.d.C(m,p))},On.prefetchDNS=function(m){typeof m=="string"&&s.d.D(m)},On.preinit=function(m,p){if(typeof m=="string"&&p&&typeof p.as=="string"){var _=p.as,g=d(_,p.crossOrigin),x=typeof p.integrity=="string"?p.integrity:void 0,M=typeof p.fetchPriority=="string"?p.fetchPriority:void 0;_==="style"?s.d.S(m,typeof p.precedence=="string"?p.precedence:void 0,{crossOrigin:g,integrity:x,fetchPriority:M}):_==="script"&&s.d.X(m,{crossOrigin:g,integrity:x,fetchPriority:M,nonce:typeof p.nonce=="string"?p.nonce:void 0})}},On.preinitModule=function(m,p){if(typeof m=="string")if(typeof p=="object"&&p!==null){if(p.as==null||p.as==="script"){var _=d(p.as,p.crossOrigin);s.d.M(m,{crossOrigin:_,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0})}}else p==null&&s.d.M(m)},On.preload=function(m,p){if(typeof m=="string"&&typeof p=="object"&&p!==null&&typeof p.as=="string"){var _=p.as,g=d(_,p.crossOrigin);s.d.L(m,_,{crossOrigin:g,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0,type:typeof p.type=="string"?p.type:void 0,fetchPriority:typeof p.fetchPriority=="string"?p.fetchPriority:void 0,referrerPolicy:typeof p.referrerPolicy=="string"?p.referrerPolicy:void 0,imageSrcSet:typeof p.imageSrcSet=="string"?p.imageSrcSet:void 0,imageSizes:typeof p.imageSizes=="string"?p.imageSizes:void 0,media:typeof p.media=="string"?p.media:void 0})}},On.preloadModule=function(m,p){if(typeof m=="string")if(p){var _=d(p.as,p.crossOrigin);s.d.m(m,{as:typeof p.as=="string"&&p.as!=="script"?p.as:void 0,crossOrigin:_,integrity:typeof p.integrity=="string"?p.integrity:void 0})}else s.d.m(m)},On.requestFormReset=function(m){s.d.r(m)},On.unstable_batchedUpdates=function(m,p){return m(p)},On.useFormState=function(m,p,_){return h.H.useFormState(m,p,_)},On.useFormStatus=function(){return h.H.useHostTransitionStatus()},On.version="19.2.3",On}var m_;function My(){if(m_)return Lh.exports;m_=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(t){console.error(t)}}return o(),Lh.exports=yy(),Lh.exports}var g_;function Ey(){if(g_)return Wo;g_=1;var o=Sy(),t=hp(),i=My();function s(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function u(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function h(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function d(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function m(e){if(u(e)!==e)throw Error(s(188))}function p(e){var n=e.alternate;if(!n){if(n=u(e),n===null)throw Error(s(188));return n!==e?null:e}for(var a=e,r=n;;){var c=a.return;if(c===null)break;var f=c.alternate;if(f===null){if(r=c.return,r!==null){a=r;continue}break}if(c.child===f.child){for(f=c.child;f;){if(f===a)return m(c),e;if(f===r)return m(c),n;f=f.sibling}throw Error(s(188))}if(a.return!==r.return)a=c,r=f;else{for(var S=!1,A=c.child;A;){if(A===a){S=!0,a=c,r=f;break}if(A===r){S=!0,r=c,a=f;break}A=A.sibling}if(!S){for(A=f.child;A;){if(A===a){S=!0,a=f,r=c;break}if(A===r){S=!0,r=f,a=c;break}A=A.sibling}if(!S)throw Error(s(189))}}if(a.alternate!==r)throw Error(s(190))}if(a.tag!==3)throw Error(s(188));return a.stateNode.current===a?e:n}function _(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=_(e),n!==null)return n;e=e.sibling}return null}var g=Object.assign,x=Symbol.for("react.element"),M=Symbol.for("react.transitional.element"),b=Symbol.for("react.portal"),T=Symbol.for("react.fragment"),y=Symbol.for("react.strict_mode"),v=Symbol.for("react.profiler"),U=Symbol.for("react.consumer"),L=Symbol.for("react.context"),D=Symbol.for("react.forward_ref"),B=Symbol.for("react.suspense"),O=Symbol.for("react.suspense_list"),P=Symbol.for("react.memo"),k=Symbol.for("react.lazy"),C=Symbol.for("react.activity"),w=Symbol.for("react.memo_cache_sentinel"),V=Symbol.iterator;function J(e){return e===null||typeof e!="object"?null:(e=V&&e[V]||e["@@iterator"],typeof e=="function"?e:null)}var it=Symbol.for("react.client.reference");function dt(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===it?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case T:return"Fragment";case v:return"Profiler";case y:return"StrictMode";case B:return"Suspense";case O:return"SuspenseList";case C:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case b:return"Portal";case L:return e.displayName||"Context";case U:return(e._context.displayName||"Context")+".Consumer";case D:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case P:return n=e.displayName||null,n!==null?n:dt(e.type)||"Memo";case k:n=e._payload,e=e._init;try{return dt(e(n))}catch{}}return null}var ct=Array.isArray,F=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,H=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,st={pending:!1,data:null,method:null,action:null},yt=[],xt=-1;function z(e){return{current:e}}function at(e){0>xt||(e.current=yt[xt],yt[xt]=null,xt--)}function gt(e,n){xt++,yt[xt]=e.current,e.current=n}var Tt=z(null),Ft=z(null),nt=z(null),ut=z(null);function wt(e,n){switch(gt(nt,n),gt(Ft,e),gt(Tt,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?U0(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=U0(n),e=L0(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}at(Tt),gt(Tt,e)}function Gt(){at(Tt),at(Ft),at(nt)}function It(e){e.memoizedState!==null&&gt(ut,e);var n=Tt.current,a=L0(n,e.type);n!==a&&(gt(Ft,e),gt(Tt,a))}function ge(e){Ft.current===e&&(at(Tt),at(Ft)),ut.current===e&&(at(ut),Ho._currentValue=st)}var tn,Se;function _e(e){if(tn===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);tn=n&&n[1]||"",Se=-1<a.stack.indexOf(`
...
`].filter(al).join(`
`)),h=fp(h),h=dv(h,i),h=pv(h,i),d=fp(d),d=dv(d,i),d=pv(d,i),h=mv(h),d=mv(d),i.isRawShaderMaterial!==!0&&(U=`#version 300 es
...
`)+`
`+v);const L=U+y+h,D=U+v+d,B=cv(l,l.VERTEX_SHADER,L),O=cv(l,l.FRAGMENT_SHADER,D);l.attachShader(T,B),l.attachShader(T,O),i.index0AttributeName!==void 0?l.bindAttribLocation(T,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(T,0,"position"),l.linkProgram(T);function P(V){if(o.debug.checkShaderErrors){const J=l.getProgramInfoLog(T)||"",it=l.getShaderInfoLog(B)||"",dt=l.getShaderInfoLog(O)||"",ct=J.trim(),F=it.trim(),H=dt.trim();let st=!0,yt=!0;if(l.getProgramParameter(T,l.LINK_STATUS)===!1)if(st=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,T,B,O);else{const xt=hv(l,B,"vertex"),z=hv(l,O,"fragment");Re("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(T,l.VALIDATE_STATUS)+`
...
Program Info Log: `+ct+`
`+xt+`
`+z)}else ct!==""?ie("WebGLProgram: Program Info Log:",ct):(F===""||H==="")&&(yt=!1);yt&&(V.diagnostics={runnable:st,programLog:ct,vertexShader:{log:F,prefix:y},fragmentShader:{log:H,prefix:v}})}l.deleteShader(B),l.deleteShader(O),k=new oc(l,T),C=eA(l,T)}let k;this.getUniforms=function(){return k===void 0&&P(this),k};let C;this.getAttributes=function(){return C===void 0&&P(this),C};let w=i.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return w===!1&&(w=l.getProgramParameter(T,W1)),w},this.destroy=function(){s.releaseStatesOfProgram(this),l.deleteProgram(T),this.program=void 0},this.type=i.shaderType,this.name=i.shaderName,this.id=q1++,this.cacheKey=t,this.usedTimes=1,this.program=T,this.vertexShader=B,this.fragmentShader=O,this}let _A=0;class vA{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const i=t.vertexShader,s=t.fragmentShader,l=this._getShaderStage(i),u=this._getShaderStage(s),h=this._getShaderCacheForMaterial(t);return h.has(l)===!1&&(h.add(l),l.usedTimes++),h.has(u)===!1&&(h.add(u),u.usedTimes++),this}remove(t){const i=this.materialCache.get(t);for(const s of i)s.usedTimes--,s.usedTimes===0&&this.shaderCache.delete(s.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const i=this.materialCache;let s=i.get(t);return s===void 0&&(s=new Set,i.set(t,s)),s}_getShaderStage(t){const i=this.shaderCache;let s=i.get(t);return s===void 0&&(s=new xA(t),i.set(t,s)),s}}class xA{constructor(t){this.id=_A++,this.code=t,this.usedTimes=0}}function SA(o,t,i,s,l,u,h){const d=new kv,m=new vA,p=new Set,_=[],g=new Map,x=l.logarithmicDepthBuffer;let M=l.precision;const b={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function T(C){return p.add(C),C===0?"uv":`uv${C}`}function y(C,w,V,J,it){const dt=J.fog,ct=it.geometry,F=C.isMeshStandardMaterial?J.environment:null,H=(C.isMeshStandardMaterial?i:t).get(C.envMap||F),st=H&&H.mapping===_c?H.image.height:null,yt=b[C.type];C.precision!==null&&(M=l.getMaxPrecision(C.precision),M!==C.precision&&ie("WebGLProgram.getParameters:",C.precision,"not supported, using",M,"instead."));const xt=ct.morphAttributes.position||ct.morphAttributes.normal||ct.morphAttributes.color,z=xt!==void 0?xt.length:0;let at=0;ct.morphAttributes.position!==void 0&&(at=1),ct.morphAttributes.normal!==void 0&&(at=2),ct.morphAttributes.color!==void 0&&(at=3);let gt,Tt,Ft,nt;if(yt){const Ae=ki[yt];gt=Ae.vertexShader,Tt=Ae.fragmentShader}else gt=C.vertexShader,Tt=C.fragmentShader,m.update(C),Ft=m.getVertexShaderID(C),nt=m.getFragmentShaderID(C);const ut=o.getRenderTarget(),wt=o.state.buffers.depth.getReversed(),Gt=it.isInstancedMesh===!0,It=it.isBatchedMesh===!0,ge=!!C.map,tn=!!C.matcap,Se=!!H,_e=!!C.aoMap,Ue=!!C.lightMap,oe=!!C.bumpMap,en=!!C.normalMap,G=!!C.displacementMap,Qe=!!C.emissiveMap,Te=!!C.metalnessMap,Pe=!!C.roughnessMap,qt=C.anisotropy>0,N=C.clearcoat>0,E=C.dispersion>0,q=C.iridescence>0,ht=C.sheen>0,vt=C.transmission>0,lt=qt&&!!C.anisotropyMap,jt=N&&!!C.clearcoatMap,Rt=N&&!!C.clearcoatNormalMap,Xt=N&&!!C.clearcoatRoughnessMap,ne=q&&!!C.iridescenceMap,Mt=q&&!!C.iridescenceThicknessMap,Et=ht&&!!C.sheenColorMap,zt=ht&&!!C.sheenRoughnessMap,Ot=!!C.specularMap,Ct=!!C.specularColorMap,ce=!!C.specularIntensityMap,W=vt&&!!C.transmissionMap,Ut=vt&&!!C.thicknessMap,bt=!!C.gradientMap,Pt=!!C.alphaMap,St=C.alphaTest>0,_t=!!C.alphaHash,At=!!C.extensions;let ae=Zi;C.toneMapped&&(ut===null||ut.isXRRenderTarget===!0)&&(ae=o.toneMapping);const Be={shaderID:yt,shaderType:C.type,shaderName:C.name,vertexShader:gt,fragmentShader:Tt,defines:C.defines,customVertexShaderID:Ft,customFragmentShaderID:nt,isRawShaderMaterial:C.isRawShaderMaterial===!0,glslVersion:C.glslVersion,precision:M,batching:It,batchingColor:It&&it._colorsTexture!==null,instancing:Gt,instancingColor:Gt&&it.instanceColor!==null,instancingMorph:Gt&&it.morphTexture!==null,outputColorSpace:ut===null?o.outputColorSpace:ut.isXRRenderTarget===!0?ut.texture.colorSpace:qr,alphaToCoverage:!!C.alphaToCoverage,map:ge,matcap:tn,envMap:Se,envMapMode:Se&&H.mapping,envMapCubeUVHeight:st,aoMap:_e,lightMap:Ue,bumpMap:oe,normalMap:en,displacementMap:G,emissiveMap:Qe,normalMapObjectSpace:en&&C.normalMapType===Qy,normalMapTangentSpace:en&&C.normalMapType===Mp,metalnessMap:Te,roughnessMap:Pe,anisotropy:qt,anisotropyMap:lt,clearcoat:N,clearcoatMap:jt,clearcoatNormalMap:Rt,clearcoatRoughnessMap:Xt,dispersion:E,iridescence:q,iridescenceMap:ne,iridescenceThicknessMap:Mt,sheen:ht,sheenColorMap:Et,sheenRoughnessMap:zt,specularMap:Ot,specularColorMap:Ct,specularIntensityMap:ce,transmission:vt,transmissionMap:W,thicknessMap:Ut,gradientMap:bt,opaque:C.transparent===!1&&C.blending===Bs&&C.alphaToCoverage===!1,alphaMap:Pt,alphaTest:St,alphaHash:_t,combine:C.combine,mapUv:ge&&T(C.map.channel),aoMapUv:_e&&T(C.aoMap.channel),lightMapUv:Ue&&T(C.lightMap.channel),bumpMapUv:oe&&T(C.bumpMap.channel),normalMapUv:en&&T(C.normalMap.channel),displacementMapUv:G&&T(C.displacementMap.channel),emissiveMapUv:Qe&&T(C.emissiveMap.channel),metalnessMapUv:Te&&T(C.metalnessMap.channel),roughnessMapUv:Pe&&T(C.roughnessMap.channel),anisotropyMapUv:lt&&T(C.anisotropyMap.channel),clearcoatMapUv:jt&&T(C.clearcoatMap.channel),clearcoatNormalMapUv:Rt&&T(C.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Xt&&T(C.clearcoatRoughnessMap.channel),iridescenceMapUv:ne&&T(C.iridescenceMap.channel),iridescenceThicknessMapUv:Mt&&T(C.iridescenceThicknessMap.channel),sheenColorMapUv:Et&&T(C.sheenColorMap.channel),sheenRoughnessMapUv:zt&&T(C.sheenRoughnessMap.channel),specularMapUv:Ot&&T(C.specularMap.channel),specularColorMapUv:Ct&&T(C.specularColorMap.channel),specularIntensityMapUv:ce&&T(C.specularIntensityMap.channel),transmissionMapUv:W&&T(C.transmissionMap.channel),thicknessMapUv:Ut&&T(C.thicknessMap.channel),alphaMapUv:Pt&&T(C.alphaMap.channel),vertexTangents:!!ct.attributes.tangent&&(en||qt),vertexColors:C.vertexColors,vertexAlphas:C.vertexColors===!0&&!!ct.attributes.color&&ct.attributes.color.itemSize===4,pointsUvs:it.isPoints===!0&&!!ct.attributes.uv&&(ge||Pt),fog:!!dt,useFog:C.fog===!0,fogExp2:!!dt&&dt.isFogExp2,flatShading:C.flatShading===!0&&C.wireframe===!1,sizeAttenuation:C.sizeAttenuation===!0,logarithmicDepthBuffer:x,reversedDepthBuffer:wt,skinning:it.isSkinnedMesh===!0,morphTargets:ct.morphAttributes.position!==void 0,morphNormals:ct.morphAttributes.normal!==void 0,morphColors:ct.morphAttributes.color!==void 0,morphTargetsCount:z,morphTextureStride:at,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:h.numPlanes,numClipIntersection:h.numIntersection,dithering:C.dithering,shadowMapEnabled:o.shadowMap.enabled&&V.length>0,shadowMapType:o.shadowMap.type,toneMapping:ae,decodeVideoTexture:ge&&C.map.isVideoTexture===!0&&Ce.getTransfer(C.map.colorSpace)===Ve,decodeVideoTextureEmissive:Qe&&C.emissiveMap.isVideoTexture===!0&&Ce.getTransfer(C.emissiveMap.colorSpace)===Ve,premultipliedAlpha:C.premultipliedAlpha,doubleSided:C.side===Ma,flipSided:C.side===Kn,useDepthPacking:C.depthPacking>=0,depthPacking:C.depthPacking||0,index0AttributeName:C.index0AttributeName,extensionClipCullDistance:At&&C.extensions.clipCullDistance===!0&&s.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(At&&C.extensions.multiDraw===!0||It)&&s.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:s.has("KHR_parallel_shader_compile"),customProgramCacheKey:C.customProgramCacheKey()};return Be.vertexUv1s=p.has(1),Be.vertexUv2s=p.has(2),Be.vertexUv3s=p.has(3),p.clear(),Be}function v(C){const w=[];if(C.shaderID?w.push(C.shaderID):(w.push(C.customVertexShaderID),w.push(C.customFragmentShaderID)),C.defines!==void 0)for(const V in C.defines)w.push(V),w.push(C.defines[V]);return C.isRawShaderMaterial===!1&&(U(w,C),L(w,C),w.push(o.outputColorSpace)),w.push(C.customProgramCacheKey),w.join()}function U(C,w){C.push(w.precision),C.push(w.outputColorSpace),C.push(w.envMapMode),C.push(w.envMapCubeUVHeight),C.push(w.mapUv),C.push(w.alphaMapUv),C.push(w.lightMapUv),C.push(w.aoMapUv),C.push(w.bumpMapUv),C.push(w.normalMapUv),C.push(w.displacementMapUv),C.push(w.emissiveMapUv),C.push(w.metalnessMapUv),C.push(w.roughnessMapUv),C.push(w.anisotropyMapUv),C.push(w.clearcoatMapUv),C.push(w.clearcoatNormalMapUv),C.push(w.clearcoatRoughnessMapUv),C.push(w.iridescenceMapUv),C.push(w.iridescenceThicknessMapUv),C.push(w.sheenColorMapUv),C.push(w.sheenRoughnessMapUv),C.push(w.specularMapUv),C.push(w.specularColorMapUv),C.push(w.specularIntensityMapUv),C.push(w.transmissionMapUv),C.push(w.thicknessMapUv),C.push(w.combine),C.push(w.fogExp2),C.push(w.sizeAttenuation),C.push(w.morphTargetsCount),C.push(w.morphAttributeCount),C.push(w.numDirLights),C.push(w.numPointLights),C.push(w.numSpotLights),C.push(w.numSpotLightMaps),C.push(w.numHemiLights),C.push(w.numRectAreaLights),C.push(w.numDirLightShadows),C.push(w.numPointLightShadows),C.push(w.numSpotLightShadows),C.push(w.numSpotLightShadowsWithMaps),C.push(w.numLightProbes),C.push(w.shadowMapType),C.push(w.toneMapping),C.push(w.numClippingPlanes),C.push(w.numClipIntersection),C.push(w.depthPacking)}function L(C,w){d.disableAll(),w.instancing&&d.enable(0),w.instancingColor&&d.enable(1),w.instancingMorph&&d.enable(2),w.matcap&&d.enable(3),w.envMap&&d.enable(4),w.normalMapObjectSpace&&d.enable(5),w.normalMapTangentSpace&&d.enable(6),w.clearcoat&&d.enable(7),w.iridescence&&d.enable(8),w.alphaTest&&d.enable(9),w.vertexColors&&d.enable(10),w.vertexAlphas&&d.enable(11),w.vertexUv1s&&d.enable(12),w.vertexUv2s&&d.enable(13),w.vertexUv3s&&d.enable(14),w.vertexTangents&&d.enable(15),w.anisotropy&&d.enable(16),w.alphaHash&&d.enable(17),w.batching&&d.enable(18),w.dispersion&&d.enable(19),w.batchingColor&&d.enable(20),w.gradientMap&&d.enable(21),C.push(d.mask),d.disableAll(),w.fog&&d.enable(0),w.useFog&&d.enable(1),w.flatShading&&d.enable(2),w.logarithmicDepthBuffer&&d.enable(3),w.reversedDepthBuffer&&d.enable(4),w.skinning&&d.enable(5),w.morphTargets&&d.enable(6),w.morphNormals&&d.enable(7),w.morphColors&&d.enable(8),w.premultipliedAlpha&&d.enable(9),w.shadowMapEnabled&&d.enable(10),w.doubleSided&&d.enable(11),w.flipSided&&d.enable(12),w.useDepthPacking&&d.enable(13),w.dithering&&d.enable(14),w.transmission&&d.enable(15),w.sheen&&d.enable(16),w.opaque&&d.enable(17),w.pointsUvs&&d.enable(18),w.decodeVideoTexture&&d.enable(19),w.decodeVideoTextureEmissive&&d.enable(20),w.alphaToCoverage&&d.enable(21),C.push(d.mask)}function D(C){const w=b[C.type];let V;if(w){const J=ki[w];V=hc.clone(J.uniforms)}else V=C.uniforms;return V}function B(C,w){let V=g.get(w);return V!==void 0?++V.usedTimes:(V=new gA(o,w,C,u),_.push(V),g.set(w,V)),V}function O(C){if(--C.usedTimes===0){const w=_.indexOf(C);_[w]=_[_.length-1],_.pop(),g.delete(C.cacheKey),C.destroy()}}function P(C){m.remove(C)}function k(){m.dispose()}return{getParameters:y,getProgramCacheKey:v,getUniforms:D,acquireProgram:B,releaseProgram:O,releaseShaderCache:P,programs:_,dispose:k}}function yA(){let o=new WeakMap;function t(h){return o.has(h)}function i(h){let d=o.get(h);return d===void 0&&(d={},o.set(h,d)),d}function s(h){o.delete(h)}function l(h,d,m){o.get(h)[d]=m}function u(){o=new WeakMap}return{has:t,get:i,remove:s,update:l,dispose:u}}function MA(o,t){return o.groupOrder!==t.groupOrder?o.groupOrder-t.groupOrder:o.renderOrder!==t.renderOrder?o.renderOrder-t.renderOrder:o.material.id!==t.material.id?o.material.id-t.material.id:o.z!==t.z?o.z-t.z:o.id-t.id}function _v(o,t){return o.groupOrder!==t.groupOrder?o.groupOrder-t.groupOrder:o.renderOrder!==t.renderOrder?o.renderOrder-t.renderOrder:o.z!==t.z?t.z-o.z:o.id-t.id}function vv(){const o=[];let t=0;const i=[],s=[],l=[];function u(){t=0,i.length=0,s.length=0,l.length=0}function h(g,x,M,b,T,y){let v=o[t];return v===void 0?(v={id:g.id,object:g,geometry:x,material:M,groupOrder:b,renderOrder:g.renderOrder,z:T,group:y},o[t]=v):(v.id=g.id,v.object=g,v.geometry=x,v.material=M,v.groupOrder=b,v.renderOrder=g.renderOrder,v.z=T,v.group=y),t++,v}function d(g,x,M,b,T,y){const v=h(g,x,M,b,T,y);M.transmission>0?s.push(v):M.transparent===!0?l.push(v):i.push(v)}function m(g,x,M,b,T,y){const v=h(g,x,M,b,T,y);M.transmission>0?s.unshift(v):M.transparent===!0?l.unshift(v):i.unshift(v)}function p(g,x){i.length>1&&i.sort(g||MA),s.length>1&&s.sort(x||_v),l.length>1&&l.sort(x||_v)}function _(){for(let g=t,x=o.length;g<x;g++){const M=o[g];if(M.id===null)break;M.id=null,M.object=null,M.geometry=null,M.material=null,M.group=null}}return{opaque:i,transmissive:s,transparent:l,init:u,push:d,unshift:m,finish:_,sort:p}}function EA(){let o=new WeakMap;function t(s,l){const u=o.get(s);let h;return u===void 0?(h=new vv,o.set(s,[h])):l>=u.length?(h=new vv,u.push(h)):h=u[l],h}function i(){o=new WeakMap}return{get:t,dispose:i}}function bA(){const o={};return{get:function(t){if(o[t.id]!==void 0)return o[t.id];let i;switch(t.type){case"DirectionalLight":i={direction:new j,color:new le};break;case"SpotLight":i={position:new j,direction:new j,color:new le,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":i={position:new j,color:new le,distance:0,decay:0};break;case"HemisphereLight":i={direction:new j,skyColor:new le,groundColor:new le};break;case"RectAreaLight":i={color:new le,position:new j,halfWidth:new j,halfHeight:new j};break}return o[t.id]=i,i}}}function TA(){const o={};return{get:function(t){if(o[t.id]!==void 0)return o[t.id];let i;switch(t.type){case"DirectionalLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ee};break;case"SpotLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ee};break;case"PointLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ee,shadowCameraNear:1,shadowCameraFar:1e3};break}return o[t.id]=i,i}}}let AA=0;function RA(o,t){return(t.castShadow?2:0)-(o.castShadow?2:0)+(t.map?1:0)-(o.map?1:0)}function CA(o){const t=new bA,i=TA(),s={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let p=0;p<9;p++)s.probe.push(new j);const l=new j,u=new Ke,h=new Ke;function d(p){let _=0,g=0,x=0;for(let C=0;C<9;C++)s.probe[C].set(0,0,0);let M=0,b=0,T=0,y=0,v=0,U=0,L=0,D=0,B=0,O=0,P=0;p.sort(RA);for(let C=0,w=p.length;C<w;C++){const V=p[C],J=V.color,it=V.intensity,dt=V.distance;let ct=null;if(V.shadow&&V.shadow.map&&(V.shadow.map.texture.format===Wr?ct=V.shadow.map.texture:ct=V.shadow.map.depthTexture||V.shadow.map.texture),V.isAmbientLight)_+=J.r*it,g+=J.g*it,x+=J.b*it;else if(V.isLightProbe){for(let F=0;F<9;F++)s.probe[F].addScaledVector(V.sh.coefficients[F],it);P++}else if(V.isDirectionalLight){const F=t.get(V);if(F.color.copy(V.color).multiplyScalar(V.intensity),V.castShadow){const H=V.shadow,st=i.get(V);st.shadowIntensity=H.intensity,st.shadowBias=H.bias,st.shadowNormalBias=H.normalBias,st.shadowRadius=H.radius,st.shadowMapSize=H.mapSize,s.directionalShadow[M]=st,s.directionalShadowMap[M]=ct,s.directionalShadowMatrix[M]=V.shadow.matrix,U++}s.directional[M]=F,M++}else if(V.isSpotLight){const F=t.get(V);F.position.setFromMatrixPosition(V.matrixWorld),F.color.copy(J).multiplyScalar(it),F.distance=dt,F.coneCos=Math.cos(V.angle),F.penumbraCos=Math.cos(V.angle*(1-V.penumbra)),F.decay=V.decay,s.spot[T]=F;const H=V.shadow;if(V.map&&(s.spotLightMap[B]=V.map,B++,H.updateMatrices(V),V.castShadow&&O++),s.spotLightMatrix[T]=H.matrix,V.castShadow){const st=i.get(V);st.shadowIntensity=H.intensity,st.shadowBias=H.bias,st.shadowNormalBias=H.normalBias,st.shadowRadius=H.radius,st.shadowMapSize=H.mapSize,s.spotShadow[T]=st,s.spotShadowMap[T]=ct,D++}T++}else if(V.isRectAreaLight){const F=t.get(V);F.color.copy(J).multiplyScalar(it),F.halfWidth.set(V.width*.5,0,0),F.halfHeight.set(0,V.height*.5,0),s.rectArea[y]=F,y++}else if(V.isPointLight){const F=t.get(V);if(F.color.copy(V.color).multiplyScalar(V.intensity),F.distance=V.distance,F.decay=V.decay,V.castShadow){const H=V.shadow,st=i.get(V);st.shadowIntensity=H.intensity,st.shadowBias=H.bias,st.shadowNormalBias=H.normalBias,st.shadowRadius=H.radius,st.shadowMapSize=H.mapSize,st.shadowCameraNear=H.camera.near,st.shadowCameraFar=H.camera.far,s.pointShadow[b]=st,s.pointShadowMap[b]=ct,s.pointShadowMatrix[b]=V.shadow.matrix,L++}s.point[b]=F,b++}else if(V.isHemisphereLight){const F=t.get(V);F.skyColor.copy(V.color).multiplyScalar(it),F.groundColor.copy(V.groundColor).multiplyScalar(it),s.hemi[v]=F,v++}}y>0&&(o.has("OES_texture_float_linear")===!0?(s.rectAreaLTC1=Nt.LTC_FLOAT_1,s.rectAreaLTC2=Nt.LTC_FLOAT_2):(s.rectAreaLTC1=Nt.LTC_HALF_1,s.rectAreaLTC2=Nt.LTC_HALF_2)),s.ambient[0]=_,s.ambient[1]=g,s.ambient[2]=x;const k=s.hash;(k.directionalLength!==M||k.pointLength!==b||k.spotLength!==T||k.rectAreaLength!==y||k.hemiLength!==v||k.numDirectionalShadows!==U||k.numPointShadows!==L||k.numSpotShadows!==D||k.numSpotMaps!==B||k.numLightProbes!==P)&&(s.directional.length=M,s.spot.length=T,s.rectArea.length=y,s.point.length=b,s.hemi.length=v,s.directionalShadow.length=U,s.directionalShadowMap.length=U,s.pointShadow.length=L,s.pointShadowMap.length=L,s.spotShadow.length=D,s.spotShadowMap.length=D,s.directionalShadowMatrix.length=U,s.pointShadowMatrix.length=L,s.spotLightMatrix.length=D+B-O,s.spotLightMap.length=B,s.numSpotLightShadowsWithMaps=O,s.numLightProbes=P,k.directionalLength=M,k.pointLength=b,k.spotLength=T,k.rectAreaLength=y,k.hemiLength=v,k.numDirectionalShadows=U,k.numPointShadows=L,k.numSpotShadows=D,k.numSpotMaps=B,k.numLightProbes=P,s.version=AA++)}function m(p,_){let g=0,x=0,M=0,b=0,T=0;const y=_.matrixWorldInverse;for(let v=0,U=p.length;v<U;v++){const L=p[v];if(L.isDirectionalLight){const D=s.directional[g];D.direction.setFromMatrixPosition(L.matrixWorld),l.setFromMatrixPosition(L.target.matrixWorld),D.direction.sub(l),D.direction.transformDirection(y),g++}else if(L.isSpotLight){const D=s.spot[M];D.position.setFromMatrixPosition(L.matrixWorld),D.position.applyMatrix4(y),D.direction.setFromMatrixPosition(L.matrixWorld),l.setFromMatrixPosition(L.target.matrixWorld),D.direction.sub(l),D.direction.transformDirection(y),M++}else if(L.isRectAreaLight){const D=s.rectArea[b];D.position.setFromMatrixPosition(L.matrixWorld),D.position.applyMatrix4(y),h.identity(),u.copy(L.matrixWorld),u.premultiply(y),h.extractRotation(u),D.halfWidth.set(L.width*.5,0,0),D.halfHeight.set(0,L.height*.5,0),D.halfWidth.applyMatrix4(h),D.halfHeight.applyMatrix4(h),b++}else if(L.isPointLight){const D=s.point[x];D.position.setFromMatrixPosition(L.matrixWorld),D.position.applyMatrix4(y),x++}else if(L.isHemisphereLight){const D=s.hemi[T];D.direction.setFromMatrixPosition(L.matrixWorld),D.direction.transformDirection(y),T++}}}return{setup:d,setupView:m,state:s}}function xv(o){const t=new CA(o),i=[],s=[];function l(_){p.camera=_,i.length=0,s.length=0}function u(_){i.push(_)}function h(_){s.push(_)}function d(){t.setup(i)}function m(_){t.setupView(i,_)}const p={lightsArray:i,shadowsArray:s,camera:null,lights:t,transmissionRenderTarget:{}};return{init:l,state:p,setupLights:d,setupLightsView:m,pushLight:u,pushShadow:h}}function wA(o){let t=new WeakMap;function i(l,u=0){const h=t.get(l);let d;return h===void 0?(d=new xv(o),t.set(l,[d])):u>=h.length?(d=new xv(o),h.push(d)):d=h[u],d}function s(){t=new WeakMap}return{get:i,dispose:s}}const DA=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,LA=[new j(1,0,0),new j(-1,0,0),new j(0,1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1)],NA=[new j(0,-1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1),new j(0,-1,0),new j(0,-1,0)],Sv=new Ke,el=new j,dd=new j;function OA(o,t,i){let s=new Cp;const l=new ee,u=new ee,h=new rn,d=new HM,m=new VM,p={},_=i.maxTextureSize,g={[os]:Kn,[Kn]:os,[Ma]:Ma},x=new Fn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ee},radius:{value:4}},vertexShader:DA,fragmentShader:UA}),M=x.clone();M.defines.HORIZONTAL_PASS=1;const b=new Hn;b.setAttribute("position",new zi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const T=new ci(b,x),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ec;let v=this.type;this.render=function(O,P,k){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||O.length===0)return;O.type===Cy&&(ie("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),O.type=ec);const C=o.getRenderTarget(),w=o.getActiveCubeFace(),V=o.getActiveMipmapLevel(),J=o.state;J.setBlending(ji),J.buffers.depth.getReversed()===!0?J.buffers.color.setClear(0,0,0,0):J.buffers.color.setClear(1,1,1,1),J.buffers.depth.setTest(!0),J.setScissorTest(!1);const it=v!==this.type;it&&P.traverse(function(dt){dt.material&&(Array.isArray(dt.material)?dt.material.forEach(ct=>ct.needsUpdate=!0):dt.material.needsUpdate=!0)});for(let dt=0,ct=O.length;dt<ct;dt++){const F=O[dt],H=F.shadow;if(H===void 0){ie("WebGLShadowMap:",F,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;l.copy(H.mapSize);const st=H.getFrameExtents();if(l.multiply(st),u.copy(H.mapSize),(l.x>_||l.y>_)&&(l.x>_&&(u.x=Math.floor(_/st.x),l.x=u.x*st.x,H.mapSize.x=u.x),l.y>_&&(u.y=Math.floor(_/st.y),l.y=u.y*st.y,H.mapSize.y=u.y)),H.map===null||it===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===nl){if(F.isPointLight){ie("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new Qn(l.x,l.y,{format:Wr,type:ui,minFilter:Bn,magFilter:Bn,generateMipmaps:!1}),H.map.texture.name=F.name+".shadowMap",H.map.depthTexture=new cl(l.x,l.y,qi),H.map.depthTexture.name=F.name+".shadowMapDepth",H.map.depthTexture.format=Ta,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Ln,H.map.depthTexture.magFilter=Ln}else{F.isPointLight?(H.map=new Qv(l.x),H.map.depthTexture=new BM(l.x,Ki)):(H.map=new Qn(l.x,l.y),H.map.depthTexture=new cl(l.x,l.y,Ki)),H.map.depthTexture.name=F.name+".shadowMap",H.map.depthTexture.format=Ta;const xt=o.state.buffers.depth.getReversed();this.type===ec?(H.map.depthTexture.compareFunction=xt?bp:Ep,H.map.depthTexture.minFilter=Bn,H.map.depthTexture.magFilter=Bn):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Ln,H.map.depthTexture.magFilter=Ln)}H.camera.updateProjectionMatrix()}const yt=H.map.isWebGLCubeRenderTarget?6:1;for(let xt=0;xt<yt;xt++){if(H.map.isWebGLCubeRenderTarget)o.setRenderTarget(H.map,xt),o.clear();else{xt===0&&(o.setRenderTarget(H.map),o.clear());const z=H.getViewport(xt);h.set(u.x*z.x,u.y*z.y,u.x*z.z,u.y*z.w),J.viewport(h)}if(F.isPointLight){const z=H.camera,at=H.matrix,gt=F.distance||z.far;gt!==z.far&&(z.far=gt,z.updateProjectionMatrix()),el.setFromMatrixPosition(F.matrixWorld),z.position.copy(el),dd.copy(z.position),dd.add(LA[xt]),z.up.copy(NA[xt]),z.lookAt(dd),z.updateMatrixWorld(),at.makeTranslation(-el.x,-el.y,-el.z),Sv.multiplyMatrices(z.projectionMatrix,z.matrixWorldInverse),H._frustum.setFromProjectionMatrix(Sv,z.coordinateSystem,z.reversedDepth)}else H.updateMatrices(F);s=H.getFrustum(),D(P,k,H.camera,F,this.type)}H.isPointLightShadow!==!0&&this.type===nl&&U(H,k),H.needsUpdate=!1}v=this.type,y.needsUpdate=!1,o.setRenderTarget(C,w,V)};function U(O,P){const k=t.update(T);x.defines.VSM_SAMPLES!==O.blurSamples&&(x.defines.VSM_SAMPLES=O.blurSamples,M.defines.VSM_SAMPLES=O.blurSamples,x.needsUpdate=!0,M.needsUpdate=!0),O.mapPass===null&&(O.mapPass=new Qn(l.x,l.y,{format:Wr,type:ui})),x.uniforms.shadow_pass.value=O.map.depthTexture,x.uniforms.resolution.value=O.mapSize,x.uniforms.radius.value=O.radius,o.setRenderTarget(O.mapPass),o.clear(),o.renderBufferDirect(P,null,k,x,T,null),M.uniforms.shadow_pass.value=O.mapPass.texture,M.uniforms.resolution.value=O.mapSize,M.uniforms.radius.value=O.radius,o.setRenderTarget(O.map),o.clear(),o.renderBufferDirect(P,null,k,M,T,null)}function L(O,P,k,C){let w=null;const V=k.isPointLight===!0?O.customDistanceMaterial:O.customDepthMaterial;if(V!==void 0)w=V;else if(w=k.isPointLight===!0?m:d,o.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const J=w.uuid,it=P.uuid;let dt=p[J];dt===void 0&&(dt={},p[J]=dt);let ct=dt[it];ct===void 0&&(ct=w.clone(),dt[it]=ct,P.addEventListener("dispose",B)),w=ct}if(w.visible=P.visible,w.wireframe=P.wireframe,C===nl?w.side=P.shadowSide!==null?P.shadowSide:P.side:w.side=P.shadowSide!==null?P.shadowSide:g[P.side],w.alphaMap=P.alphaMap,w.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,w.map=P.map,w.clipShadows=P.clipShadows,w.clippingPlanes=P.clippingPlanes,w.clipIntersection=P.clipIntersection,w.displacementMap=P.displacementMap,w.displacementScale=P.displacementScale,w.displacementBias=P.displacementBias,w.wireframeLinewidth=P.wireframeLinewidth,w.linewidth=P.linewidth,k.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const J=o.properties.get(w);J.light=k}return w}function D(O,P,k,C,w){if(O.visible===!1)return;if(O.layers.test(P.layers)&&(O.isMesh||O.isLine||O.isPoints)&&(O.castShadow||O.receiveShadow&&w===nl)&&(!O.frustumCulled||s.intersectsObject(O))){O.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,O.matrixWorld);const it=t.update(O),dt=O.material;if(Array.isArray(dt)){const ct=it.groups;for(let F=0,H=ct.length;F<H;F++){const st=ct[F],yt=dt[st.materialIndex];if(yt&&yt.visible){const xt=L(O,yt,C,w);O.onBeforeShadow(o,O,P,k,it,xt,st),o.renderBufferDirect(k,null,it,xt,O,st),O.onAfterShadow(o,O,P,k,it,xt,st)}}}else if(dt.visible){const ct=L(O,dt,C,w);O.onBeforeShadow(o,O,P,k,it,ct,null),o.renderBufferDirect(k,null,it,ct,O,null),O.onAfterShadow(o,O,P,k,it,ct,null)}}const J=O.children;for(let it=0,dt=J.length;it<dt;it++)D(J[it],P,k,C,w)}function B(O){O.target.removeEventListener("dispose",B);for(const k in p){const C=p[k],w=O.target.uuid;w in C&&(C[w].dispose(),delete C[w])}}}const PA={[vd]:xd,[Sd]:Ed,[yd]:bd,[Xr]:Md,[xd]:vd,[Ed]:Sd,[bd]:yd,[Md]:Xr};function zA(o,t){function i(){let W=!1;const Ut=new rn;let bt=null;const Pt=new rn(0,0,0,0);return{setMask:function(St){bt!==St&&!W&&(o.colorMask(St,St,St,St),bt=St)},setLocked:function(St){W=St},setClear:function(St,_t,At,ae,Be){Be===!0&&(St*=ae,_t*=ae,At*=ae),Ut.set(St,_t,At,ae),Pt.equals(Ut)===!1&&(o.clearColor(St,_t,At,ae),Pt.copy(Ut))},reset:function(){W=!1,bt=null,Pt.set(-1,0,0,0)}}}function s(){let W=!1,Ut=!1,bt=null,Pt=null,St=null;return{setReversed:function(_t){if(Ut!==_t){const At=t.get("EXT_clip_control");_t?At.clipControlEXT(At.LOWER_LEFT_EXT,At.ZERO_TO_ONE_EXT):At.clipControlEXT(At.LOWER_LEFT_EXT,At.NEGATIVE_ONE_TO_ONE_EXT),Ut=_t;const ae=St;St=null,this.setClear(ae)}},getReversed:function(){return Ut},setTest:function(_t){_t?ut(o.DEPTH_TEST):wt(o.DEPTH_TEST)},setMask:function(_t){bt!==_t&&!W&&(o.depthMask(_t),bt=_t)},setFunc:function(_t){if(Ut&&(_t=PA[_t]),Pt!==_t){switch(_t){case vd:o.depthFunc(o.NEVER);break;case xd:o.depthFunc(o.ALWAYS);break;case Sd:o.depthFunc(o.LESS);break;case Xr:o.depthFunc(o.LEQUAL);break;case yd:o.depthFunc(o.EQUAL);break;case Md:o.depthFunc(o.GEQUAL);break;case Ed:o.depthFunc(o.GREATER);break;case bd:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Pt=_t}},setLocked:function(_t){W=_t},setClear:function(_t){St!==_t&&(Ut&&(_t=1-_t),o.clearDepth(_t),St=_t)},reset:function(){W=!1,bt=null,Pt=null,St=null,Ut=!1}}}function l(){let W=!1,Ut=null,bt=null,Pt=null,St=null,_t=null,At=null,ae=null,Be=null;return{setTest:function(Ae){W||(Ae?ut(o.STENCIL_TEST):wt(o.STENCIL_TEST))},setMask:function(Ae){Ut!==Ae&&!W&&(o.stencilMask(Ae),Ut=Ae)},setFunc:function(Ae,Nn,Ai){(bt!==Ae||Pt!==Nn||St!==Ai)&&(o.stencilFunc(Ae,Nn,Ai),bt=Ae,Pt=Nn,St=Ai)},setOp:function(Ae,Nn,Ai){(_t!==Ae||At!==Nn||ae!==Ai)&&(o.stencilOp(Ae,Nn,Ai),_t=Ae,At=Nn,ae=Ai)},setLocked:function(Ae){W=Ae},setClear:function(Ae){Be!==Ae&&(o.clearStencil(Ae),Be=Ae)},reset:function(){W=!1,Ut=null,bt=null,Pt=null,St=null,_t=null,At=null,ae=null,Be=null}}}const u=new i,h=new s,d=new l,m=new WeakMap,p=new WeakMap;let _={},g={},x=new WeakMap,M=[],b=null,T=!1,y=null,v=null,U=null,L=null,D=null,B=null,O=null,P=new le(0,0,0),k=0,C=!1,w=null,V=null,J=null,it=null,dt=null;const ct=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let F=!1,H=0;const st=o.getParameter(o.VERSION);st.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(st)[1]),F=H>=1):st.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(st)[1]),F=H>=2);let yt=null,xt={};const z=o.getParameter(o.SCISSOR_BOX),at=o.getParameter(o.VIEWPORT),gt=new rn().fromArray(z),Tt=new rn().fromArray(at);function Ft(W,Ut,bt,Pt){const St=new Uint8Array(4),_t=o.createTexture();o.bindTexture(W,_t),o.texParameteri(W,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(W,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let At=0;At<bt;At++)W===o.TEXTURE_3D||W===o.TEXTURE_2D_ARRAY?o.texImage3D(Ut,0,o.RGBA,1,1,Pt,0,o.RGBA,o.UNSIGNED_BYTE,St):o.texImage2D(Ut+At,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,St);return _t}const nt={};nt[o.TEXTURE_2D]=Ft(o.TEXTURE_2D,o.TEXTURE_2D,1),nt[o.TEXTURE_CUBE_MAP]=Ft(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),nt[o.TEXTURE_2D_ARRAY]=Ft(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),nt[o.TEXTURE_3D]=Ft(o.TEXTURE_3D,o.TEXTURE_3D,1,1),u.setClear(0,0,0,1),h.setClear(1),d.setClear(0),ut(o.DEPTH_TEST),h.setFunc(Xr),oe(!1),en(v_),ut(o.CULL_FACE),_e(ji);function ut(W){_[W]!==!0&&(o.enable(W),_[W]=!0)}function wt(W){_[W]!==!1&&(o.disable(W),_[W]=!1)}function Gt(W,Ut){return g[W]!==Ut?(o.bindFramebuffer(W,Ut),g[W]=Ut,W===o.DRAW_FRAMEBUFFER&&(g[o.FRAMEBUFFER]=Ut),W===o.FRAMEBUFFER&&(g[o.DRAW_FRAMEBUFFER]=Ut),!0):!1}function It(W,Ut){let bt=M,Pt=!1;if(W){bt=x.get(Ut),bt===void 0&&(bt=[],x.set(Ut,bt));const St=W.textures;if(bt.length!==St.length||bt[0]!==o.COLOR_ATTACHMENT0){for(let _t=0,At=St.length;_t<At;_t++)bt[_t]=o.COLOR_ATTACHMENT0+_t;bt.length=St.length,Pt=!0}}else bt[0]!==o.BACK&&(bt[0]=o.BACK,Pt=!0);Pt&&o.drawBuffers(bt)}function ge(W){return b!==W?(o.useProgram(W),b=W,!0):!1}const tn={[Ns]:o.FUNC_ADD,[Dy]:o.FUNC_SUBTRACT,[Uy]:o.FUNC_REVERSE_SUBTRACT};tn[Ly]=o.MIN,tn[Ny]=o.MAX;const Se={[Oy]:o.ZERO,[Py]:o.ONE,[zy]:o.SRC_COLOR,[gd]:o.SRC_ALPHA,[Gy]:o.SRC_ALPHA_SATURATE,[Hy]:o.DST_COLOR,[Fy]:o.DST_ALPHA,[By]:o.ONE_MINUS_SRC_COLOR,[_d]:o.ONE_MINUS_SRC_ALPHA,[Vy]:o.ONE_MINUS_DST_COLOR,[Iy]:o.ONE_MINUS_DST_ALPHA,[Xy]:o.CONSTANT_COLOR,[ky]:o.ONE_MINUS_CONSTANT_COLOR,[Wy]:o.CONSTANT_ALPHA,[qy]:o.ONE_MINUS_CONSTANT_ALPHA};function _e(W,Ut,bt,Pt,St,_t,At,ae,Be,Ae){if(W===ji){T===!0&&(wt(o.BLEND),T=!1);return}if(T===!1&&(ut(o.BLEND),T=!0),W!==wy){if(W!==y||Ae!==C){if((v!==Ns||D!==Ns)&&(o.blendEquation(o.FUNC_ADD),v=Ns,D=Ns),Ae)switch(W){case Bs:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case md:o.blendFunc(o.ONE,o.ONE);break;case x_:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case S_:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:Re("WebGLState: Invalid blending: ",W);break}else switch(W){case Bs:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case md:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case x_:Re("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case S_:Re("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Re("WebGLState: Invalid blending: ",W);break}U=null,L=null,B=null,O=null,P.set(0,0,0),k=0,y=W,C=Ae}return}St=St||Ut,_t=_t||bt,At=At||Pt,(Ut!==v||St!==D)&&(o.blendEquationSeparate(tn[Ut],tn[St]),v=Ut,D=St),(bt!==U||Pt!==L||_t!==B||At!==O)&&(o.blendFuncSeparate(Se[bt],Se[Pt],Se[_t],Se[At]),U=bt,L=Pt,B=_t,O=At),(ae.equals(P)===!1||Be!==k)&&(o.blendColor(ae.r,ae.g,ae.b,Be),P.copy(ae),k=Be),y=W,C=!1}function Ue(W,Ut){W.side===Ma?wt(o.CULL_FACE):ut(o.CULL_FACE);let bt=W.side===Kn;Ut&&(bt=!bt),oe(bt),W.blending===Bs&&W.transparent===!1?_e(ji):_e(W.blending,W.blendEquation,W.blendSrc,W.blendDst,W.blendEquationAlpha,W.blendSrcAlpha,W.blendDstAlpha,W.blendColor,W.blendAlpha,W.premultipliedAlpha),h.setFunc(W.depthFunc),h.setTest(W.depthTest),h.setMask(W.depthWrite),u.setMask(W.colorWrite);const Pt=W.stencilWrite;d.setTest(Pt),Pt&&(d.setMask(W.stencilWriteMask),d.setFunc(W.stencilFunc,W.stencilRef,W.stencilFuncMask),d.setOp(W.stencilFail,W.stencilZFail,W.stencilZPass)),Qe(W.polygonOffset,W.polygonOffsetFactor,W.polygonOffsetUnits),W.alphaToCoverage===!0?ut(o.SAMPLE_ALPHA_TO_COVERAGE):wt(o.SAMPLE_ALPHA_TO_COVERAGE)}function oe(W){w!==W&&(W?o.frontFace(o.CW):o.frontFace(o.CCW),w=W)}function en(W){W!==Ay?(ut(o.CULL_FACE),W!==V&&(W===v_?o.cullFace(o.BACK):W===Ry?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):wt(o.CULL_FACE),V=W}function G(W){W!==J&&(F&&o.lineWidth(W),J=W)}function Qe(W,Ut,bt){W?(ut(o.POLYGON_OFFSET_FILL),(it!==Ut||dt!==bt)&&(o.polygonOffset(Ut,bt),it=Ut,dt=bt)):wt(o.POLYGON_OFFSET_FILL)}function Te(W){W?ut(o.SCISSOR_TEST):wt(o.SCISSOR_TEST)}function Pe(W){W===void 0&&(W=o.TEXTURE0+ct-1),yt!==W&&(o.activeTexture(W),yt=W)}function qt(W,Ut,bt){bt===void 0&&(yt===null?bt=o.TEXTURE0+ct-1:bt=yt);let Pt=xt[bt];Pt===void 0&&(Pt={type:void 0,texture:void 0},xt[bt]=Pt),(Pt.type!==W||Pt.texture!==Ut)&&(yt!==bt&&(o.activeTexture(bt),yt=bt),o.bindTexture(W,Ut||nt[W]),Pt.type=W,Pt.texture=Ut)}function N(){const W=xt[yt];W!==void 0&&W.type!==void 0&&(o.bindTexture(W.type,null),W.type=void 0,W.texture=void 0)}function E(){try{o.compressedTexImage2D(...arguments)}catch(W){Re("WebGLState:",W)}}function q(){try{o.compressedTexImage3D(...arguments)}catch(W){Re("WebGLState:",W)}}function ht(){try{o.texSubImage2D(...arguments)}catch(W){Re("WebGLState:",W)}}function vt(){try{o.texSubImage3D(...arguments)}catch(W){Re("WebGLState:",W)}}function lt(){try{o.compressedTexSubImage2D(...arguments)}catch(W){Re("WebGLState:",W)}}function jt(){try{o.compressedTexSubImage3D(...arguments)}catch(W){Re("WebGLState:",W)}}function Rt(){try{o.texStorage2D(...arguments)}catch(W){Re("WebGLState:",W)}}function Xt(){try{o.texStorage3D(...arguments)}catch(W){Re("WebGLState:",W)}}function ne(){try{o.texImage2D(...arguments)}catch(W){Re("WebGLState:",W)}}function Mt(){try{o.texImage3D(...arguments)}catch(W){Re("WebGLState:",W)}}function Et(W){gt.equals(W)===!1&&(o.scissor(W.x,W.y,W.z,W.w),gt.copy(W))}function zt(W){Tt.equals(W)===!1&&(o.viewport(W.x,W.y,W.z,W.w),Tt.copy(W))}function Ot(W,Ut){let bt=p.get(Ut);bt===void 0&&(bt=new WeakMap,p.set(Ut,bt));let Pt=bt.get(W);Pt===void 0&&(Pt=o.getUniformBlockIndex(Ut,W.name),bt.set(W,Pt))}function Ct(W,Ut){const Pt=p.get(Ut).get(W);m.get(Ut)!==Pt&&(o.uniformBlockBinding(Ut,Pt,W.__bindingPointIndex),m.set(Ut,Pt))}function ce(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),h.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),_={},yt=null,xt={},g={},x=new WeakMap,M=[],b=null,T=!1,y=null,v=null,U=null,L=null,D=null,B=null,O=null,P=new le(0,0,0),k=0,C=!1,w=null,V=null,J=null,it=null,dt=null,gt.set(0,0,o.canvas.width,o.canvas.height),Tt.set(0,0,o.canvas.width,o.canvas.height),u.reset(),h.reset(),d.reset()}return{buffers:{color:u,depth:h,stencil:d},enable:ut,disable:wt,bindFramebuffer:Gt,drawBuffers:It,useProgram:ge,setBlending:_e,setMaterial:Ue,setFlipSided:oe,setCullFace:en,setLineWidth:G,setPolygonOffset:Qe,setScissorTest:Te,activeTexture:Pe,bindTexture:qt,unbindTexture:N,compressedTexImage2D:E,compressedTexImage3D:q,texImage2D:ne,texImage3D:Mt,updateUBOMapping:Ot,uniformBlockBinding:Ct,texStorage2D:Rt,texStorage3D:Xt,texSubImage2D:ht,texSubImage3D:vt,compressedTexSubImage2D:lt,compressedTexSubImage3D:jt,scissor:Et,viewport:zt,reset:ce}}function BA(o,t,i,s,l,u,h){const d=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new ee,_=new WeakMap;let g;const x=new WeakMap;let M=!1;try{M=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(N,E){return M?new OffscreenCanvas(N,E):ll("canvas")}function T(N,E,q){let ht=1;const vt=qt(N);if((vt.width>q||vt.height>q)&&(ht=q/Math.max(vt.width,vt.height)),ht<1)if(typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&N instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&N instanceof ImageBitmap||typeof VideoFrame<"u"&&N instanceof VideoFrame){const lt=Math.floor(ht*vt.width),jt=Math.floor(ht*vt.height);g===void 0&&(g=b(lt,jt));const Rt=E?b(lt,jt):g;return Rt.width=lt,Rt.height=jt,Rt.getContext("2d").drawImage(N,0,0,lt,jt),ie("WebGLRenderer: Texture has been resized from ("+vt.width+"x"+vt.height+") to ("+lt+"x"+jt+")."),Rt}else return"data"in N&&ie("WebGLRenderer: Image in DataTexture is too big ("+vt.width+"x"+vt.height+")."),N;return N}function y(N){return N.generateMipmaps}function v(N){o.generateMipmap(N)}function U(N){return N.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:N.isWebGL3DRenderTarget?o.TEXTURE_3D:N.isWebGLArrayRenderTarget||N.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function L(N,E,q,ht,vt=!1){if(N!==null){if(o[N]!==void 0)return o[N];ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+N+"'")}let lt=E;if(E===o.RED&&(q===o.FLOAT&&(lt=o.R32F),q===o.HALF_FLOAT&&(lt=o.R16F),q===o.UNSIGNED_BYTE&&(lt=o.R8)),E===o.RED_INTEGER&&(q===o.UNSIGNED_BYTE&&(lt=o.R8UI),q===o.UNSIGNED_SHORT&&(lt=o.R16UI),q===o.UNSIGNED_INT&&(lt=o.R32UI),q===o.BYTE&&(lt=o.R8I),q===o.SHORT&&(lt=o.R16I),q===o.INT&&(lt=o.R32I)),E===o.RG&&(q===o.FLOAT&&(lt=o.RG32F),q===o.HALF_FLOAT&&(lt=o.RG16F),q===o.UNSIGNED_BYTE&&(lt=o.RG8)),E===o.RG_INTEGER&&(q===o.UNSIGNED_BYTE&&(lt=o.RG8UI),q===o.UNSIGNED_SHORT&&(lt=o.RG16UI),q===o.UNSIGNED_INT&&(lt=o.RG32UI),q===o.BYTE&&(lt=o.RG8I),q===o.SHORT&&(lt=o.RG16I),q===o.INT&&(lt=o.RG32I)),E===o.RGB_INTEGER&&(q===o.UNSIGNED_BYTE&&(lt=o.RGB8UI),q===o.UNSIGNED_SHORT&&(lt=o.RGB16UI),q===o.UNSIGNED_INT&&(lt=o.RGB32UI),q===o.BYTE&&(lt=o.RGB8I),q===o.SHORT&&(lt=o.RGB16I),q===o.INT&&(lt=o.RGB32I)),E===o.RGBA_INTEGER&&(q===o.UNSIGNED_BYTE&&(lt=o.RGBA8UI),q===o.UNSIGNED_SHORT&&(lt=o.RGBA16UI),q===o.UNSIGNED_INT&&(lt=o.RGBA32UI),q===o.BYTE&&(lt=o.RGBA8I),q===o.SHORT&&(lt=o.RGBA16I),q===o.INT&&(lt=o.RGBA32I)),E===o.RGB&&(q===o.UNSIGNED_INT_5_9_9_9_REV&&(lt=o.RGB9_E5),q===o.UNSIGNED_INT_10F_11F_11F_REV&&(lt=o.R11F_G11F_B10F)),E===o.RGBA){const jt=vt?uc:Ce.getTransfer(ht);q===o.FLOAT&&(lt=o.RGBA32F),q===o.HALF_FLOAT&&(lt=o.RGBA16F),q===o.UNSIGNED_BYTE&&(lt=jt===Ve?o.SRGB8_ALPHA8:o.RGBA8),q===o.UNSIGNED_SHORT_4_4_4_4&&(lt=o.RGBA4),q===o.UNSIGNED_SHORT_5_5_5_1&&(lt=o.RGB5_A1)}return(lt===o.R16F||lt===o.R32F||lt===o.RG16F||lt===o.RG32F||lt===o.RGBA16F||lt===o.RGBA32F)&&t.get("EXT_color_buffer_float"),lt}function D(N,E){let q;return N?E===null||E===Ki||E===ol?q=o.DEPTH24_STENCIL8:E===qi?q=o.DEPTH32F_STENCIL8:E===rl&&(q=o.DEPTH24_STENCIL8,ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Ki||E===ol?q=o.DEPTH_COMPONENT24:E===qi?q=o.DEPTH_COMPONENT32F:E===rl&&(q=o.DEPTH_COMPONENT16),q}function B(N,E){return y(N)===!0||N.isFramebufferTexture&&N.minFilter!==Ln&&N.minFilter!==Bn?Math.log2(Math.max(E.width,E.height))+1:N.mipmaps!==void 0&&N.mipmaps.length>0?N.mipmaps.length:N.isCompressedTexture&&Array.isArray(N.image)?E.mipmaps.length:1}function O(N){const E=N.target;E.removeEventListener("dispose",O),k(E),E.isVideoTexture&&_.delete(E)}function P(N){const E=N.target;E.removeEventListener("dispose",P),w(E)}function k(N){const E=s.get(N);if(E.__webglInit===void 0)return;const q=N.source,ht=x.get(q);if(ht){const vt=ht[E.__cacheKey];vt.usedTimes--,vt.usedTimes===0&&C(N),Object.keys(ht).length===0&&x.delete(q)}s.remove(N)}function C(N){const E=s.get(N);o.deleteTexture(E.__webglTexture);const q=N.source,ht=x.get(q);delete ht[E.__cacheKey],h.memory.textures--}function w(N){const E=s.get(N);if(N.depthTexture&&(N.depthTexture.dispose(),s.remove(N.depthTexture)),N.isWebGLCubeRenderTarget)for(let ht=0;ht<6;ht++){if(Array.isArray(E.__webglFramebuffer[ht]))for(let vt=0;vt<E.__webglFramebuffer[ht].length;vt++)o.deleteFramebuffer(E.__webglFramebuffer[ht][vt]);else o.deleteFramebuffer(E.__webglFramebuffer[ht]);E.__webglDepthbuffer&&o.deleteRenderbuffer(E.__webglDepthbuffer[ht])}else{if(Array.isArray(E.__webglFramebuffer))for(let ht=0;ht<E.__webglFramebuffer.length;ht++)o.deleteFramebuffer(E.__webglFramebuffer[ht]);else o.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&o.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&o.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ht=0;ht<E.__webglColorRenderbuffer.length;ht++)E.__webglColorRenderbuffer[ht]&&o.deleteRenderbuffer(E.__webglColorRenderbuffer[ht]);E.__webglDepthRenderbuffer&&o.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const q=N.textures;for(let ht=0,vt=q.length;ht<vt;ht++){const lt=s.get(q[ht]);lt.__webglTexture&&(o.deleteTexture(lt.__webglTexture),h.memory.textures--),s.remove(q[ht])}s.remove(N)}let V=0;function J(){V=0}function it(){const N=V;return N>=l.maxTextures&&ie("WebGLTextures: Trying to use "+N+" texture units while this GPU supports only "+l.maxTextures),V+=1,N}function dt(N){const E=[];return E.push(N.wrapS),E.push(N.wrapT),E.push(N.wrapR||0),E.push(N.magFilter),E.push(N.minFilter),E.push(N.anisotropy),E.push(N.internalFormat),E.push(N.format),E.push(N.type),E.push(N.generateMipmaps),E.push(N.premultiplyAlpha),E.push(N.flipY),E.push(N.unpackAlignment),E.push(N.colorSpace),E.join()}function ct(N,E){const q=s.get(N);if(N.isVideoTexture&&Te(N),N.isRenderTargetTexture===!1&&N.isExternalTexture!==!0&&N.version>0&&q.__version!==N.version){const ht=N.image;if(ht===null)ie("WebGLRenderer: Texture marked for update but no image data found.");else if(ht.complete===!1)ie("WebGLRenderer: Texture marked for update but image is incomplete");else{nt(q,N,E);return}}else N.isExternalTexture&&(q.__webglTexture=N.sourceTexture?N.sourceTexture:null);i.bindTexture(o.TEXTURE_2D,q.__webglTexture,o.TEXTURE0+E)}function F(N,E){const q=s.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&q.__version!==N.version){nt(q,N,E);return}else N.isExternalTexture&&(q.__webglTexture=N.sourceTexture?N.sourceTexture:null);i.bindTexture(o.TEXTURE_2D_ARRAY,q.__webglTexture,o.TEXTURE0+E)}function H(N,E){const q=s.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&q.__version!==N.version){nt(q,N,E);return}i.bindTexture(o.TEXTURE_3D,q.__webglTexture,o.TEXTURE0+E)}function st(N,E){const q=s.get(N);if(N.isCubeDepthTexture!==!0&&N.version>0&&q.__version!==N.version){ut(q,N,E);return}i.bindTexture(o.TEXTURE_CUBE_MAP,q.__webglTexture,o.TEXTURE0+E)}const yt={[Rd]:o.REPEAT,[Ea]:o.CLAMP_TO_EDGE,[Cd]:o.MIRRORED_REPEAT},xt={[Ln]:o.NEAREST,[Zy]:o.NEAREST_MIPMAP_NEAREST,[Ru]:o.NEAREST_MIPMAP_LINEAR,[Bn]:o.LINEAR,[Nh]:o.LINEAR_MIPMAP_NEAREST,[Ps]:o.LINEAR_MIPMAP_LINEAR},z={[Jy]:o.NEVER,[iM]:o.ALWAYS,[$y]:o.LESS,[Ep]:o.LEQUAL,[tM]:o.EQUAL,[bp]:o.GEQUAL,[eM]:o.GREATER,[nM]:o.NOTEQUAL};function at(N,E){if(E.type===qi&&t.has("OES_texture_float_linear")===!1&&(E.magFilter===Bn||E.magFilter===Nh||E.magFilter===Ru||E.magFilter===Ps||E.minFilter===Bn||E.minFilter===Nh||E.minFilter===Ru||E.minFilter===Ps)&&ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(N,o.TEXTURE_WRAP_S,yt[E.wrapS]),o.texParameteri(N,o.TEXTURE_WRAP_T,yt[E.wrapT]),(N===o.TEXTURE_3D||N===o.TEXTURE_2D_ARRAY)&&o.texParameteri(N,o.TEXTURE_WRAP_R,yt[E.wrapR]),o.texParameteri(N,o.TEXTURE_MAG_FILTER,xt[E.magFilter]),o.texParameteri(N,o.TEXTURE_MIN_FILTER,xt[E.minFilter]),E.compareFunction&&(o.texParameteri(N,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(N,o.TEXTURE_COMPARE_FUNC,z[E.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Ln||E.minFilter!==Ru&&E.minFilter!==Ps||E.type===qi&&t.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||s.get(E).__currentAnisotropy){const q=t.get("EXT_texture_filter_anisotropic");o.texParameterf(N,q.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),s.get(E).__currentAnisotropy=E.anisotropy}}}function gt(N,E){let q=!1;N.__webglInit===void 0&&(N.__webglInit=!0,E.addEventListener("dispose",O));const ht=E.source;let vt=x.get(ht);vt===void 0&&(vt={},x.set(ht,vt));const lt=dt(E);if(lt!==N.__cacheKey){vt[lt]===void 0&&(vt[lt]={texture:o.createTexture(),usedTimes:0},h.memory.textures++,q=!0),vt[lt].usedTimes++;const jt=vt[N.__cacheKey];jt!==void 0&&(vt[N.__cacheKey].usedTimes--,jt.usedTimes===0&&C(E)),N.__cacheKey=lt,N.__webglTexture=vt[lt].texture}return q}function Tt(N,E,q){return Math.floor(Math.floor(N/q)/E)}function Ft(N,E,q,ht){const lt=N.updateRanges;if(lt.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,E.width,E.height,q,ht,E.data);else{lt.sort((Mt,Et)=>Mt.start-Et.start);let jt=0;for(let Mt=1;Mt<lt.length;Mt++){const Et=lt[jt],zt=lt[Mt],Ot=Et.start+Et.count,Ct=Tt(zt.start,E.width,4),ce=Tt(Et.start,E.width,4);zt.start<=Ot+1&&Ct===ce&&Tt(zt.start+zt.count-1,E.width,4)===Ct?Et.count=Math.max(Et.count,zt.start+zt.count-Et.start):(++jt,lt[jt]=zt)}lt.length=jt+1;const Rt=o.getParameter(o.UNPACK_ROW_LENGTH),Xt=o.getParameter(o.UNPACK_SKIP_PIXELS),ne=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,E.width);for(let Mt=0,Et=lt.length;Mt<Et;Mt++){const zt=lt[Mt],Ot=Math.floor(zt.start/4),Ct=Math.ceil(zt.count/4),ce=Ot%E.width,W=Math.floor(Ot/E.width),Ut=Ct,bt=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,ce),o.pixelStorei(o.UNPACK_SKIP_ROWS,W),i.texSubImage2D(o.TEXTURE_2D,0,ce,W,Ut,bt,q,ht,E.data)}N.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,Rt),o.pixelStorei(o.UNPACK_SKIP_PIXELS,Xt),o.pixelStorei(o.UNPACK_SKIP_ROWS,ne)}}function nt(N,E,q){let ht=o.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ht=o.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ht=o.TEXTURE_3D);const vt=gt(N,E),lt=E.source;i.bindTexture(ht,N.__webglTexture,o.TEXTURE0+q);const jt=s.get(lt);if(lt.version!==jt.__version||vt===!0){i.activeTexture(o.TEXTURE0+q);const Rt=Ce.getPrimaries(Ce.workingColorSpace),Xt=E.colorSpace===as?null:Ce.getPrimaries(E.colorSpace),ne=E.colorSpace===as||Rt===Xt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,E.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,E.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,ne);let Mt=T(E.image,!1,l.maxTextureSize);Mt=Pe(E,Mt);const Et=u.convert(E.format,E.colorSpace),zt=u.convert(E.type);let Ot=L(E.internalFormat,Et,zt,E.colorSpace,E.isVideoTexture);at(ht,E);let Ct;const ce=E.mipmaps,W=E.isVideoTexture!==!0,Ut=jt.__version===void 0||vt===!0,bt=lt.dataReady,Pt=B(E,Mt);if(E.isDepthTexture)Ot=D(E.format===zs,E.type),Ut&&(W?i.texStorage2D(o.TEXTURE_2D,1,Ot,Mt.width,Mt.height):i.texImage2D(o.TEXTURE_2D,0,Ot,Mt.width,Mt.height,0,Et,zt,null));else if(E.isDataTexture)if(ce.length>0){W&&Ut&&i.texStorage2D(o.TEXTURE_2D,Pt,Ot,ce[0].width,ce[0].height);for(let St=0,_t=ce.length;St<_t;St++)Ct=ce[St],W?bt&&i.texSubImage2D(o.TEXTURE_2D,St,0,0,Ct.width,Ct.height,Et,zt,Ct.data):i.texImage2D(o.TEXTURE_2D,St,Ot,Ct.width,Ct.height,0,Et,zt,Ct.data);E.generateMipmaps=!1}else W?(Ut&&i.texStorage2D(o.TEXTURE_2D,Pt,Ot,Mt.width,Mt.height),bt&&Ft(E,Mt,Et,zt)):i.texImage2D(o.TEXTURE_2D,0,Ot,Mt.width,Mt.height,0,Et,zt,Mt.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){W&&Ut&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Pt,Ot,ce[0].width,ce[0].height,Mt.depth);for(let St=0,_t=ce.length;St<_t;St++)if(Ct=ce[St],E.format!==Pi)if(Et!==null)if(W){if(bt)if(E.layerUpdates.size>0){const At=Q_(Ct.width,Ct.height,E.format,E.type);for(const ae of E.layerUpdates){const Be=Ct.data.subarray(ae*At/Ct.data.BYTES_PER_ELEMENT,(ae+1)*At/Ct.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,St,0,0,ae,Ct.width,Ct.height,1,Et,Be)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,St,0,0,0,Ct.width,Ct.height,Mt.depth,Et,Ct.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,St,Ot,Ct.width,Ct.height,Mt.depth,0,Ct.data,0,0);else ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else W?bt&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,St,0,0,0,Ct.width,Ct.height,Mt.depth,Et,zt,Ct.data):i.texImage3D(o.TEXTURE_2D_ARRAY,St,Ot,Ct.width,Ct.height,Mt.depth,0,Et,zt,Ct.data)}else{W&&Ut&&i.texStorage2D(o.TEXTURE_2D,Pt,Ot,ce[0].width,ce[0].height);for(let St=0,_t=ce.length;St<_t;St++)Ct=ce[St],E.format!==Pi?Et!==null?W?bt&&i.compressedTexSubImage2D(o.TEXTURE_2D,St,0,0,Ct.width,Ct.height,Et,Ct.data):i.compressedTexImage2D(o.TEXTURE_2D,St,Ot,Ct.width,Ct.height,0,Ct.data):ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):W?bt&&i.texSubImage2D(o.TEXTURE_2D,St,0,0,Ct.width,Ct.height,Et,zt,Ct.data):i.texImage2D(o.TEXTURE_2D,St,Ot,Ct.width,Ct.height,0,Et,zt,Ct.data)}else if(E.isDataArrayTexture)if(W){if(Ut&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Pt,Ot,Mt.width,Mt.height,Mt.depth),bt)if(E.layerUpdates.size>0){const St=Q_(Mt.width,Mt.height,E.format,E.type);for(const _t of E.layerUpdates){const At=Mt.data.subarray(_t*St/Mt.data.BYTES_PER_ELEMENT,(_t+1)*St/Mt.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,_t,Mt.width,Mt.height,1,Et,zt,At)}E.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,Mt.width,Mt.height,Mt.depth,Et,zt,Mt.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,Ot,Mt.width,Mt.height,Mt.depth,0,Et,zt,Mt.data);else if(E.isData3DTexture)W?(Ut&&i.texStorage3D(o.TEXTURE_3D,Pt,Ot,Mt.width,Mt.height,Mt.depth),bt&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,Mt.width,Mt.height,Mt.depth,Et,zt,Mt.data)):i.texImage3D(o.TEXTURE_3D,0,Ot,Mt.width,Mt.height,Mt.depth,0,Et,zt,Mt.data);else if(E.isFramebufferTexture){if(Ut)if(W)i.texStorage2D(o.TEXTURE_2D,Pt,Ot,Mt.width,Mt.height);else{let St=Mt.width,_t=Mt.height;for(let At=0;At<Pt;At++)i.texImage2D(o.TEXTURE_2D,At,Ot,St,_t,0,Et,zt,null),St>>=1,_t>>=1}}else if(ce.length>0){if(W&&Ut){const St=qt(ce[0]);i.texStorage2D(o.TEXTURE_2D,Pt,Ot,St.width,St.height)}for(let St=0,_t=ce.length;St<_t;St++)Ct=ce[St],W?bt&&i.texSubImage2D(o.TEXTURE_2D,St,0,0,Et,zt,Ct):i.texImage2D(o.TEXTURE_2D,St,Ot,Et,zt,Ct);E.generateMipmaps=!1}else if(W){if(Ut){const St=qt(Mt);i.texStorage2D(o.TEXTURE_2D,Pt,Ot,St.width,St.height)}bt&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,Et,zt,Mt)}else i.texImage2D(o.TEXTURE_2D,0,Ot,Et,zt,Mt);y(E)&&v(ht),jt.__version=lt.version,E.onUpdate&&E.onUpdate(E)}N.__version=E.version}function ut(N,E,q){if(E.image.length!==6)return;const ht=gt(N,E),vt=E.source;i.bindTexture(o.TEXTURE_CUBE_MAP,N.__webglTexture,o.TEXTURE0+q);const lt=s.get(vt);if(vt.version!==lt.__version||ht===!0){i.activeTexture(o.TEXTURE0+q);const jt=Ce.getPrimaries(Ce.workingColorSpace),Rt=E.colorSpace===as?null:Ce.getPrimaries(E.colorSpace),Xt=E.colorSpace===as||jt===Rt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,E.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,E.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xt);const ne=E.isCompressedTexture||E.image[0].isCompressedTexture,Mt=E.image[0]&&E.image[0].isDataTexture,Et=[];for(let _t=0;_t<6;_t++)!ne&&!Mt?Et[_t]=T(E.image[_t],!0,l.maxCubemapSize):Et[_t]=Mt?E.image[_t].image:E.image[_t],Et[_t]=Pe(E,Et[_t]);const zt=Et[0],Ot=u.convert(E.format,E.colorSpace),Ct=u.convert(E.type),ce=L(E.internalFormat,Ot,Ct,E.colorSpace),W=E.isVideoTexture!==!0,Ut=lt.__version===void 0||ht===!0,bt=vt.dataReady;let Pt=B(E,zt);at(o.TEXTURE_CUBE_MAP,E);let St;if(ne){W&&Ut&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Pt,ce,zt.width,zt.height);for(let _t=0;_t<6;_t++){St=Et[_t].mipmaps;for(let At=0;At<St.length;At++){const ae=St[At];E.format!==Pi?Ot!==null?W?bt&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,At,0,0,ae.width,ae.height,Ot,ae.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,At,ce,ae.width,ae.height,0,ae.data):ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):W?bt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,At,0,0,ae.width,ae.height,Ot,Ct,ae.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,At,ce,ae.width,ae.height,0,Ot,Ct,ae.data)}}}else{if(St=E.mipmaps,W&&Ut){St.length>0&&Pt++;const _t=qt(Et[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,Pt,ce,_t.width,_t.height)}for(let _t=0;_t<6;_t++)if(Mt){W?bt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,Et[_t].width,Et[_t].height,Ot,Ct,Et[_t].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,ce,Et[_t].width,Et[_t].height,0,Ot,Ct,Et[_t].data);for(let At=0;At<St.length;At++){const Be=St[At].image[_t].image;W?bt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,At+1,0,0,Be.width,Be.height,Ot,Ct,Be.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,At+1,ce,Be.width,Be.height,0,Ot,Ct,Be.data)}}else{W?bt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,Ot,Ct,Et[_t]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,ce,Ot,Ct,Et[_t]);for(let At=0;At<St.length;At++){const ae=St[At];W?bt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,At+1,0,0,Ot,Ct,ae.image[_t]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,At+1,ce,Ot,Ct,ae.image[_t])}}}y(E)&&v(o.TEXTURE_CUBE_MAP),lt.__version=vt.version,E.onUpdate&&E.onUpdate(E)}N.__version=E.version}function wt(N,E,q,ht,vt,lt){const jt=u.convert(q.format,q.colorSpace),Rt=u.convert(q.type),Xt=L(q.internalFormat,jt,Rt,q.colorSpace),ne=s.get(E),Mt=s.get(q);if(Mt.__renderTarget=E,!ne.__hasExternalTextures){const Et=Math.max(1,E.width>>lt),zt=Math.max(1,E.height>>lt);vt===o.TEXTURE_3D||vt===o.TEXTURE_2D_ARRAY?i.texImage3D(vt,lt,Xt,Et,zt,E.depth,0,jt,Rt,null):i.texImage2D(vt,lt,Xt,Et,zt,0,jt,Rt,null)}i.bindFramebuffer(o.FRAMEBUFFER,N),Qe(E)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,ht,vt,Mt.__webglTexture,0,G(E)):(vt===o.TEXTURE_2D||vt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&vt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,ht,vt,Mt.__webglTexture,lt),i.bindFramebuffer(o.FRAMEBUFFER,null)}function Gt(N,E,q){if(o.bindRenderbuffer(o.RENDERBUFFER,N),E.depthBuffer){const ht=E.depthTexture,vt=ht&&ht.isDepthTexture?ht.type:null,lt=D(E.stencilBuffer,vt),jt=E.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;Qe(E)?d.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,G(E),lt,E.width,E.height):q?o.renderbufferStorageMultisample(o.RENDERBUFFER,G(E),lt,E.width,E.height):o.renderbufferStorage(o.RENDERBUFFER,lt,E.width,E.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,jt,o.RENDERBUFFER,N)}else{const ht=E.textures;for(let vt=0;vt<ht.length;vt++){const lt=ht[vt],jt=u.convert(lt.format,lt.colorSpace),Rt=u.convert(lt.type),Xt=L(lt.internalFormat,jt,Rt,lt.colorSpace);Qe(E)?d.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,G(E),Xt,E.width,E.height):q?o.renderbufferStorageMultisample(o.RENDERBUFFER,G(E),Xt,E.width,E.height):o.renderbufferStorage(o.RENDERBUFFER,Xt,E.width,E.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function It(N,E,q){const ht=E.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(o.FRAMEBUFFER,N),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const vt=s.get(E.depthTexture);if(vt.__renderTarget=E,(!vt.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),ht){if(vt.__webglInit===void 0&&(vt.__webglInit=!0,E.depthTexture.addEventListener("dispose",O)),vt.__webglTexture===void 0){vt.__webglTexture=o.createTexture(),i.bindTexture(o.TEXTURE_CUBE_MAP,vt.__webglTexture),at(o.TEXTURE_CUBE_MAP,E.depthTexture);const ne=u.convert(E.depthTexture.format),Mt=u.convert(E.depthTexture.type);let Et;E.depthTexture.format===Ta?Et=o.DEPTH_COMPONENT24:E.depthTexture.format===zs&&(Et=o.DEPTH24_STENCIL8);for(let zt=0;zt<6;zt++)o.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+zt,0,Et,E.width,E.height,0,ne,Mt,null)}}else ct(E.depthTexture,0);const lt=vt.__webglTexture,jt=G(E),Rt=ht?o.TEXTURE_CUBE_MAP_POSITIVE_X+q:o.TEXTURE_2D,Xt=E.depthTexture.format===zs?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;if(E.depthTexture.format===Ta)Qe(E)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,Xt,Rt,lt,0,jt):o.framebufferTexture2D(o.FRAMEBUFFER,Xt,Rt,lt,0);else if(E.depthTexture.format===zs)Qe(E)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,Xt,Rt,lt,0,jt):o.framebufferTexture2D(o.FRAMEBUFFER,Xt,Rt,lt,0);else throw new Error("Unknown depthTexture format")}function ge(N){const E=s.get(N),q=N.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==N.depthTexture){const ht=N.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ht){const vt=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ht.removeEventListener("dispose",vt)};ht.addEventListener("dispose",vt),E.__depthDisposeCallback=vt}E.__boundDepthTexture=ht}if(N.depthTexture&&!E.__autoAllocateDepthBuffer)if(q)for(let ht=0;ht<6;ht++)It(E.__webglFramebuffer[ht],N,ht);else{const ht=N.texture.mipmaps;ht&&ht.length>0?It(E.__webglFramebuffer[0],N,0):It(E.__webglFramebuffer,N,0)}else if(q){E.__webglDepthbuffer=[];for(let ht=0;ht<6;ht++)if(i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer[ht]),E.__webglDepthbuffer[ht]===void 0)E.__webglDepthbuffer[ht]=o.createRenderbuffer(),Gt(E.__webglDepthbuffer[ht],N,!1);else{const vt=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,lt=E.__webglDepthbuffer[ht];o.bindRenderbuffer(o.RENDERBUFFER,lt),o.framebufferRenderbuffer(o.FRAMEBUFFER,vt,o.RENDERBUFFER,lt)}}else{const ht=N.texture.mipmaps;if(ht&&ht.length>0?i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=o.createRenderbuffer(),Gt(E.__webglDepthbuffer,N,!1);else{const vt=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,lt=E.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,lt),o.framebufferRenderbuffer(o.FRAMEBUFFER,vt,o.RENDERBUFFER,lt)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function tn(N,E,q){const ht=s.get(N);E!==void 0&&wt(ht.__webglFramebuffer,N,N.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),q!==void 0&&ge(N)}function Se(N){const E=N.texture,q=s.get(N),ht=s.get(E);N.addEventListener("dispose",P);const vt=N.textures,lt=N.isWebGLCubeRenderTarget===!0,jt=vt.length>1;if(jt||(ht.__webglTexture===void 0&&(ht.__webglTexture=o.createTexture()),ht.__version=E.version,h.memory.textures++),lt){q.__webglFramebuffer=[];for(let Rt=0;Rt<6;Rt++)if(E.mipmaps&&E.mipmaps.length>0){q.__webglFramebuffer[Rt]=[];for(let Xt=0;Xt<E.mipmaps.length;Xt++)q.__webglFramebuffer[Rt][Xt]=o.createFramebuffer()}else q.__webglFramebuffer[Rt]=o.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){q.__webglFramebuffer=[];for(let Rt=0;Rt<E.mipmaps.length;Rt++)q.__webglFramebuffer[Rt]=o.createFramebuffer()}else q.__webglFramebuffer=o.createFramebuffer();if(jt)for(let Rt=0,Xt=vt.length;Rt<Xt;Rt++){const ne=s.get(vt[Rt]);ne.__webglTexture===void 0&&(ne.__webglTexture=o.createTexture(),h.memory.textures++)}if(N.samples>0&&Qe(N)===!1){q.__webglMultisampledFramebuffer=o.createFramebuffer(),q.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,q.__webglMultisampledFramebuffer);for(let Rt=0;Rt<vt.length;Rt++){const Xt=vt[Rt];q.__webglColorRenderbuffer[Rt]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,q.__webglColorRenderbuffer[Rt]);const ne=u.convert(Xt.format,Xt.colorSpace),Mt=u.convert(Xt.type),Et=L(Xt.internalFormat,ne,Mt,Xt.colorSpace,N.isXRRenderTarget===!0),zt=G(N);o.renderbufferStorageMultisample(o.RENDERBUFFER,zt,Et,N.width,N.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Rt,o.RENDERBUFFER,q.__webglColorRenderbuffer[Rt])}o.bindRenderbuffer(o.RENDERBUFFER,null),N.depthBuffer&&(q.__webglDepthRenderbuffer=o.createRenderbuffer(),Gt(q.__webglDepthRenderbuffer,N,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(lt){i.bindTexture(o.TEXTURE_CUBE_MAP,ht.__webglTexture),at(o.TEXTURE_CUBE_MAP,E);for(let Rt=0;Rt<6;Rt++)if(E.mipmaps&&E.mipmaps.length>0)for(let Xt=0;Xt<E.mipmaps.length;Xt++)wt(q.__webglFramebuffer[Rt][Xt],N,E,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,Xt);else wt(q.__webglFramebuffer[Rt],N,E,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,0);y(E)&&v(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(jt){for(let Rt=0,Xt=vt.length;Rt<Xt;Rt++){const ne=vt[Rt],Mt=s.get(ne);let Et=o.TEXTURE_2D;(N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Et=N.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Et,Mt.__webglTexture),at(Et,ne),wt(q.__webglFramebuffer,N,ne,o.COLOR_ATTACHMENT0+Rt,Et,0),y(ne)&&v(Et)}i.unbindTexture()}else{let Rt=o.TEXTURE_2D;if((N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Rt=N.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Rt,ht.__webglTexture),at(Rt,E),E.mipmaps&&E.mipmaps.length>0)for(let Xt=0;Xt<E.mipmaps.length;Xt++)wt(q.__webglFramebuffer[Xt],N,E,o.COLOR_ATTACHMENT0,Rt,Xt);else wt(q.__webglFramebuffer,N,E,o.COLOR_ATTACHMENT0,Rt,0);y(E)&&v(Rt),i.unbindTexture()}N.depthBuffer&&ge(N)}function _e(N){const E=N.textures;for(let q=0,ht=E.length;q<ht;q++){const vt=E[q];if(y(vt)){const lt=U(N),jt=s.get(vt).__webglTexture;i.bindTexture(lt,jt),v(lt),i.unbindTexture()}}}const Ue=[],oe=[];function en(N){if(N.samples>0){if(Qe(N)===!1){const E=N.textures,q=N.width,ht=N.height;let vt=o.COLOR_BUFFER_BIT;const lt=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,jt=s.get(N),Rt=E.length>1;if(Rt)for(let ne=0;ne<E.length;ne++)i.bindFramebuffer(o.FRAMEBUFFER,jt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+ne,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,jt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+ne,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,jt.__webglMultisampledFramebuffer);const Xt=N.texture.mipmaps;Xt&&Xt.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,jt.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,jt.__webglFramebuffer);for(let ne=0;ne<E.length;ne++){if(N.resolveDepthBuffer&&(N.depthBuffer&&(vt|=o.DEPTH_BUFFER_BIT),N.stencilBuffer&&N.resolveStencilBuffer&&(vt|=o.STENCIL_BUFFER_BIT)),Rt){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,jt.__webglColorRenderbuffer[ne]);const Mt=s.get(E[ne]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,Mt,0)}o.blitFramebuffer(0,0,q,ht,0,0,q,ht,vt,o.NEAREST),m===!0&&(Ue.length=0,oe.length=0,Ue.push(o.COLOR_ATTACHMENT0+ne),N.depthBuffer&&N.resolveDepthBuffer===!1&&(Ue.push(lt),oe.push(lt),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,oe)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,Ue))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Rt)for(let ne=0;ne<E.length;ne++){i.bindFramebuffer(o.FRAMEBUFFER,jt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+ne,o.RENDERBUFFER,jt.__webglColorRenderbuffer[ne]);const Mt=s.get(E[ne]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,jt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+ne,o.TEXTURE_2D,Mt,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,jt.__webglMultisampledFramebuffer)}else if(N.depthBuffer&&N.resolveDepthBuffer===!1&&m){const E=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[E])}}}function G(N){return Math.min(l.maxSamples,N.samples)}function Qe(N){const E=s.get(N);return N.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function Te(N){const E=h.render.frame;_.get(N)!==E&&(_.set(N,E),N.update())}function Pe(N,E){const q=N.colorSpace,ht=N.format,vt=N.type;return N.isCompressedTexture===!0||N.isVideoTexture===!0||q!==qr&&q!==as&&(Ce.getTransfer(q)===Ve?(ht!==Pi||vt!==li)&&ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Re("WebGLTextures: Unsupported texture color space:",q)),E}function qt(N){return typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement?(p.width=N.naturalWidth||N.width,p.height=N.naturalHeight||N.height):typeof VideoFrame<"u"&&N instanceof VideoFrame?(p.width=N.displayWidth,p.height=N.displayHeight):(p.width=N.width,p.height=N.height),p}this.allocateTextureUnit=it,this.resetTextureUnits=J,this.setTexture2D=ct,this.setTexture2DArray=F,this.setTexture3D=H,this.setTextureCube=st,this.rebindTextures=tn,this.setupRenderTarget=Se,this.updateRenderTargetMipmap=_e,this.updateMultisampleRenderTarget=en,this.setupDepthRenderbuffer=ge,this.setupFrameBufferTexture=wt,this.useMultisampledRTT=Qe,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function FA(o,t){function i(s,l=as){let u;const h=Ce.getTransfer(l);if(s===li)return o.UNSIGNED_BYTE;if(s===_p)return o.UNSIGNED_SHORT_4_4_4_4;if(s===vp)return o.UNSIGNED_SHORT_5_5_5_1;if(s===Bv)return o.UNSIGNED_INT_5_9_9_9_REV;if(s===Fv)return o.UNSIGNED_INT_10F_11F_11F_REV;if(s===Pv)return o.BYTE;if(s===zv)return o.SHORT;if(s===rl)return o.UNSIGNED_SHORT;if(s===gp)return o.INT;if(s===Ki)return o.UNSIGNED_INT;if(s===qi)return o.FLOAT;if(s===ui)return o.HALF_FLOAT;if(s===Iv)return o.ALPHA;if(s===Hv)return o.RGB;if(s===Pi)return o.RGBA;if(s===Ta)return o.DEPTH_COMPONENT;if(s===zs)return o.DEPTH_STENCIL;if(s===Vv)return o.RED;if(s===xp)return o.RED_INTEGER;if(s===Wr)return o.RG;if(s===Sp)return o.RG_INTEGER;if(s===yp)return o.RGBA_INTEGER;if(s===nc||s===ic||s===ac||s===sc)if(h===Ve)if(u=t.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(s===nc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===ic)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===ac)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===sc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=t.get("WEBGL_compressed_texture_s3tc"),u!==null){if(s===nc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===ic)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===ac)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===sc)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===wd||s===Dd||s===Ud||s===Ld)if(u=t.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(s===wd)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Dd)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Ud)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Ld)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Nd||s===Od||s===Pd||s===zd||s===Bd||s===Fd||s===Id)if(u=t.get("WEBGL_compressed_texture_etc"),u!==null){if(s===Nd||s===Od)return h===Ve?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(s===Pd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC;if(s===zd)return u.COMPRESSED_R11_EAC;if(s===Bd)return u.COMPRESSED_SIGNED_R11_EAC;if(s===Fd)return u.COMPRESSED_RG11_EAC;if(s===Id)return u.COMPRESSED_SIGNED_RG11_EAC}else return null;if(s===Hd||s===Vd||s===Gd||s===Xd||s===kd||s===Wd||s===qd||s===Yd||s===jd||s===Zd||s===Kd||s===Qd||s===Jd||s===$d)if(u=t.get("WEBGL_compressed_texture_astc"),u!==null){if(s===Hd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Vd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Gd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Xd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===kd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Wd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===qd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Yd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===jd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Zd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Kd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Qd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Jd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===$d)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===tp||s===ep||s===np)if(u=t.get("EXT_texture_compression_bptc"),u!==null){if(s===tp)return h===Ve?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===ep)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===np)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===ip||s===ap||s===sp||s===rp)if(u=t.get("EXT_texture_compression_rgtc"),u!==null){if(s===ip)return u.COMPRESSED_RED_RGTC1_EXT;if(s===ap)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===sp)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===rp)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===ol?o.UNSIGNED_INT_24_8:o[s]!==void 0?o[s]:null}return{convert:i}}const IA=`
void main() {
...
}`;class VA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i){if(this.texture===null){const s=new tx(t.texture);(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,s=new Fn({vertexShader:IA,fragmentShader:HA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new ci(new vc(20,20),s)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class GA extends Zr{constructor(t,i){super();const s=this;let l=null,u=1,h=null,d="local-floor",m=1,p=null,_=null,g=null,x=null,M=null,b=null;const T=typeof XRWebGLBinding<"u",y=new VA,v={},U=i.getContextAttributes();let L=null,D=null;const B=[],O=[],P=new ee;let k=null;const C=new Ei;C.viewport=new rn;const w=new Ei;w.viewport=new rn;const V=[C,w],J=new JM;let it=null,dt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(nt){let ut=B[nt];return ut===void 0&&(ut=new nd,B[nt]=ut),ut.getTargetRaySpace()},this.getControllerGrip=function(nt){let ut=B[nt];return ut===void 0&&(ut=new nd,B[nt]=ut),ut.getGripSpace()},this.getHand=function(nt){let ut=B[nt];return ut===void 0&&(ut=new nd,B[nt]=ut),ut.getHandSpace()};function ct(nt){const ut=O.indexOf(nt.inputSource);if(ut===-1)return;const wt=B[ut];wt!==void 0&&(wt.update(nt.inputSource,nt.frame,p||h),wt.dispatchEvent({type:nt.type,data:nt.inputSource}))}function F(){l.removeEventListener("select",ct),l.removeEventListener("selectstart",ct),l.removeEventListener("selectend",ct),l.removeEventListener("squeeze",ct),l.removeEventListener("squeezestart",ct),l.removeEventListener("squeezeend",ct),l.removeEventListener("end",F),l.removeEventListener("inputsourceschange",H);for(let nt=0;nt<B.length;nt++){const ut=O[nt];ut!==null&&(O[nt]=null,B[nt].disconnect(ut))}it=null,dt=null,y.reset();for(const nt in v)delete v[nt];t.setRenderTarget(L),M=null,x=null,g=null,l=null,D=null,Ft.stop(),s.isPresenting=!1,t.setPixelRatio(k),t.setSize(P.width,P.height,!1),s.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(nt){u=nt,s.isPresenting===!0&&ie("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(nt){d=nt,s.isPresenting===!0&&ie("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||h},this.setReferenceSpace=function(nt){p=nt},this.getBaseLayer=function(){return x!==null?x:M},this.getBinding=function(){return g===null&&T&&(g=new XRWebGLBinding(l,i)),g},this.getFrame=function(){return b},this.getSession=function(){return l},this.setSession=async function(nt){if(l=nt,l!==null){if(L=t.getRenderTarget(),l.addEventListener("select",ct),l.addEventListener("selectstart",ct),l.addEventListener("selectend",ct),l.addEventListener("squeeze",ct),l.addEventListener("squeezestart",ct),l.addEventListener("squeezeend",ct),l.addEventListener("end",F),l.addEventListener("inputsourceschange",H),U.xrCompatible!==!0&&await i.makeXRCompatible(),k=t.getPixelRatio(),t.getSize(P),T&&"createProjectionLayer"in XRWebGLBinding.prototype){let wt=null,Gt=null,It=null;U.depth&&(It=U.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,wt=U.stencil?zs:Ta,Gt=U.stencil?ol:Ki);const ge={colorFormat:i.RGBA8,depthFormat:It,scaleFactor:u};g=this.getBinding(),x=g.createProjectionLayer(ge),l.updateRenderState({layers:[x]}),t.setPixelRatio(1),t.setSize(x.textureWidth,x.textureHeight,!1),D=new Qn(x.textureWidth,x.textureHeight,{format:Pi,type:li,depthTexture:new cl(x.textureWidth,x.textureHeight,Gt,void 0,void 0,void 0,void 0,void 0,void 0,wt),stencilBuffer:U.stencil,colorSpace:t.outputColorSpace,samples:U.antialias?4:0,resolveDepthBuffer:x.ignoreDepthValues===!1,resolveStencilBuffer:x.ignoreDepthValues===!1})}else{const wt={antialias:U.antialias,alpha:!0,depth:U.depth,stencil:U.stencil,framebufferScaleFactor:u};M=new XRWebGLLayer(l,i,wt),l.updateRenderState({baseLayer:M}),t.setPixelRatio(1),t.setSize(M.framebufferWidth,M.framebufferHeight,!1),D=new Qn(M.framebufferWidth,M.framebufferHeight,{format:Pi,type:li,colorSpace:t.outputColorSpace,stencilBuffer:U.stencil,resolveDepthBuffer:M.ignoreDepthValues===!1,resolveStencilBuffer:M.ignoreDepthValues===!1})}D.isXRRenderTarget=!0,this.setFoveation(m),p=null,h=await l.requestReferenceSpace(d),Ft.setContext(l),Ft.start(),s.isPresenting=!0,s.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function H(nt){for(let ut=0;ut<nt.removed.length;ut++){const wt=nt.removed[ut],Gt=O.indexOf(wt);Gt>=0&&(O[Gt]=null,B[Gt].disconnect(wt))}for(let ut=0;ut<nt.added.length;ut++){const wt=nt.added[ut];let Gt=O.indexOf(wt);if(Gt===-1){for(let ge=0;ge<B.length;ge++)if(ge>=O.length){O.push(wt),Gt=ge;break}else if(O[ge]===null){O[ge]=wt,Gt=ge;break}if(Gt===-1)break}const It=B[Gt];It&&It.connect(wt)}}const st=new j,yt=new j;function xt(nt,ut,wt){st.setFromMatrixPosition(ut.matrixWorld),yt.setFromMatrixPosition(wt.matrixWorld);const Gt=st.distanceTo(yt),It=ut.projectionMatrix.elements,ge=wt.projectionMatrix.elements,tn=It[14]/(It[10]-1),Se=It[14]/(It[10]+1),_e=(It[9]+1)/It[5],Ue=(It[9]-1)/It[5],oe=(It[8]-1)/It[0],en=(ge[8]+1)/ge[0],G=tn*oe,Qe=tn*en,Te=Gt/(-oe+en),Pe=Te*-oe;if(ut.matrixWorld.decompose(nt.position,nt.quaternion,nt.scale),nt.translateX(Pe),nt.translateZ(Te),nt.matrixWorld.compose(nt.position,nt.quaternion,nt.scale),nt.matrixWorldInverse.copy(nt.matrixWorld).invert(),It[10]===-1)nt.projectionMatrix.copy(ut.projectionMatrix),nt.projectionMatrixInverse.copy(ut.projectionMatrixInverse);else{const qt=tn+Te,N=Se+Te,E=G-Pe,q=Qe+(Gt-Pe),ht=_e*Se/N*qt,vt=Ue*Se/N*qt;nt.projectionMatrix.makePerspective(E,q,ht,vt,qt,N),nt.projectionMatrixInverse.copy(nt.projectionMatrix).invert()}}function z(nt,ut){ut===null?nt.matrixWorld.copy(nt.matrix):nt.matrixWorld.multiplyMatrices(ut.matrixWorld,nt.matrix),nt.matrixWorldInverse.copy(nt.matrixWorld).invert()}this.updateCamera=function(nt){if(l===null)return;let ut=nt.near,wt=nt.far;y.texture!==null&&(y.depthNear>0&&(ut=y.depthNear),y.depthFar>0&&(wt=y.depthFar)),J.near=w.near=C.near=ut,J.far=w.far=C.far=wt,(it!==J.near||dt!==J.far)&&(l.updateRenderState({depthNear:J.near,depthFar:J.far}),it=J.near,dt=J.far),J.layers.mask=nt.layers.mask|6,C.layers.mask=J.layers.mask&3,w.layers.mask=J.layers.mask&5;const Gt=nt.parent,It=J.cameras;z(J,Gt);for(let ge=0;ge<It.length;ge++)z(It[ge],Gt);It.length===2?xt(J,C,w):J.projectionMatrix.copy(C.projectionMatrix),at(nt,J,Gt)};function at(nt,ut,wt){wt===null?nt.matrix.copy(ut.matrixWorld):(nt.matrix.copy(wt.matrixWorld),nt.matrix.invert(),nt.matrix.multiply(ut.matrixWorld)),nt.matrix.decompose(nt.position,nt.quaternion,nt.scale),nt.updateMatrixWorld(!0),nt.projectionMatrix.copy(ut.projectionMatrix),nt.projectionMatrixInverse.copy(ut.projectionMatrixInverse),nt.isPerspectiveCamera&&(nt.fov=lp*2*Math.atan(1/nt.projectionMatrix.elements[5]),nt.zoom=1)}this.getCamera=function(){return J},this.getFoveation=function(){if(!(x===null&&M===null))return m},this.setFoveation=function(nt){m=nt,x!==null&&(x.fixedFoveation=nt),M!==null&&M.fixedFoveation!==void 0&&(M.fixedFoveation=nt)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(J)},this.getCameraTexture=function(nt){return v[nt]};let gt=null;function Tt(nt,ut){if(_=ut.getViewerPose(p||h),b=ut,_!==null){const wt=_.views;M!==null&&(t.setRenderTargetFramebuffer(D,M.framebuffer),t.setRenderTarget(D));let Gt=!1;wt.length!==J.cameras.length&&(J.cameras.length=0,Gt=!0);for(let Se=0;Se<wt.length;Se++){const _e=wt[Se];let Ue=null;if(M!==null)Ue=M.getViewport(_e);else{const en=g.getViewSubImage(x,_e);Ue=en.viewport,Se===0&&(t.setRenderTargetTextures(D,en.colorTexture,en.depthStencilTexture),t.setRenderTarget(D))}let oe=V[Se];oe===void 0&&(oe=new Ei,oe.layers.enable(Se),oe.viewport=new rn,V[Se]=oe),oe.matrix.fromArray(_e.transform.matrix),oe.matrix.decompose(oe.position,oe.quaternion,oe.scale),oe.projectionMatrix.fromArray(_e.projectionMatrix),oe.projectionMatrixInverse.copy(oe.projectionMatrix).invert(),oe.viewport.set(Ue.x,Ue.y,Ue.width,Ue.height),Se===0&&(J.matrix.copy(oe.matrix),J.matrix.decompose(J.position,J.quaternion,J.scale)),Gt===!0&&J.cameras.push(oe)}const It=l.enabledFeatures;if(It&&It.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&T){g=s.getBinding();const Se=g.getDepthInformation(wt[0]);Se&&Se.isValid&&Se.texture&&y.init(Se,l.renderState)}if(It&&It.includes("camera-access")&&T){t.state.unbindTexture(),g=s.getBinding();for(let Se=0;Se<wt.length;Se++){const _e=wt[Se].camera;if(_e){let Ue=v[_e];Ue||(Ue=new tx,v[_e]=Ue);const oe=g.getCameraImage(_e);Ue.sourceTexture=oe}}}}for(let wt=0;wt<B.length;wt++){const Gt=O[wt],It=B[wt];Gt!==null&&It!==void 0&&It.update(Gt,ut,p||h)}gt&&gt(nt,ut),ut.detectedPlanes&&s.dispatchEvent({type:"planesdetected",data:ut}),b=null}const Ft=new ax;Ft.setAnimationLoop(Tt),this.setAnimationLoop=function(nt){gt=nt},this.dispose=function(){}}}const Us=new Qi,XA=new Ke;function kA(o,t){function i(y,v){y.matrixAutoUpdate===!0&&y.updateMatrix(),v.value.copy(y.matrix)}function s(y,v){v.color.getRGB(y.fogColor.value,jv(o)),v.isFog?(y.fogNear.value=v.near,y.fogFar.value=v.far):v.isFogExp2&&(y.fogDensity.value=v.density)}function l(y,v,U,L,D){v.isMeshBasicMaterial||v.isMeshLambertMaterial?u(y,v):v.isMeshToonMaterial?(u(y,v),g(y,v)):v.isMeshPhongMaterial?(u(y,v),_(y,v)):v.isMeshStandardMaterial?(u(y,v),x(y,v),v.isMeshPhysicalMaterial&&M(y,v,D)):v.isMeshMatcapMaterial?(u(y,v),b(y,v)):v.isMeshDepthMaterial?u(y,v):v.isMeshDistanceMaterial?(u(y,v),T(y,v)):v.isMeshNormalMaterial?u(y,v):v.isLineBasicMaterial?(h(y,v),v.isLineDashedMaterial&&d(y,v)):v.isPointsMaterial?m(y,v,U,L):v.isSpriteMaterial?p(y,v):v.isShadowMaterial?(y.color.value.copy(v.color),y.opacity.value=v.opacity):v.isShaderMaterial&&(v.uniformsNeedUpdate=!1)}function u(y,v){y.opacity.value=v.opacity,v.color&&y.diffuse.value.copy(v.color),v.emissive&&y.emissive.value.copy(v.emissive).multiplyScalar(v.emissiveIntensity),v.map&&(y.map.value=v.map,i(v.map,y.mapTransform)),v.alphaMap&&(y.alphaMap.value=v.alphaMap,i(v.alphaMap,y.alphaMapTransform)),v.bumpMap&&(y.bumpMap.value=v.bumpMap,i(v.bumpMap,y.bumpMapTransform),y.bumpScale.value=v.bumpScale,v.side===Kn&&(y.bumpScale.value*=-1)),v.normalMap&&(y.normalMap.value=v.normalMap,i(v.normalMap,y.normalMapTransform),y.normalScale.value.copy(v.normalScale),v.side===Kn&&y.normalScale.value.negate()),v.displacementMap&&(y.displacementMap.value=v.displacementMap,i(v.displacementMap,y.displacementMapTransform),y.displacementScale.value=v.displacementScale,y.displacementBias.value=v.displacementBias),v.emissiveMap&&(y.emissiveMap.value=v.emissiveMap,i(v.emissiveMap,y.emissiveMapTransform)),v.specularMap&&(y.specularMap.value=v.specularMap,i(v.specularMap,y.specularMapTransform)),v.alphaTest>0&&(y.alphaTest.value=v.alphaTest);const U=t.get(v),L=U.envMap,D=U.envMapRotation;L&&(y.envMap.value=L,Us.copy(D),Us.x*=-1,Us.y*=-1,Us.z*=-1,L.isCubeTexture&&L.isRenderTargetTexture===!1&&(Us.y*=-1,Us.z*=-1),y.envMapRotation.value.setFromMatrix4(XA.makeRotationFromEuler(Us)),y.flipEnvMap.value=L.isCubeTexture&&L.isRenderTargetTexture===!1?-1:1,y.reflectivity.value=v.reflectivity,y.ior.value=v.ior,y.refractionRatio.value=v.refractionRatio),v.lightMap&&(y.lightMap.value=v.lightMap,y.lightMapIntensity.value=v.lightMapIntensity,i(v.lightMap,y.lightMapTransform)),v.aoMap&&(y.aoMap.value=v.aoMap,y.aoMapIntensity.value=v.aoMapIntensity,i(v.aoMap,y.aoMapTransform))}function h(y,v){y.diffuse.value.copy(v.color),y.opacity.value=v.opacity,v.map&&(y.map.value=v.map,i(v.map,y.mapTransform))}function d(y,v){y.dashSize.value=v.dashSize,y.totalSize.value=v.dashSize+v.gapSize,y.scale.value=v.scale}function m(y,v,U,L){y.diffuse.value.copy(v.color),y.opacity.value=v.opacity,y.size.value=v.size*U,y.scale.value=L*.5,v.map&&(y.map.value=v.map,i(v.map,y.uvTransform)),v.alphaMap&&(y.alphaMap.value=v.alphaMap,i(v.alphaMap,y.alphaMapTransform)),v.alphaTest>0&&(y.alphaTest.value=v.alphaTest)}function p(y,v){y.diffuse.value.copy(v.color),y.opacity.value=v.opacity,y.rotation.value=v.rotation,v.map&&(y.map.value=v.map,i(v.map,y.mapTransform)),v.alphaMap&&(y.alphaMap.value=v.alphaMap,i(v.alphaMap,y.alphaMapTransform)),v.alphaTest>0&&(y.alphaTest.value=v.alphaTest)}function _(y,v){y.specular.value.copy(v.specular),y.shininess.value=Math.max(v.shininess,1e-4)}function g(y,v){v.gradientMap&&(y.gradientMap.value=v.gradientMap)}function x(y,v){y.metalness.value=v.metalness,v.metalnessMap&&(y.metalnessMap.value=v.metalnessMap,i(v.metalnessMap,y.metalnessMapTransform)),y.roughness.value=v.roughness,v.roughnessMap&&(y.roughnessMap.value=v.roughnessMap,i(v.roughnessMap,y.roughnessMapTransform)),v.envMap&&(y.envMapIntensity.value=v.envMapIntensity)}function M(y,v,U){y.ior.value=v.ior,v.sheen>0&&(y.sheenColor.value.copy(v.sheenColor).multiplyScalar(v.sheen),y.sheenRoughness.value=v.sheenRoughness,v.sheenColorMap&&(y.sheenColorMap.value=v.sheenColorMap,i(v.sheenColorMap,y.sheenColorMapTransform)),v.sheenRoughnessMap&&(y.sheenRoughnessMap.value=v.sheenRoughnessMap,i(v.sheenRoughnessMap,y.sheenRoughnessMapTransform))),v.clearcoat>0&&(y.clearcoat.value=v.clearcoat,y.clearcoatRoughness.value=v.clearcoatRoughness,v.clearcoatMap&&(y.clearcoatMap.value=v.clearcoatMap,i(v.clearcoatMap,y.clearcoatMapTransform)),v.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=v.clearcoatRoughnessMap,i(v.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),v.clearcoatNormalMap&&(y.clearcoatNormalMap.value=v.clearcoatNormalMap,i(v.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(v.clearcoatNormalScale),v.side===Kn&&y.clearcoatNormalScale.value.negate())),v.dispersion>0&&(y.dispersion.value=v.dispersion),v.iridescence>0&&(y.iridescence.value=v.iridescence,y.iridescenceIOR.value=v.iridescenceIOR,y.iridescenceThicknessMinimum.value=v.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=v.iridescenceThicknessRange[1],v.iridescenceMap&&(y.iridescenceMap.value=v.iridescenceMap,i(v.iridescenceMap,y.iridescenceMapTransform)),v.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=v.iridescenceThicknessMap,i(v.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),v.transmission>0&&(y.transmission.value=v.transmission,y.transmissionSamplerMap.value=U.texture,y.transmissionSamplerSize.value.set(U.width,U.height),v.transmissionMap&&(y.transmissionMap.value=v.transmissionMap,i(v.transmissionMap,y.transmissionMapTransform)),y.thickness.value=v.thickness,v.thicknessMap&&(y.thicknessMap.value=v.thicknessMap,i(v.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=v.attenuationDistance,y.attenuationColor.value.copy(v.attenuationColor)),v.anisotropy>0&&(y.anisotropyVector.value.set(v.anisotropy*Math.cos(v.anisotropyRotation),v.anisotropy*Math.sin(v.anisotropyRotation)),v.anisotropyMap&&(y.anisotropyMap.value=v.anisotropyMap,i(v.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=v.specularIntensity,y.specularColor.value.copy(v.specularColor),v.specularColorMap&&(y.specularColorMap.value=v.specularColorMap,i(v.specularColorMap,y.specularColorMapTransform)),v.specularIntensityMap&&(y.specularIntensityMap.value=v.specularIntensityMap,i(v.specularIntensityMap,y.specularIntensityMapTransform))}function b(y,v){v.matcap&&(y.matcap.value=v.matcap)}function T(y,v){const U=t.get(v).light;y.referencePosition.value.setFromMatrixPosition(U.matrixWorld),y.nearDistance.value=U.shadow.camera.near,y.farDistance.value=U.shadow.camera.far}return{refreshFogUniforms:s,refreshMaterialUniforms:l}}function WA(o,t,i,s){let l={},u={},h=[];const d=o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS);function m(U,L){const D=L.program;s.uniformBlockBinding(U,D)}function p(U,L){let D=l[U.id];D===void 0&&(b(U),D=_(U),l[U.id]=D,U.addEventListener("dispose",y));const B=L.program;s.updateUBOMapping(U,B);const O=t.render.frame;u[U.id]!==O&&(x(U),u[U.id]=O)}function _(U){const L=g();U.__bindingPointIndex=L;const D=o.createBuffer(),B=U.__size,O=U.usage;return o.bindBuffer(o.UNIFORM_BUFFER,D),o.bufferData(o.UNIFORM_BUFFER,B,O),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,L,D),D}function g(){for(let U=0;U<d;U++)if(h.indexOf(U)===-1)return h.push(U),U;return Re("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function x(U){const L=l[U.id],D=U.uniforms,B=U.__cache;o.bindBuffer(o.UNIFORM_BUFFER,L);for(let O=0,P=D.length;O<P;O++){const k=Array.isArray(D[O])?D[O]:[D[O]];for(let C=0,w=k.length;C<w;C++){const V=k[C];if(M(V,O,C,B)===!0){const J=V.__offset,it=Array.isArray(V.value)?V.value:[V.value];let dt=0;for(let ct=0;ct<it.length;ct++){const F=it[ct],H=T(F);typeof F=="number"||typeof F=="boolean"?(V.__data[0]=F,o.bufferSubData(o.UNIFORM_BUFFER,J+dt,V.__data)):F.isMatrix3?(V.__data[0]=F.elements[0],V.__data[1]=F.elements[1],V.__data[2]=F.elements[2],V.__data[3]=0,V.__data[4]=F.elements[3],V.__data[5]=F.elements[4],V.__data[6]=F.elements[5],V.__data[7]=0,V.__data[8]=F.elements[6],V.__data[9]=F.elements[7],V.__data[10]=F.elements[8],V.__data[11]=0):(F.toArray(V.__data,dt),dt+=H.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,J,V.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function M(U,L,D,B){const O=U.value,P=L+"_"+D;if(B[P]===void 0)return typeof O=="number"||typeof O=="boolean"?B[P]=O:B[P]=O.clone(),!0;{const k=B[P];if(typeof O=="number"||typeof O=="boolean"){if(k!==O)return B[P]=O,!0}else if(k.equals(O)===!1)return k.copy(O),!0}return!1}function b(U){const L=U.uniforms;let D=0;const B=16;for(let P=0,k=L.length;P<k;P++){const C=Array.isArray(L[P])?L[P]:[L[P]];for(let w=0,V=C.length;w<V;w++){const J=C[w],it=Array.isArray(J.value)?J.value:[J.value];for(let dt=0,ct=it.length;dt<ct;dt++){const F=it[dt],H=T(F),st=D%B,yt=st%H.boundary,xt=st+yt;D+=yt,xt!==0&&B-xt<H.storage&&(D+=B-xt),J.__data=new Float32Array(H.storage/Float32Array.BYTES_PER_ELEMENT),J.__offset=D,D+=H.storage}}}const O=D%B;return O>0&&(D+=B-O),U.__size=D,U.__cache={},this}function T(U){const L={boundary:0,storage:0};return typeof U=="number"||typeof U=="boolean"?(L.boundary=4,L.storage=4):U.isVector2?(L.boundary=8,L.storage=8):U.isVector3||U.isColor?(L.boundary=16,L.storage=12):U.isVector4?(L.boundary=16,L.storage=16):U.isMatrix3?(L.boundary=48,L.storage=48):U.isMatrix4?(L.boundary=64,L.storage=64):U.isTexture?ie("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ie("WebGLRenderer: Unsupported uniform value type.",U),L}function y(U){const L=U.target;L.removeEventListener("dispose",y);const D=h.indexOf(L.__bindingPointIndex);h.splice(D,1),o.deleteBuffer(l[L.id]),delete l[L.id],delete u[L.id]}function v(){for(const U in l)o.deleteBuffer(l[U]);h=[],l={},u={}}return{bind:m,update:p,dispose:v}}const qA=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Xi=null;function YA(){return Xi===null&&(Xi=new LM(qA,16,16,Wr,ui),Xi.name="DFG_LUT",Xi.minFilter=Bn,Xi.magFilter=Bn,Xi.wrapS=Ea,Xi.wrapT=Ea,Xi.generateMipmaps=!1,Xi.needsUpdate=!0),Xi}class jA{constructor(t={}){const{canvas:i=aM(),context:s=null,depth:l=!0,stencil:u=!1,alpha:h=!1,antialias:d=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:g=!1,reversedDepthBuffer:x=!1,outputBufferType:M=li}=t;this.isWebGLRenderer=!0;let b;if(s!==null){if(typeof WebGLRenderingContext<"u"&&s instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");b=s.getContextAttributes().alpha}else b=h;const T=M,y=new Set([yp,Sp,xp]),v=new Set([li,Ki,rl,ol,_p,vp]),U=new Uint32Array(4),L=new Int32Array(4);let D=null,B=null;const O=[],P=[];let k=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Zi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const C=this;let w=!1;this._outputColorSpace=oi;let V=0,J=0,it=null,dt=-1,ct=null;const F=new rn,H=new rn;let st=null;const yt=new le(0);let xt=0,z=i.width,at=i.height,gt=1,Tt=null,Ft=null;const nt=new rn(0,0,z,at),ut=new rn(0,0,z,at);let wt=!1;const Gt=new Cp;let It=!1,ge=!1;const tn=new Ke,Se=new j,_e=new rn,Ue={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let oe=!1;function en(){return it===null?gt:1}let G=s;function Qe(R,Y){return i.getContext(R,Y)}try{const R={alpha:!0,depth:l,stencil:u,antialias:d,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:_,failIfMajorPerformanceCaveat:g};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${dp}`),i.addEventListener("webglcontextlost",ae,!1),i.addEventListener("webglcontextrestored",Be,!1),i.addEventListener("webglcontextcreationerror",Ae,!1),G===null){const Y="webgl2";if(G=Qe(Y,R),G===null)throw Qe(Y)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(R){throw Re("WebGLRenderer: "+R.message),R}let Te,Pe,qt,N,E,q,ht,vt,lt,jt,Rt,Xt,ne,Mt,Et,zt,Ot,Ct,ce,W,Ut,bt,Pt,St;function _t(){Te=new YT(G),Te.init(),bt=new FA(G,Te),Pe=new FT(G,Te,t,bt),qt=new zA(G,Te),Pe.reversedDepthBuffer&&x&&qt.buffers.depth.setReversed(!0),N=new KT(G),E=new yA,q=new BA(G,Te,qt,E,Pe,bt,N),ht=new HT(C),vt=new qT(C),lt=new tE(G),Pt=new zT(G,lt),jt=new jT(G,lt,N,Pt),Rt=new JT(G,jt,lt,N),ce=new QT(G,Pe,q),zt=new IT(E),Xt=new SA(C,ht,vt,Te,Pe,Pt,zt),ne=new kA(C,E),Mt=new EA,Et=new wA(Te),Ct=new PT(C,ht,vt,qt,Rt,b,m),Ot=new OA(C,Rt,Pe),St=new WA(G,N,Pe,qt),W=new BT(G,Te,N),Ut=new ZT(G,Te,N),N.programs=Xt.programs,C.capabilities=Pe,C.extensions=Te,C.properties=E,C.renderLists=Mt,C.shadowMap=Ot,C.state=qt,C.info=N}_t(),T!==li&&(k=new t1(T,i.width,i.height,l,u));const At=new GA(C,G);this.xr=At,this.getContext=function(){return G},this.getContextAttributes=function(){return G.getContextAttributes()},this.forceContextLoss=function(){const R=Te.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){const R=Te.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return gt},this.setPixelRatio=function(R){R!==void 0&&(gt=R,this.setSize(z,at,!1))},this.getSize=function(R){return R.set(z,at)},this.setSize=function(R,Y,rt=!0){if(At.isPresenting){ie("WebGLRenderer: Can't change size while VR device is presenting.");return}z=R,at=Y,i.width=Math.floor(R*gt),i.height=Math.floor(Y*gt),rt===!0&&(i.style.width=R+"px",i.style.height=Y+"px"),k!==null&&k.setSize(i.width,i.height),this.setViewport(0,0,R,Y)},this.getDrawingBufferSize=function(R){return R.set(z*gt,at*gt).floor()},this.setDrawingBufferSize=function(R,Y,rt){z=R,at=Y,gt=rt,i.width=Math.floor(R*rt),i.height=Math.floor(Y*rt),this.setViewport(0,0,R,Y)},this.setEffects=function(R){if(T===li){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(R){for(let Y=0;Y<R.length;Y++)if(R[Y].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}k.setEffects(R||[])},this.getCurrentViewport=function(R){return R.copy(F)},this.getViewport=function(R){return R.copy(nt)},this.setViewport=function(R,Y,rt,tt){R.isVector4?nt.set(R.x,R.y,R.z,R.w):nt.set(R,Y,rt,tt),qt.viewport(F.copy(nt).multiplyScalar(gt).round())},this.getScissor=function(R){return R.copy(ut)},this.setScissor=function(R,Y,rt,tt){R.isVector4?ut.set(R.x,R.y,R.z,R.w):ut.set(R,Y,rt,tt),qt.scissor(H.copy(ut).multiplyScalar(gt).round())},this.getScissorTest=function(){return wt},this.setScissorTest=function(R){qt.setScissorTest(wt=R)},this.setOpaqueSort=function(R){Tt=R},this.setTransparentSort=function(R){Ft=R},this.getClearColor=function(R){return R.copy(Ct.getClearColor())},this.setClearColor=function(){Ct.setClearColor(...arguments)},this.getClearAlpha=function(){return Ct.getClearAlpha()},this.setClearAlpha=function(){Ct.setClearAlpha(...arguments)},this.clear=function(R=!0,Y=!0,rt=!0){let tt=0;if(R){let K=!1;if(it!==null){const Dt=it.texture.format;K=y.has(Dt)}if(K){const Dt=it.texture.type,Bt=v.has(Dt),Lt=Ct.getClearColor(),Ht=Ct.getClearAlpha(),kt=Lt.r,Qt=Lt.g,Wt=Lt.b;Bt?(U[0]=kt,U[1]=Qt,U[2]=Wt,U[3]=Ht,G.clearBufferuiv(G.COLOR,0,U)):(L[0]=kt,L[1]=Qt,L[2]=Wt,L[3]=Ht,G.clearBufferiv(G.COLOR,0,L))}else tt|=G.COLOR_BUFFER_BIT}Y&&(tt|=G.DEPTH_BUFFER_BIT),rt&&(tt|=G.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G.clear(tt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",ae,!1),i.removeEventListener("webglcontextrestored",Be,!1),i.removeEventListener("webglcontextcreationerror",Ae,!1),Ct.dispose(),Mt.dispose(),Et.dispose(),E.dispose(),ht.dispose(),vt.dispose(),Rt.dispose(),Pt.dispose(),St.dispose(),Xt.dispose(),At.dispose(),At.removeEventListener("sessionstart",Vs),At.removeEventListener("sessionend",$r),Fi.stop()};function ae(R){R.preventDefault(),fc("WebGLRenderer: Context Lost."),w=!0}function Be(){fc("WebGLRenderer: Context Restored."),w=!1;const R=N.autoReset,Y=Ot.enabled,rt=Ot.autoUpdate,tt=Ot.needsUpdate,K=Ot.type;_t(),N.autoReset=R,Ot.enabled=Y,Ot.autoUpdate=rt,Ot.needsUpdate=tt,Ot.type=K}function Ae(R){Re("WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function Nn(R){const Y=R.target;Y.removeEventListener("dispose",Nn),Ai(Y)}function Ai(R){gl(R),E.remove(R)}function gl(R){const Y=E.get(R).programs;Y!==void 0&&(Y.forEach(function(rt){Xt.releaseProgram(rt)}),R.isShaderMaterial&&Xt.releaseShaderCache(R))}this.renderBufferDirect=function(R,Y,rt,tt,K,Dt){Y===null&&(Y=Ue);const Bt=K.isMesh&&K.matrixWorld.determinant()<0,Lt=ls(R,Y,rt,tt,K);qt.setMaterial(tt,Bt);let Ht=rt.index,kt=1;if(tt.wireframe===!0){if(Ht=jt.getWireframeAttribute(rt),Ht===void 0)return;kt=2}const Qt=rt.drawRange,Wt=rt.attributes.position;let $t=Qt.start*kt,Le=(Qt.start+Qt.count)*kt;Dt!==null&&($t=Math.max($t,Dt.start*kt),Le=Math.min(Le,(Dt.start+Dt.count)*kt)),Ht!==null?($t=Math.max($t,0),Le=Math.min(Le,Ht.count)):Wt!=null&&($t=Math.max($t,0),Le=Math.min(Le,Wt.count));const Je=Le-$t;if(Je<0||Je===1/0)return;Pt.setup(K,tt,Lt,rt,Ht);let Ye,ze=W;if(Ht!==null&&(Ye=lt.get(Ht),ze=Ut,ze.setIndex(Ye)),K.isMesh)tt.wireframe===!0?(qt.setLineWidth(tt.wireframeLinewidth*en()),ze.setMode(G.LINES)):ze.setMode(G.TRIANGLES);else if(K.isLine){let Zt=tt.linewidth;Zt===void 0&&(Zt=1),qt.setLineWidth(Zt*en()),K.isLineSegments?ze.setMode(G.LINES):K.isLineLoop?ze.setMode(G.LINE_LOOP):ze.setMode(G.LINE_STRIP)}else K.isPoints?ze.setMode(G.POINTS):K.isSprite&&ze.setMode(G.TRIANGLES);if(K.isBatchedMesh)if(K._multiDrawInstances!==null)ul("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ze.renderMultiDrawInstances(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount,K._multiDrawInstances);else if(Te.get("WEBGL_multi_draw"))ze.renderMultiDraw(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount);else{const Zt=K._multiDrawStarts,Ne=K._multiDrawCounts,se=K._multiDrawCount,En=Ht?lt.get(Ht).bytesPerElement:1,Ji=E.get(tt).currentProgram.getUniforms();for(let bn=0;bn<se;bn++)Ji.setValue(G,"_gl_DrawID",bn),ze.render(Zt[bn]/En,Ne[bn])}else if(K.isInstancedMesh)ze.renderInstances($t,Je,K.count);else if(rt.isInstancedBufferGeometry){const Zt=rt._maxInstanceCount!==void 0?rt._maxInstanceCount:1/0,Ne=Math.min(rt.instanceCount,Zt);ze.renderInstances($t,Je,Ne)}else ze.render($t,Je)};function Qr(R,Y,rt){R.transparent===!0&&R.side===Ma&&R.forceSinglePass===!1?(R.side=Kn,R.needsUpdate=!0,Xs(R,Y,rt),R.side=os,R.needsUpdate=!0,Xs(R,Y,rt),R.side=Ma):Xs(R,Y,rt)}this.compile=function(R,Y,rt=null){rt===null&&(rt=R),B=Et.get(rt),B.init(Y),P.push(B),rt.traverseVisible(function(K){K.isLight&&K.layers.test(Y.layers)&&(B.pushLight(K),K.castShadow&&B.pushShadow(K))}),R!==rt&&R.traverseVisible(function(K){K.isLight&&K.layers.test(Y.layers)&&(B.pushLight(K),K.castShadow&&B.pushShadow(K))}),B.setupLights();const tt=new Set;return R.traverse(function(K){if(!(K.isMesh||K.isPoints||K.isLine||K.isSprite))return;const Dt=K.material;if(Dt)if(Array.isArray(Dt))for(let Bt=0;Bt<Dt.length;Bt++){const Lt=Dt[Bt];Qr(Lt,rt,K),tt.add(Lt)}else Qr(Dt,rt,K),tt.add(Dt)}),B=P.pop(),tt},this.compileAsync=function(R,Y,rt=null){const tt=this.compile(R,Y,rt);return new Promise(K=>{function Dt(){if(tt.forEach(function(Bt){E.get(Bt).currentProgram.isReady()&&tt.delete(Bt)}),tt.size===0){K(R);return}setTimeout(Dt,10)}Te.get("KHR_parallel_shader_compile")!==null?Dt():setTimeout(Dt,10)})};let Hs=null;function Jr(R){Hs&&Hs(R)}function Vs(){Fi.stop()}function $r(){Fi.start()}const Fi=new ax;Fi.setAnimationLoop(Jr),typeof self<"u"&&Fi.setContext(self),this.setAnimationLoop=function(R){Hs=R,At.setAnimationLoop(R),R===null?Fi.stop():Fi.start()},At.addEventListener("sessionstart",Vs),At.addEventListener("sessionend",$r),this.render=function(R,Y){if(Y!==void 0&&Y.isCamera!==!0){Re("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;const rt=At.enabled===!0&&At.isPresenting===!0,tt=k!==null&&(it===null||rt)&&k.begin(C,it);if(R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),Y.parent===null&&Y.matrixWorldAutoUpdate===!0&&Y.updateMatrixWorld(),At.enabled===!0&&At.isPresenting===!0&&(k===null||k.isCompositing()===!1)&&(At.cameraAutoUpdate===!0&&At.updateCamera(Y),Y=At.getCamera()),R.isScene===!0&&R.onBeforeRender(C,R,Y,it),B=Et.get(R,P.length),B.init(Y),P.push(B),tn.multiplyMatrices(Y.projectionMatrix,Y.matrixWorldInverse),Gt.setFromProjectionMatrix(tn,Yi,Y.reversedDepth),ge=this.localClippingEnabled,It=zt.init(this.clippingPlanes,ge),D=Mt.get(R,O.length),D.init(),O.push(D),At.enabled===!0&&At.isPresenting===!0){const Bt=C.xr.getDepthSensingMesh();Bt!==null&&fi(Bt,Y,-1/0,C.sortObjects)}fi(R,Y,0,C.sortObjects),D.finish(),C.sortObjects===!0&&D.sort(Tt,Ft),oe=At.enabled===!1||At.isPresenting===!1||At.hasDepthSensing()===!1,oe&&Ct.addToRenderList(D,R),this.info.render.frame++,It===!0&&zt.beginShadows();const K=B.state.shadowsArray;if(Ot.render(K,R,Y),It===!0&&zt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(tt&&k.hasRenderPass())===!1){const Bt=D.opaque,Lt=D.transmissive;if(B.setupLights(),Y.isArrayCamera){const Ht=Y.cameras;if(Lt.length>0)for(let kt=0,Qt=Ht.length;kt<Qt;kt++){const Wt=Ht[kt];Mn(Bt,Lt,R,Wt)}oe&&Ct.render(R);for(let kt=0,Qt=Ht.length;kt<Qt;kt++){const Wt=Ht[kt];un(D,R,Wt,Wt.viewport)}}else Lt.length>0&&Mn(Bt,Lt,R,Y),oe&&Ct.render(R),un(D,R,Y)}it!==null&&J===0&&(q.updateMultisampleRenderTarget(it),q.updateRenderTargetMipmap(it)),tt&&k.end(C),R.isScene===!0&&R.onAfterRender(C,R,Y),Pt.resetDefaultState(),dt=-1,ct=null,P.pop(),P.length>0?(B=P[P.length-1],It===!0&&zt.setGlobalState(C.clippingPlanes,B.state.camera)):B=null,O.pop(),O.length>0?D=O[O.length-1]:D=null};function fi(R,Y,rt,tt){if(R.visible===!1)return;if(R.layers.test(Y.layers)){if(R.isGroup)rt=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update(Y);else if(R.isLight)B.pushLight(R),R.castShadow&&B.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||Gt.intersectsSprite(R)){tt&&_e.setFromMatrixPosition(R.matrixWorld).applyMatrix4(tn);const Bt=Rt.update(R),Lt=R.material;Lt.visible&&D.push(R,Bt,Lt,rt,_e.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||Gt.intersectsObject(R))){const Bt=Rt.update(R),Lt=R.material;if(tt&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),_e.copy(R.boundingSphere.center)):(Bt.boundingSphere===null&&Bt.computeBoundingSphere(),_e.copy(Bt.boundingSphere.center)),_e.applyMatrix4(R.matrixWorld).applyMatrix4(tn)),Array.isArray(Lt)){const Ht=Bt.groups;for(let kt=0,Qt=Ht.length;kt<Qt;kt++){const Wt=Ht[kt],$t=Lt[Wt.materialIndex];$t&&$t.visible&&D.push(R,Bt,$t,rt,_e.z,Wt)}}else Lt.visible&&D.push(R,Bt,Lt,rt,_e.z,null)}}const Dt=R.children;for(let Bt=0,Lt=Dt.length;Bt<Lt;Bt++)fi(Dt[Bt],Y,rt,tt)}function un(R,Y,rt,tt){const{opaque:K,transmissive:Dt,transparent:Bt}=R;B.setupLightsView(rt),It===!0&&zt.setGlobalState(C.clippingPlanes,rt),tt&&qt.viewport(F.copy(tt)),K.length>0&&Ri(K,Y,rt),Dt.length>0&&Ri(Dt,Y,rt),Bt.length>0&&Ri(Bt,Y,rt),qt.buffers.depth.setTest(!0),qt.buffers.depth.setMask(!0),qt.buffers.color.setMask(!0),qt.setPolygonOffset(!1)}function Mn(R,Y,rt,tt){if((rt.isScene===!0?rt.overrideMaterial:null)!==null)return;if(B.state.transmissionRenderTarget[tt.id]===void 0){const $t=Te.has("EXT_color_buffer_half_float")||Te.has("EXT_color_buffer_float");B.state.transmissionRenderTarget[tt.id]=new Qn(1,1,{generateMipmaps:!0,type:$t?ui:li,minFilter:Ps,samples:Pe.samples,stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ce.workingColorSpace})}const Dt=B.state.transmissionRenderTarget[tt.id],Bt=tt.viewport||F;Dt.setSize(Bt.z*C.transmissionResolutionScale,Bt.w*C.transmissionResolutionScale);const Lt=C.getRenderTarget(),Ht=C.getActiveCubeFace(),kt=C.getActiveMipmapLevel();C.setRenderTarget(Dt),C.getClearColor(yt),xt=C.getClearAlpha(),xt<1&&C.setClearColor(16777215,.5),C.clear(),oe&&Ct.render(rt);const Qt=C.toneMapping;C.toneMapping=Zi;const Wt=tt.viewport;if(tt.viewport!==void 0&&(tt.viewport=void 0),B.setupLightsView(tt),It===!0&&zt.setGlobalState(C.clippingPlanes,tt),Ri(R,rt,tt),q.updateMultisampleRenderTarget(Dt),q.updateRenderTargetMipmap(Dt),Te.has("WEBGL_multisampled_render_to_texture")===!1){let $t=!1;for(let Le=0,Je=Y.length;Le<Je;Le++){const Ye=Y[Le],{object:ze,geometry:Zt,material:Ne,group:se}=Ye;if(Ne.side===Ma&&ze.layers.test(tt.layers)){const En=Ne.side;Ne.side=Kn,Ne.needsUpdate=!0,Gs(ze,rt,tt,Zt,Ne,se),Ne.side=En,Ne.needsUpdate=!0,$t=!0}}$t===!0&&(q.updateMultisampleRenderTarget(Dt),q.updateRenderTargetMipmap(Dt))}C.setRenderTarget(Lt,Ht,kt),C.setClearColor(yt,xt),Wt!==void 0&&(tt.viewport=Wt),C.toneMapping=Qt}function Ri(R,Y,rt){const tt=Y.isScene===!0?Y.overrideMaterial:null;for(let K=0,Dt=R.length;K<Dt;K++){const Bt=R[K],{object:Lt,geometry:Ht,group:kt}=Bt;let Qt=Bt.material;Qt.allowOverride===!0&&tt!==null&&(Qt=tt),Lt.layers.test(rt.layers)&&Gs(Lt,Y,rt,Ht,Qt,kt)}}function Gs(R,Y,rt,tt,K,Dt){R.onBeforeRender(C,Y,rt,tt,K,Dt),R.modelViewMatrix.multiplyMatrices(rt.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),K.onBeforeRender(C,Y,rt,tt,R,Dt),K.transparent===!0&&K.side===Ma&&K.forceSinglePass===!1?(K.side=Kn,K.needsUpdate=!0,C.renderBufferDirect(rt,Y,tt,K,R,Dt),K.side=os,K.needsUpdate=!0,C.renderBufferDirect(rt,Y,tt,K,R,Dt),K.side=Ma):C.renderBufferDirect(rt,Y,tt,K,R,Dt),R.onAfterRender(C,Y,rt,tt,K,Dt)}function Xs(R,Y,rt){Y.isScene!==!0&&(Y=Ue);const tt=E.get(R),K=B.state.lights,Dt=B.state.shadowsArray,Bt=K.state.version,Lt=Xt.getParameters(R,K.state,Dt,Y,rt),Ht=Xt.getProgramCacheKey(Lt);let kt=tt.programs;tt.environment=R.isMeshStandardMaterial?Y.environment:null,tt.fog=Y.fog,tt.envMap=(R.isMeshStandardMaterial?vt:ht).get(R.envMap||tt.environment),tt.envMapRotation=tt.environment!==null&&R.envMap===null?Y.environmentRotation:R.envMapRotation,kt===void 0&&(R.addEventListener("dispose",Nn),kt=new Map,tt.programs=kt);let Qt=kt.get(Ht);if(Qt!==void 0){if(tt.currentProgram===Qt&&tt.lightsStateVersion===Bt)return to(R,Lt),Qt}else Lt.uniforms=Xt.getUniforms(R),R.onBeforeCompile(Lt,C),Qt=Xt.acquireProgram(Lt,Ht),kt.set(Ht,Qt),tt.uniforms=Lt.uniforms;const Wt=tt.uniforms;return(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&(Wt.clippingPlanes=zt.uniform),to(R,Lt),tt.needsLights=Aa(R),tt.lightsStateVersion=Bt,tt.needsLights&&(Wt.ambientLightColor.value=K.state.ambient,Wt.lightProbe.value=K.state.probe,Wt.directionalLights.value=K.state.directional,Wt.directionalLightShadows.value=K.state.directionalShadow,Wt.spotLights.value=K.state.spot,Wt.spotLightShadows.value=K.state.spotShadow,Wt.rectAreaLights.value=K.state.rectArea,Wt.ltc_1.value=K.state.rectAreaLTC1,Wt.ltc_2.value=K.state.rectAreaLTC2,Wt.pointLights.value=K.state.point,Wt.pointLightShadows.value=K.state.pointShadow,Wt.hemisphereLights.value=K.state.hemi,Wt.directionalShadowMap.value=K.state.directionalShadowMap,Wt.directionalShadowMatrix.value=K.state.directionalShadowMatrix,Wt.spotShadowMap.value=K.state.spotShadowMap,Wt.spotLightMatrix.value=K.state.spotLightMatrix,Wt.spotLightMap.value=K.state.spotLightMap,Wt.pointShadowMap.value=K.state.pointShadowMap,Wt.pointShadowMatrix.value=K.state.pointShadowMatrix),tt.currentProgram=Qt,tt.uniformsList=null,Qt}function _l(R){if(R.uniformsList===null){const Y=R.currentProgram.getUniforms();R.uniformsList=oc.seqWithValue(Y.seq,R.uniforms)}return R.uniformsList}function to(R,Y){const rt=E.get(R);rt.outputColorSpace=Y.outputColorSpace,rt.batching=Y.batching,rt.batchingColor=Y.batchingColor,rt.instancing=Y.instancing,rt.instancingColor=Y.instancingColor,rt.instancingMorph=Y.instancingMorph,rt.skinning=Y.skinning,rt.morphTargets=Y.morphTargets,rt.morphNormals=Y.morphNormals,rt.morphColors=Y.morphColors,rt.morphTargetsCount=Y.morphTargetsCount,rt.numClippingPlanes=Y.numClippingPlanes,rt.numIntersection=Y.numClipIntersection,rt.vertexAlphas=Y.vertexAlphas,rt.vertexTangents=Y.vertexTangents,rt.toneMapping=Y.toneMapping}function ls(R,Y,rt,tt,K){Y.isScene!==!0&&(Y=Ue),q.resetTextureUnits();const Dt=Y.fog,Bt=tt.isMeshStandardMaterial?Y.environment:null,Lt=it===null?C.outputColorSpace:it.isXRRenderTarget===!0?it.texture.colorSpace:qr,Ht=(tt.isMeshStandardMaterial?vt:ht).get(tt.envMap||Bt),kt=tt.vertexColors===!0&&!!rt.attributes.color&&rt.attributes.color.itemSize===4,Qt=!!rt.attributes.tangent&&(!!tt.normalMap||tt.anisotropy>0),Wt=!!rt.morphAttributes.position,$t=!!rt.morphAttributes.normal,Le=!!rt.morphAttributes.color;let Je=Zi;tt.toneMapped&&(it===null||it.isXRRenderTarget===!0)&&(Je=C.toneMapping);const Ye=rt.morphAttributes.position||rt.morphAttributes.normal||rt.morphAttributes.color,ze=Ye!==void 0?Ye.length:0,Zt=E.get(tt),Ne=B.state.lights;if(It===!0&&(ge===!0||R!==ct)){const An=R===ct&&tt.id===dt;zt.setState(tt,R,An)}let se=!1;tt.version===Zt.__version?(Zt.needsLights&&Zt.lightsStateVersion!==Ne.state.version||Zt.outputColorSpace!==Lt||K.isBatchedMesh&&Zt.batching===!1||!K.isBatchedMesh&&Zt.batching===!0||K.isBatchedMesh&&Zt.batchingColor===!0&&K.colorTexture===null||K.isBatchedMesh&&Zt.batchingColor===!1&&K.colorTexture!==null||K.isInstancedMesh&&Zt.instancing===!1||!K.isInstancedMesh&&Zt.instancing===!0||K.isSkinnedMesh&&Zt.skinning===!1||!K.isSkinnedMesh&&Zt.skinning===!0||K.isInstancedMesh&&Zt.instancingColor===!0&&K.instanceColor===null||K.isInstancedMesh&&Zt.instancingColor===!1&&K.instanceColor!==null||K.isInstancedMesh&&Zt.instancingMorph===!0&&K.morphTexture===null||K.isInstancedMesh&&Zt.instancingMorph===!1&&K.morphTexture!==null||Zt.envMap!==Ht||tt.fog===!0&&Zt.fog!==Dt||Zt.numClippingPlanes!==void 0&&(Zt.numClippingPlanes!==zt.numPlanes||Zt.numIntersection!==zt.numIntersection)||Zt.vertexAlphas!==kt||Zt.vertexTangents!==Qt||Zt.morphTargets!==Wt||Zt.morphNormals!==$t||Zt.morphColors!==Le||Zt.toneMapping!==Je||Zt.morphTargetsCount!==ze)&&(se=!0):(se=!0,Zt.__version=tt.version);let En=Zt.currentProgram;se===!0&&(En=Xs(tt,Y,K));let Ji=!1,bn=!1,hi=!1;const Fe=En.getUniforms(),Tn=Zt.uniforms;if(qt.useProgram(En.program)&&(Ji=!0,bn=!0,hi=!0),tt.id!==dt&&(dt=tt.id,bn=!0),Ji||ct!==R){qt.buffers.depth.getReversed()&&R.reversedDepth!==!0&&(R._reversedDepth=!0,R.updateProjectionMatrix()),Fe.setValue(G,"projectionMatrix",R.projectionMatrix),Fe.setValue(G,"viewMatrix",R.matrixWorldInverse);const Rn=Fe.map.cameraPosition;Rn!==void 0&&Rn.setValue(G,Se.setFromMatrixPosition(R.matrixWorld)),Pe.logarithmicDepthBuffer&&Fe.setValue(G,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),(tt.isMeshPhongMaterial||tt.isMeshToonMaterial||tt.isMeshLambertMaterial||tt.isMeshBasicMaterial||tt.isMeshStandardMaterial||tt.isShaderMaterial)&&Fe.setValue(G,"isOrthographic",R.isOrthographicCamera===!0),ct!==R&&(ct=R,bn=!0,hi=!0)}if(Zt.needsLights&&(Ne.state.directionalShadowMap.length>0&&Fe.setValue(G,"directionalShadowMap",Ne.state.directionalShadowMap,q),Ne.state.spotShadowMap.length>0&&Fe.setValue(G,"spotShadowMap",Ne.state.spotShadowMap,q),Ne.state.pointShadowMap.length>0&&Fe.setValue(G,"pointShadowMap",Ne.state.pointShadowMap,q)),K.isSkinnedMesh){Fe.setOptional(G,K,"bindMatrix"),Fe.setOptional(G,K,"bindMatrixInverse");const An=K.skeleton;An&&(An.boneTexture===null&&An.computeBoneTexture(),Fe.setValue(G,"boneTexture",An.boneTexture,q))}K.isBatchedMesh&&(Fe.setOptional(G,K,"batchingTexture"),Fe.setValue(G,"batchingTexture",K._matricesTexture,q),Fe.setOptional(G,K,"batchingIdTexture"),Fe.setValue(G,"batchingIdTexture",K._indirectTexture,q),Fe.setOptional(G,K,"batchingColorTexture"),K._colorsTexture!==null&&Fe.setValue(G,"batchingColorTexture",K._colorsTexture,q));const mn=rt.morphAttributes;if((mn.position!==void 0||mn.normal!==void 0||mn.color!==void 0)&&ce.update(K,rt,En),(bn||Zt.receiveShadow!==K.receiveShadow)&&(Zt.receiveShadow=K.receiveShadow,Fe.setValue(G,"receiveShadow",K.receiveShadow)),tt.isMeshGouraudMaterial&&tt.envMap!==null&&(Tn.envMap.value=Ht,Tn.flipEnvMap.value=Ht.isCubeTexture&&Ht.isRenderTargetTexture===!1?-1:1),tt.isMeshStandardMaterial&&tt.envMap===null&&Y.environment!==null&&(Tn.envMapIntensity.value=Y.environmentIntensity),Tn.dfgLUT!==void 0&&(Tn.dfgLUT.value=YA()),bn&&(Fe.setValue(G,"toneMappingExposure",C.toneMappingExposure),Zt.needsLights&&eo(Tn,hi),Dt&&tt.fog===!0&&ne.refreshFogUniforms(Tn,Dt),ne.refreshMaterialUniforms(Tn,tt,gt,at,B.state.transmissionRenderTarget[R.id]),oc.upload(G,_l(Zt),Tn,q)),tt.isShaderMaterial&&tt.uniformsNeedUpdate===!0&&(oc.upload(G,_l(Zt),Tn,q),tt.uniformsNeedUpdate=!1),tt.isSpriteMaterial&&Fe.setValue(G,"center",K.center),Fe.setValue(G,"modelViewMatrix",K.modelViewMatrix),Fe.setValue(G,"normalMatrix",K.normalMatrix),Fe.setValue(G,"modelMatrix",K.matrixWorld),tt.isShaderMaterial||tt.isRawShaderMaterial){const An=tt.uniformsGroups;for(let Rn=0,ks=An.length;Rn<ks;Rn++){const Ci=An[Rn];St.update(Ci,En),St.bind(Ci,En)}}return En}function eo(R,Y){R.ambientLightColor.needsUpdate=Y,R.lightProbe.needsUpdate=Y,R.directionalLights.needsUpdate=Y,R.directionalLightShadows.needsUpdate=Y,R.pointLights.needsUpdate=Y,R.pointLightShadows.needsUpdate=Y,R.spotLights.needsUpdate=Y,R.spotLightShadows.needsUpdate=Y,R.rectAreaLights.needsUpdate=Y,R.hemisphereLights.needsUpdate=Y}function Aa(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return V},this.getActiveMipmapLevel=function(){return J},this.getRenderTarget=function(){return it},this.setRenderTargetTextures=function(R,Y,rt){const tt=E.get(R);tt.__autoAllocateDepthBuffer=R.resolveDepthBuffer===!1,tt.__autoAllocateDepthBuffer===!1&&(tt.__useRenderToTexture=!1),E.get(R.texture).__webglTexture=Y,E.get(R.depthTexture).__webglTexture=tt.__autoAllocateDepthBuffer?void 0:rt,tt.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(R,Y){const rt=E.get(R);rt.__webglFramebuffer=Y,rt.__useDefaultFramebuffer=Y===void 0};const Ra=G.createFramebuffer();this.setRenderTarget=function(R,Y=0,rt=0){it=R,V=Y,J=rt;let tt=null,K=!1,Dt=!1;if(R){const Lt=E.get(R);if(Lt.__useDefaultFramebuffer!==void 0){qt.bindFramebuffer(G.FRAMEBUFFER,Lt.__webglFramebuffer),F.copy(R.viewport),H.copy(R.scissor),st=R.scissorTest,qt.viewport(F),qt.scissor(H),qt.setScissorTest(st),dt=-1;return}else if(Lt.__webglFramebuffer===void 0)q.setupRenderTarget(R);else if(Lt.__hasExternalTextures)q.rebindTextures(R,E.get(R.texture).__webglTexture,E.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){const Qt=R.depthTexture;if(Lt.__boundDepthTexture!==Qt){if(Qt!==null&&E.has(Qt)&&(R.width!==Qt.image.width||R.height!==Qt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");q.setupDepthRenderbuffer(R)}}const Ht=R.texture;(Ht.isData3DTexture||Ht.isDataArrayTexture||Ht.isCompressedArrayTexture)&&(Dt=!0);const kt=E.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray(kt[Y])?tt=kt[Y][rt]:tt=kt[Y],K=!0):R.samples>0&&q.useMultisampledRTT(R)===!1?tt=E.get(R).__webglMultisampledFramebuffer:Array.isArray(kt)?tt=kt[rt]:tt=kt,F.copy(R.viewport),H.copy(R.scissor),st=R.scissorTest}else F.copy(nt).multiplyScalar(gt).floor(),H.copy(ut).multiplyScalar(gt).floor(),st=wt;if(rt!==0&&(tt=Ra),qt.bindFramebuffer(G.FRAMEBUFFER,tt)&&qt.drawBuffers(R,tt),qt.viewport(F),qt.scissor(H),qt.setScissorTest(st),K){const Lt=E.get(R.texture);G.framebufferTexture2D(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_CUBE_MAP_POSITIVE_X+Y,Lt.__webglTexture,rt)}else if(Dt){const Lt=Y;for(let Ht=0;Ht<R.textures.length;Ht++){const kt=E.get(R.textures[Ht]);G.framebufferTextureLayer(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0+Ht,kt.__webglTexture,rt,Lt)}}else if(R!==null&&rt!==0){const Lt=E.get(R.texture);G.framebufferTexture2D(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_2D,Lt.__webglTexture,rt)}dt=-1},this.readRenderTargetPixels=function(R,Y,rt,tt,K,Dt,Bt,Lt=0){if(!(R&&R.isWebGLRenderTarget)){Re("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ht=E.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Bt!==void 0&&(Ht=Ht[Bt]),Ht){qt.bindFramebuffer(G.FRAMEBUFFER,Ht);try{const kt=R.textures[Lt],Qt=kt.format,Wt=kt.type;if(!Pe.textureFormatReadable(Qt)){Re("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Pe.textureTypeReadable(Wt)){Re("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Y>=0&&Y<=R.width-tt&&rt>=0&&rt<=R.height-K&&(R.textures.length>1&&G.readBuffer(G.COLOR_ATTACHMENT0+Lt),G.readPixels(Y,rt,tt,K,bt.convert(Qt),bt.convert(Wt),Dt))}finally{const kt=it!==null?E.get(it).__webglFramebuffer:null;qt.bindFramebuffer(G.FRAMEBUFFER,kt)}}},this.readRenderTargetPixelsAsync=async function(R,Y,rt,tt,K,Dt,Bt,Lt=0){if(!(R&&R.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ht=E.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Bt!==void 0&&(Ht=Ht[Bt]),Ht)if(Y>=0&&Y<=R.width-tt&&rt>=0&&rt<=R.height-K){qt.bindFramebuffer(G.FRAMEBUFFER,Ht);const kt=R.textures[Lt],Qt=kt.format,Wt=kt.type;if(!Pe.textureFormatReadable(Qt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Pe.textureTypeReadable(Wt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const $t=G.createBuffer();G.bindBuffer(G.PIXEL_PACK_BUFFER,$t),G.bufferData(G.PIXEL_PACK_BUFFER,Dt.byteLength,G.STREAM_READ),R.textures.length>1&&G.readBuffer(G.COLOR_ATTACHMENT0+Lt),G.readPixels(Y,rt,tt,K,bt.convert(Qt),bt.convert(Wt),0);const Le=it!==null?E.get(it).__webglFramebuffer:null;qt.bindFramebuffer(G.FRAMEBUFFER,Le);const Je=G.fenceSync(G.SYNC_GPU_COMMANDS_COMPLETE,0);return G.flush(),await sM(G,Je,4),G.bindBuffer(G.PIXEL_PACK_BUFFER,$t),G.getBufferSubData(G.PIXEL_PACK_BUFFER,0,Dt),G.deleteBuffer($t),G.deleteSync(Je),Dt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(R,Y=null,rt=0){const tt=Math.pow(2,-rt),K=Math.floor(R.image.width*tt),Dt=Math.floor(R.image.height*tt),Bt=Y!==null?Y.x:0,Lt=Y!==null?Y.y:0;q.setTexture2D(R,0),G.copyTexSubImage2D(G.TEXTURE_2D,rt,0,0,Bt,Lt,K,Dt),qt.unbindTexture()};const us=G.createFramebuffer(),Ca=G.createFramebuffer();this.copyTextureToTexture=function(R,Y,rt=null,tt=null,K=0,Dt=null){Dt===null&&(K!==0?(ul("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Dt=K,K=0):Dt=0);let Bt,Lt,Ht,kt,Qt,Wt,$t,Le,Je;const Ye=R.isCompressedTexture?R.mipmaps[Dt]:R.image;if(rt!==null)Bt=rt.max.x-rt.min.x,Lt=rt.max.y-rt.min.y,Ht=rt.isBox3?rt.max.z-rt.min.z:1,kt=rt.min.x,Qt=rt.min.y,Wt=rt.isBox3?rt.min.z:0;else{const mn=Math.pow(2,-K);Bt=Math.floor(Ye.width*mn),Lt=Math.floor(Ye.height*mn),R.isDataArrayTexture?Ht=Ye.depth:R.isData3DTexture?Ht=Math.floor(Ye.depth*mn):Ht=1,kt=0,Qt=0,Wt=0}tt!==null?($t=tt.x,Le=tt.y,Je=tt.z):($t=0,Le=0,Je=0);const ze=bt.convert(Y.format),Zt=bt.convert(Y.type);let Ne;Y.isData3DTexture?(q.setTexture3D(Y,0),Ne=G.TEXTURE_3D):Y.isDataArrayTexture||Y.isCompressedArrayTexture?(q.setTexture2DArray(Y,0),Ne=G.TEXTURE_2D_ARRAY):(q.setTexture2D(Y,0),Ne=G.TEXTURE_2D),G.pixelStorei(G.UNPACK_FLIP_Y_WEBGL,Y.flipY),G.pixelStorei(G.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Y.premultiplyAlpha),G.pixelStorei(G.UNPACK_ALIGNMENT,Y.unpackAlignment);const se=G.getParameter(G.UNPACK_ROW_LENGTH),En=G.getParameter(G.UNPACK_IMAGE_HEIGHT),Ji=G.getParameter(G.UNPACK_SKIP_PIXELS),bn=G.getParameter(G.UNPACK_SKIP_ROWS),hi=G.getParameter(G.UNPACK_SKIP_IMAGES);G.pixelStorei(G.UNPACK_ROW_LENGTH,Ye.width),G.pixelStorei(G.UNPACK_IMAGE_HEIGHT,Ye.height),G.pixelStorei(G.UNPACK_SKIP_PIXELS,kt),G.pixelStorei(G.UNPACK_SKIP_ROWS,Qt),G.pixelStorei(G.UNPACK_SKIP_IMAGES,Wt);const Fe=R.isDataArrayTexture||R.isData3DTexture,Tn=Y.isDataArrayTexture||Y.isData3DTexture;if(R.isDepthTexture){const mn=E.get(R),An=E.get(Y),Rn=E.get(mn.__renderTarget),ks=E.get(An.__renderTarget);qt.bindFramebuffer(G.READ_FRAMEBUFFER,Rn.__webglFramebuffer),qt.bindFramebuffer(G.DRAW_FRAMEBUFFER,ks.__webglFramebuffer);for(let Ci=0;Ci<Ht;Ci++)Fe&&(G.framebufferTextureLayer(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,E.get(R).__webglTexture,K,Wt+Ci),G.framebufferTextureLayer(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,E.get(Y).__webglTexture,Dt,Je+Ci)),G.blitFramebuffer(kt,Qt,Bt,Lt,$t,Le,Bt,Lt,G.DEPTH_BUFFER_BIT,G.NEAREST);qt.bindFramebuffer(G.READ_FRAMEBUFFER,null),qt.bindFramebuffer(G.DRAW_FRAMEBUFFER,null)}else if(K!==0||R.isRenderTargetTexture||E.has(R)){const mn=E.get(R),An=E.get(Y);qt.bindFramebuffer(G.READ_FRAMEBUFFER,us),qt.bindFramebuffer(G.DRAW_FRAMEBUFFER,Ca);for(let Rn=0;Rn<Ht;Rn++)Fe?G.framebufferTextureLayer(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,mn.__webglTexture,K,Wt+Rn):G.framebufferTexture2D(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_2D,mn.__webglTexture,K),Tn?G.framebufferTextureLayer(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,An.__webglTexture,Dt,Je+Rn):G.framebufferTexture2D(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_2D,An.__webglTexture,Dt),K!==0?G.blitFramebuffer(kt,Qt,Bt,Lt,$t,Le,Bt,Lt,G.COLOR_BUFFER_BIT,G.NEAREST):Tn?G.copyTexSubImage3D(Ne,Dt,$t,Le,Je+Rn,kt,Qt,Bt,Lt):G.copyTexSubImage2D(Ne,Dt,$t,Le,kt,Qt,Bt,Lt);qt.bindFramebuffer(G.READ_FRAMEBUFFER,null),qt.bindFramebuffer(G.DRAW_FRAMEBUFFER,null)}else Tn?R.isDataTexture||R.isData3DTexture?G.texSubImage3D(Ne,Dt,$t,Le,Je,Bt,Lt,Ht,ze,Zt,Ye.data):Y.isCompressedArrayTexture?G.compressedTexSubImage3D(Ne,Dt,$t,Le,Je,Bt,Lt,Ht,ze,Ye.data):G.texSubImage3D(Ne,Dt,$t,Le,Je,Bt,Lt,Ht,ze,Zt,Ye):R.isDataTexture?G.texSubImage2D(G.TEXTURE_2D,Dt,$t,Le,Bt,Lt,ze,Zt,Ye.data):R.isCompressedTexture?G.compressedTexSubImage2D(G.TEXTURE_2D,Dt,$t,Le,Ye.width,Ye.height,ze,Ye.data):G.texSubImage2D(G.TEXTURE_2D,Dt,$t,Le,Bt,Lt,ze,Zt,Ye);G.pixelStorei(G.UNPACK_ROW_LENGTH,se),G.pixelStorei(G.UNPACK_IMAGE_HEIGHT,En),G.pixelStorei(G.UNPACK_SKIP_PIXELS,Ji),G.pixelStorei(G.UNPACK_SKIP_ROWS,bn),G.pixelStorei(G.UNPACK_SKIP_IMAGES,hi),Dt===0&&Y.generateMipmaps&&G.generateMipmap(Ne),qt.unbindTexture()},this.initRenderTarget=function(R){E.get(R).__webglFramebuffer===void 0&&q.setupRenderTarget(R)},this.initTexture=function(R){R.isCubeTexture?q.setTextureCube(R,0):R.isData3DTexture?q.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?q.setTexture2DArray(R,0):q.setTexture2D(R,0),qt.unbindTexture()},this.resetState=function(){V=0,J=0,it=null,qt.reset(),Pt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Yi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=Ce._getDrawingBufferColorSpace(t),i.unpackColorSpace=Ce._getUnpackColorSpace()}}const ZA=o=>o.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),KA=o=>o.replace(/^([A-Z])|[\s-_]+(\w)/g,(t,i,s)=>s?s.toUpperCase():i.toLowerCase()),yv=o=>{const t=KA(o);return t.charAt(0).toUpperCase()+t.slice(1)},ux=(...o)=>o.filter((t,i,s)=>!!t&&t.trim()!==""&&s.indexOf(t)===i).join(" ").trim(),QA=o=>{for(const t in o)if(t.startsWith("aria-")||t==="role"||t==="title")return!0};var JA={xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};const $A=Jt.forwardRef(({color:o="currentColor",size:t=24,strokeWidth:i=2,absoluteStrokeWidth:s,className:l="",children:u,iconNode:h,...d},m)=>Jt.createElement("svg",{ref:m,...JA,width:t,height:t,stroke:o,strokeWidth:s?Number(i)*24/Number(t):i,className:ux("lucide",l),...!u&&!QA(d)&&{"aria-hidden":"true"},...d},[...h.map(([p,_])=>Jt.createElement(p,_)),...Array.isArray(u)?u:[u]]));const cx=(o,t)=>{const i=Jt.forwardRef(({className:s,...l},u)=>Jt.createElement($A,{ref:u,iconNode:t,className:ux(`lucide-${ZA(yv(o))}`,`lucide-${o}`,s),...l}));return i.displayName=yv(o),i};const tR=[["rect",{x:"14",y:"3",width:"5",height:"18",rx:"1",key:"kaeet6"}],["rect",{x:"5",y:"3",width:"5",height:"18",rx:"1",key:"1wsw3u"}]],eR=cx("pause",tR);const nR=[["path",{d:"M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z",key:"10ikf1"}]],iR=cx("play",nR),aR=/^[og]\s*(.+)?/,sR=/^mtllib /,rR=/^usemtl /,oR=/^usemap /,Mv=/\s+/,Ev=new j,pd=new j,bv=new j,Tv=new j,Mi=new j,tc=new le;function lR(){const o={objects:[],object:{},vertices:[],normals:[],colors:[],uvs:[],materials:{},materialLibraries:[],startObject:function(t,i){if(this.object&&this.object.fromDeclaration===!1){this.object.name=t,this.object.fromDeclaration=i!==!1;return}const s=this.object&&typeof this.object.currentMaterial=="function"?this.object.currentMaterial():void 0;if(this.object&&typeof this.object._finalize=="function"&&this.object._finalize(!0),this.object={name:t||"",fromDeclaration:i!==!1,geometry:{vertices:[],normals:[],colors:[],uvs:[],hasUVIndices:!1},materials:[],smooth:!0,startMaterial:function(l,u){const h=this._finalize(!1);h&&(h.inherited||h.groupCount<=0)&&this.materials.splice(h.index,1);const d={index:this.materials.length,name:l||"",mtllib:Array.isArray(u)&&u.length>0?u[u.length-1]:"",smooth:h!==void 0?h.smooth:this.smooth,groupStart:h!==void 0?h.groupEnd:0,groupEnd:-1,groupCount:-1,inherited:!1,clone:function(m){const p={index:typeof m=="number"?m:this.index,name:this.name,mtllib:this.mtllib,smooth:this.smooth,groupStart:0,groupEnd:-1,groupCount:-1,inherited:!1};return p.clone=this.clone.bind(p),p}};return this.materials.push(d),d},currentMaterial:function(){if(this.materials.length>0)return this.materials[this.materials.length-1]},_finalize:function(l){const u=this.currentMaterial();if(u&&u.groupEnd===-1&&(u.groupEnd=this.geometry.vertices.length/3,u.groupCount=u.groupEnd-u.groupStart,u.inherited=!1),l&&this.materials.length>1)for(let h=this.materials.length-1;h>=0;h--)this.materials[h].groupCount<=0&&this.materials.splice(h,1);return l&&this.materials.length===0&&this.materials.push({name:"",smooth:this.smooth}),u}},s&&s.name&&typeof s.clone=="function"){const l=s.clone(0);l.inherited=!0,this.object.materials.push(l)}this.objects.push(this.object)},finalize:function(){this.object&&typeof this.object._finalize=="function"&&this.object._finalize(!0)},parseVertexIndex:function(t,i){const s=parseInt(t,10);return(s>=0?s-1:s+i/3)*3},parseNormalIndex:function(t,i){const s=parseInt(t,10);return(s>=0?s-1:s+i/3)*3},parseUVIndex:function(t,i){const s=parseInt(t,10);return(s>=0?s-1:s+i/2)*2},addVertex:function(t,i,s){const l=this.vertices,u=this.object.geometry.vertices;u.push(l[t+0],l[t+1],l[t+2]),u.push(l[i+0],l[i+1],l[i+2]),u.push(l[s+0],l[s+1],l[s+2])},addVertexPoint:function(t){const i=this.vertices;this.object.geometry.vertices.push(i[t+0],i[t+1],i[t+2])},addVertexLine:function(t){const i=this.vertices;this.object.geometry.vertices.push(i[t+0],i[t+1],i[t+2])},addNormal:function(t,i,s){const l=this.normals,u=this.object.geometry.normals;u.push(l[t+0],l[t+1],l[t+2]),u.push(l[i+0],l[i+1],l[i+2]),u.push(l[s+0],l[s+1],l[s+2])},addFaceNormal:function(t,i,s){const l=this.vertices,u=this.object.geometry.normals;Ev.fromArray(l,t),pd.fromArray(l,i),bv.fromArray(l,s),Mi.subVectors(bv,pd),Tv.subVectors(Ev,pd),Mi.cross(Tv),Mi.normalize(),u.push(Mi.x,Mi.y,Mi.z),u.push(Mi.x,Mi.y,Mi.z),u.push(Mi.x,Mi.y,Mi.z)},addColor:function(t,i,s){const l=this.colors,u=this.object.geometry.colors;l[t]!==void 0&&u.push(l[t+0],l[t+1],l[t+2]),l[i]!==void 0&&u.push(l[i+0],l[i+1],l[i+2]),l[s]!==void 0&&u.push(l[s+0],l[s+1],l[s+2])},addUV:function(t,i,s){const l=this.uvs,u=this.object.geometry.uvs;u.push(l[t+0],l[t+1]),u.push(l[i+0],l[i+1]),u.push(l[s+0],l[s+1])},addDefaultUV:function(){const t=this.object.geometry.uvs;t.push(0,0),t.push(0,0),t.push(0,0)},addUVLine:function(t){const i=this.uvs;this.object.geometry.uvs.push(i[t+0],i[t+1])},addFace:function(t,i,s,l,u,h,d,m,p){const _=this.vertices.length;let g=this.parseVertexIndex(t,_),x=this.parseVertexIndex(i,_),M=this.parseVertexIndex(s,_);if(this.addVertex(g,x,M),this.addColor(g,x,M),d!==void 0&&d!==""){const b=this.normals.length;g=this.parseNormalIndex(d,b),x=this.parseNormalIndex(m,b),M=this.parseNormalIndex(p,b),this.addNormal(g,x,M)}else this.addFaceNormal(g,x,M);if(l!==void 0&&l!==""){const b=this.uvs.length;g=this.parseUVIndex(l,b),x=this.parseUVIndex(u,b),M=this.parseUVIndex(h,b),this.addUV(g,x,M),this.object.geometry.hasUVIndices=!0}else this.addDefaultUV()},addPointGeometry:function(t){this.object.geometry.type="Points";const i=this.vertices.length;for(let s=0,l=t.length;s<l;s++){const u=this.parseVertexIndex(t[s],i);this.addVertexPoint(u),this.addColor(u)}},addLineGeometry:function(t,i){this.object.geometry.type="Line";const s=this.vertices.length,l=this.uvs.length;for(let u=0,h=t.length;u<h;u++)this.addVertexLine(this.parseVertexIndex(t[u],s));for(let u=0,h=i.length;u<h;u++)this.addUVLine(this.parseUVIndex(i[u],l))}};return o.startObject("",!1),o}class uR extends pl{constructor(t){super(t),this.materials=null}load(t,i,s,l){const u=this,h=new qM(this.manager);h.setPath(this.path),h.setRequestHeader(this.requestHeader),h.setWithCredentials(this.withCredentials),h.load(t,function(d){try{i(u.parse(d))}catch(m){l?l(m):console.error(m),u.manager.itemError(t)}},s,l)}setMaterials(t){return this.materials=t,this}parse(t){const i=new lR;t.indexOf(`\r
`)!==-1&&(t=t.replace(/\r\n/g,`
`)),t.indexOf(`\\
`)!==-1&&(t=t.replace(/\\\n/g,""));const s=t.split(`
`);let l=[];for(let d=0,m=s.length;d<m;d++){const p=s[d].trimStart();if(p.length===0)continue;const _=p.charAt(0);if(_!=="#")if(_==="v"){const g=p.split(Mv);switch(g[0]){case"v":i.vertices.push(parseFloat(g[1]),parseFloat(g[2]),parseFloat(g[3])),g.length>=7?(tc.setRGB(parseFloat(g[4]),parseFloat(g[5]),parseFloat(g[6]),oi),i.colors.push(tc.r,tc.g,tc.b)):i.colors.push(void 0,void 0,void 0);break;case"vn":i.normals.push(parseFloat(g[1]),parseFloat(g[2]),parseFloat(g[3]));break;case"vt":i.uvs.push(parseFloat(g[1]),parseFloat(g[2]));break}}else if(_==="f"){const x=p.slice(1).trim().split(Mv),M=[];for(let T=0,y=x.length;T<y;T++){const v=x[T];if(v.length>0){const U=v.split("/");M.push(U)}}const b=M[0];for(let T=1,y=M.length-1;T<y;T++){const v=M[T],U=M[T+1];i.addFace(b[0],v[0],U[0],b[1],v[1],U[1],b[2],v[2],U[2])}}else if(_==="l"){const g=p.substring(1).trim().split(" ");let x=[];const M=[];if(p.indexOf("/")===-1)x=g;else for(let b=0,T=g.length;b<T;b++){const y=g[b].split("/");y[0]!==""&&x.push(y[0]),y[1]!==""&&M.push(y[1])}i.addLineGeometry(x,M)}else if(_==="p"){const x=p.slice(1).trim().split(" ");i.addPointGeometry(x)}else if((l=aR.exec(p))!==null){const g=(" "+l[0].slice(1).trim()).slice(1);i.startObject(g)}else if(rR.test(p))i.object.startMaterial(p.substring(7).trim(),i.materialLibraries);else if(sR.test(p))i.materialLibraries.push(p.substring(7).trim());else if(oR.test(p))console.warn('THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.');else if(_==="s"){if(l=p.split(" "),l.length>1){const x=l[1].trim().toLowerCase();i.object.smooth=x!=="0"&&x!=="off"}else i.object.smooth=!0;const g=i.object.currentMaterial();g&&(g.smooth=i.object.smooth)}else{if(p==="\0")continue;console.warn('THREE.OBJLoader: Unexpected line: "'+p+'"')}}i.finalize();const u=new Vr;if(u.materialLibraries=[].concat(i.materialLibraries),!(i.objects.length===1&&i.objects[0].geometry.vertices.length===0)===!0)for(let d=0,m=i.objects.length;d<m;d++){const p=i.objects[d],_=p.geometry,g=p.materials,x=_.type==="Line",M=_.type==="Points";let b=!1;if(_.vertices.length===0)continue;const T=new Hn;T.setAttribute("position",new sn(_.vertices,3)),_.normals.length>0&&T.setAttribute("normal",new sn(_.normals,3)),_.colors.length>0&&(b=!0,T.setAttribute("color",new sn(_.colors,3))),_.hasUVIndices===!0&&T.setAttribute("uv",new sn(_.uvs,2));const y=[];for(let U=0,L=g.length;U<L;U++){const D=g[U],B=D.name+"_"+D.smooth+"_"+b;let O=i.materials[B];if(this.materials!==null){if(O=this.materials.create(D.name),x&&O&&!(O instanceof rc)){const P=new rc;Bi.prototype.copy.call(P,O),P.color.copy(O.color),O=P}else if(M&&O&&!(O instanceof il)){const P=new il({size:10,sizeAttenuation:!1});Bi.prototype.copy.call(P,O),P.color.copy(O.color),P.map=O.map,O=P}}O===void 0&&(x?O=new rc:M?O=new il({size:1,sizeAttenuation:!1}):O=new IM,O.name=D.name,O.flatShading=!D.smooth,O.vertexColors=b,i.materials[B]=O),y.push(O)}let v;if(y.length>1){for(let U=0,L=g.length;U<L;U++){const D=g[U];T.addGroup(D.groupStart,D.groupCount,U)}x?v=new q_(T,y):M?v=new rd(T,y):v=new ci(T,y)}else x?v=new q_(T,y[0]):M?v=new rd(T,y[0]):v=new ci(T,y[0]);v.name=p.name,u.add(v)}else if(i.vertices.length>0){const d=new il({size:1,sizeAttenuation:!1}),m=new Hn;m.setAttribute("position",new sn(i.vertices,3)),i.colors.length>0&&i.colors[0]!==void 0&&(m.setAttribute("color",new sn(i.colors,3)),d.vertexColors=!0);const p=new rd(m,d);u.add(p)}return u}}const lc={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}jr.BlurDirectionX=new ee(1,0);jr.BlurDirectionY=new ee(0,1);let gc=null;const bi="/portfolio/";console.log("BASE_URL:",bi);const Rv=({fog:o=!0,hue:t=0,opacity:i=1,path:s=`${bi}assets/images/rad-grad.png`,sat:l=.5,size:u=10,x:h=0,y:d=0,z:m=0})=>{let p=new le().setHSL(t,1,l);console.log("Loading texture from path:",s);const _=new ex().load(s,M=>console.log("Texture loaded successfully:",s),void 0,M=>console.error("Failed to load texture:",s,M)),g=new Jv({fog:o,map:_,color:p,opacity:i,transparent:!0,depthWrite:!1,blending:Bs}),x=new UM(g);return x.scale.set(u,u,u),x.position.set(h,d,m),x},pe={colors:{primary:"#fc2d2dff",secondary:"#ff5100ff",background:"#000000ff",text:"#f1f5f9",accent:"#ffd900ff"},loading:{duration:2500,messages:["Initializing Portfolio...","Requiring Libraries...","Loading Assets...","Here We Go..."]},animations:{logoFadeIn:300,delayBeforeElements:300,logoMoveUp:1200,contentFadeIn:1250},music:{playlist:["Dark Thoughts","Down With Me","TASTE","BAD TIME","NUMBER 2","NEVER LAST"].map(o=>o.includes(".wav")?`${bi}assets/music/${o}`:`${bi}assets/music/${o}.flac`),volume:.015,fadeDuration:250},socials:[{name:"x",url:"https://x.com",icon:`${bi}assets/icons/x.svg`},{name:"instagram",url:"https://instagram.com",icon:`${bi}assets/icons/instagram.svg`},{name:"github",url:"https://github.com",icon:`${bi}assets/icons/github.svg`},{name:"linkedin",url:"https://linkedin.com",icon:`${bi}assets/icons/linkedin.svg`}]};console.log("CONFIG.music.playlist:",pe.music.playlist);console.log("CONFIG.socials:",pe.socials);const Mc=Jt.createContext({activeMagneticId:null,setActiveMagneticId:()=>{},followerPos:{current:{x:-100,y:-100}},musicButtonRect:{current:null}}),vR=()=>{const o=Jt.useRef(null),t=Jt.useRef({x:-100,y:-100}),i=Jt.useRef({x:-100,y:-100}),{activeMagneticId:s,followerPos:l,musicButtonRect:u}=Jt.useContext(Mc),h=s!==null,d=s==="music-button";return Jt.useEffect(()=>{const m=g=>{t.current={x:g.clientX,y:g.clientY}};window.addEventListener("mousemove",m);let p;const _=()=>{const g=h?.045:.1;let x=t.current.x,M=t.current.y;if(d&&u.current){const b=u.current,T=b.left+b.width/2,y=b.top+b.height/2;x=T,M=y}i.current.x+=(x-i.current.x)*g,i.current.y+=(M-i.current.y)*g,l.current.x=i.current.x,l.current.y=i.current.y,o.current&&(o.current.style.transform=`translate3d(${i.current.x}px, ${i.current.y}px, 0) translate(-50%, -50%)`),p=requestAnimationFrame(_)};return _(),()=>{window.removeEventListener("mousemove",m),cancelAnimationFrame(p)}},[h,d,l,u]),me.jsx("div",{ref:o,className:"fixed pointer-events-none rounded-full bg-white z-[60] transition-all duration-200 ease-out",style:{backgroundColor:pe.colors.primary,top:0,left:0,width:d?"clamp(57px, 12vmin, 125px)":h?"clamp(32px, 8vmin, 75px)":"clamp(25px, 8vmin, 60px)",height:d?"clamp(57px, 12vmin, 125px)":h?"clamp(32px, 8vmin, 75px)":"clamp(25px, 8vmin, 60px)",opacity:1,mixBlendMode:"difference",willChange:"transform, width, height"}})},xR=({children:o,id:t})=>{const i=Jt.useRef(null),{activeMagneticId:s,setActiveMagneticId:l,followerPos:u}=Jt.useContext(Mc),h=Jt.useRef(null),d=Jt.useRef({x:0,y:0,scale:1});return Jt.useEffect(()=>{const m=()=>{i.current&&(h.current=i.current.getBoundingClientRect())};return m(),window.addEventListener("resize",m),()=>window.removeEventListener("resize",m)},[]),Jt.useEffect(()=>{let m;const p=()=>{if(!h.current){m=requestAnimationFrame(p);return}const _=u.current.x,g=u.current.y,{left:x,top:M,width:b,height:T}=h.current,y=x+b/2,v=M+T/2,U=Math.hypot(_-y,g-v),L=Math.min(window.innerWidth,window.innerHeight)*.025;let D=0,B=0,O=1;U<L&&(s===null||s===t)?(s!==t&&l(t),D=_-y,B=g-v,O=1.15):(s===t&&U>L+10&&l(null),D=0,B=0,O=1);const P=.1;d.current.x+=(D-d.current.x)*P,d.current.y+=(B-d.current.y)*P,d.current.scale+=(O-d.current.scale)*P,i.current&&(i.current.style.transform=`translate3d(${d.current.x}px, ${d.current.y}px, 0) scale(${d.current.scale})`),m=requestAnimationFrame(p)};return p(),()=>cancelAnimationFrame(m)},[t,s,l,u]),me.jsx("div",{ref:i,className:"will-change-transform",children:o})},SR=({style:o,showBackground:t})=>{const i=Jt.useRef(null),s=Jt.useRef(null),l=Jt.useRef(t);return Jt.useEffect(()=>{l.current=t},[t]),Jt.useEffect(()=>{if(!i.current)return;for(;i.current.firstChild;)i.current.removeChild(i.current.firstChild);const u=new wM,h=new Ei(75,1,.1,1e3);h.position.z=75;const d=Math.min(Math.min(window.innerWidth,window.innerHeight)*.7,925),m=new jA({antialias:!0,alpha:!0});m.setPixelRatio(window.devicePixelRatio),m.setSize(d,d),m.setClearColor(0,0),m.toneMapping=mp,i.current.appendChild(m.domElement);const p=new gR(u,h),_=new jr(new ee(d,d),2,.1,.1025),g=new mR(m);g.addPass(p),g.addPass(_);const x=new Vr;u.add(x),s.current=x;const M=`${bi}assets/textures/matcaps/Doku-Doku-no-Mi.png`;console.log("Loading matcap texture from:",M);const b=new ex().load(M,k=>console.log("Matcap texture loaded successfully:",M),void 0,k=>console.error("Failed to load matcap texture:",M,k)),T=new GM({matcap:b,color:new le(12271423)}),y=new KM(16734553);y.position.y=2,u.add(y),u.add(new QM(16734553));const v=Rv({path:`${bi}assets/images/rad-grad.png`,hue:.7,opacity:0,sat:.5,size:95,x:0,y:0,z:-25}),U=Rv({path:`${bi}assets/images/halftone_7.png`,hue:1,opacity:0,sat:0,size:95,x:0,y:0,z:-20});v.userData.targetOpacity=.035,U.userData.targetOpacity=.8,u.add(v),u.add(U);const L=[v,U],D=`${bi}assets/models/KidBuu.obj`;console.log("Loading 3D model from:",D),new uR().load(D,k=>{console.log("3D model loaded successfully:",D),k.traverse(it=>{it.isMesh&&(it.material=T)});const C=new Is().setFromObject(k),w=new j;C.getCenter(w),k.position.set(-w.x,-w.y,-w.z),k.scale.set(.25,.25,.25),k.updateMatrixWorld(!0);const V=new Is().setFromObject(k),J=new j;V.getCenter(J),k.position.x-=J.x,k.position.y-=J.y+J.y*.04,k.position.z-=J.z,x.add(k),gc&&gc()},void 0,k=>{console.error("Failed to load Kid Buu model",k);const C=new ci(new wp(8,1.35,64,16,2,3),T);x.add(C)});const O=new ix,P=()=>{requestAnimationFrame(P);const k=s.current,C=O.getElapsedTime();k&&(k.rotation.y=Math.sin(C*.5)*(Math.PI/4),k.position.y=Math.sin(C*.25)*2);const w=l.current;L.forEach(V=>{if(V.material){const J=w?V.userData.targetOpacity:0;V.material.opacity+=(J-V.material.opacity)*.05,V.material.transparent=!0}}),g.render()};return P(),()=>{i.current&&m.domElement&&i.current.removeChild(m.domElement),m.dispose(),g.dispose()}},[]),me.jsx("div",{ref:i,className:"flex items-center justify-center pointer-events-none",style:{width:"25vmax",height:"25vmax",maxWidth:"400px",maxHeight:"400px",...o}})},yR=({progress:o})=>{const i=Math.min(window.innerWidth,window.innerHeight)*.4,s=2,l=(i-s)/2,u=2*Math.PI*l,h=u-o/100*u;return me.jsxs("svg",{width:i,height:i,className:"transform -rotate-90",children:[me.jsx("circle",{cx:i/2,cy:i/2,r:l,fill:"none",stroke:pe.colors.background,strokeWidth:s,opacity:"0.3"}),me.jsx("circle",{cx:i/2,cy:i/2,r:l,fill:"none",stroke:"url(#gradient)",strokeWidth:s,strokeLinecap:"round",strokeDasharray:u,strokeDashoffset:h,style:{transition:"stroke-dashoffset 0.3s ease"}}),me.jsx("defs",{children:me.jsxs("linearGradient",{id:"gradient",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[me.jsx("stop",{offset:"0%",stopColor:pe.colors.primary}),me.jsx("stop",{offset:"50%",stopColor:pe.colors.secondary}),me.jsx("stop",{offset:"100%",stopColor:pe.colors.accent})]})})]})},MR=({progress:o,message:t,onComplete:i,startLoading:s})=>{const[l,u]=Jt.useState(!1),[h,d]=Jt.useState(!1),[m,p]=Jt.useState(!1),[_,g]=Jt.useState(!1),[x,M]=Jt.useState("translateY(0)"),[b,T]=Jt.useState(!1);Jt.useEffect(()=>(gc=()=>{T(!0)},u(!0),()=>{gc=null}),[]),Jt.useEffect(()=>{b&&setTimeout(()=>{d(!0),s()},pe.animations.logoFadeIn+pe.animations.delayBeforeElements)},[b,s]),Jt.useEffect(()=>{o>=100&&setTimeout(()=>p(!0),700)},[o]);const y=()=>{g(!0),setTimeout(()=>{M("translateY(-150vh)"),setTimeout(()=>{i()},pe.animations.logoMoveUp)},200)};return me.jsx("div",{className:"fixed inset-0 flex items-center justify-center z-50 overflow-hidden",style:{backgroundColor:pe.colors.background},children:me.jsxs("div",{className:"flex flex-col items-center gap-[2vmin] relative",children:[me.jsxs("div",{className:"font-bold tracking-wider transition-all duration-500 relative z-20",style:{color:pe.colors.text,fontSize:"clamp(1rem, 4.5vmin, 2rem)",opacity:h&&!m&&!_?1:0,transform:m?"scale(0.8)":"scale(1)"},children:[o,"%"]}),me.jsxs("div",{className:"relative flex items-center justify-center",children:[me.jsx("div",{className:"absolute transition-all flex items-center justify-center z-0",style:{opacity:l?1:0,transform:`${x} ${m&&!_?"scale(1.1)":"scale(1)"}`,transition:_?`transform ${pe.animations.logoMoveUp}ms ease-in-out, opacity 500ms ease-out`:"opacity 500ms ease-in-out, transform 800ms cubic-bezier(0.4, 0, 0.2, 1)"},children:me.jsx(SR,{showBackground:h})}),me.jsx("div",{className:"transition-all duration-500 relative z-10",style:{opacity:h&&!m&&!_?1:0,transform:m?"scale(1.1)":"scale(1)"},children:me.jsx(yR,{progress:o})})]}),me.jsxs("div",{className:"relative w-full flex justify-center",style:{height:"4vmin",minHeight:"1vmin"},children:[me.jsx("div",{className:"absolute font-medium tracking-wide transition-opacity duration-500 pointer-events-none",style:{color:pe.colors.text,fontSize:"clamp(0.75rem, 3.25vmin, 1.5rem)",opacity:h&&!m&&!_?1:0,animation:h&&!m&&!_?"pulse 2s infinite":"none"},children:t}),me.jsx("button",{onClick:y,className:`
              ...
              group
            `,style:{fontSize:"clamp(0.1rem, 4vmin, 1.4rem)",padding:"clamp(0.35rem, 1.375vmin, 1.375rem) clamp(2rem, 7.75vmin, 7.75rem)",opacity:m&&!_?1:0,transform:m&&!_?"translateY(-0.75vmin)":"translateY(2vmin)",pointerEvents:m&&!_?"auto":"none",borderColor:pe.colors.primary,backgroundColor:"transparent",color:pe.colors.primary},onMouseEnter:v=>{v.currentTarget.style.transition="all 0.15s ease-out allow-discrete",v.currentTarget.style.backgroundColor=pe.colors.primary,v.currentTarget.style.color=pe.colors.background,v.currentTarget.style.borderColor="transparent"},onMouseLeave:v=>{v.currentTarget.style.transition="all 0.45s ease-out allow-discrete",v.currentTarget.style.backgroundColor="transparent",v.currentTarget.style.color=pe.colors.primary,v.currentTarget.style.borderColor=pe.colors.primary},children:"Start"})]})]})})},ER=({social:o})=>(console.log("Loading social icon:",o.name,"from:",o.icon),me.jsx(xR,{id:o.name,children:me.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",className:"block p-2",title:o.name,children:me.jsx("img",{src:o.icon,alt:o.name,className:"w-[1.625vmax] h-[1.625vmax] min-w-[5px] min-h-[5px] max-w-[26px] max-h-[26px] invert",onLoad:()=>console.log("Social icon loaded successfully:",o.name,o.icon),onError:t=>console.error("Failed to load social icon:",o.name,o.icon,t)})})})),bR=()=>me.jsx("div",{className:"fixed bottom-[11.5vmin] left-[8vmin] flex flex-col gap-[4.75vmin] z-50",children:pe.socials.map(o=>me.jsx(ER,{social:o},o.name))}),TR=({isVisible:o,onMusicToggle:t,isPlaying:i})=>{const s=Jt.useRef(null),l=Jt.useRef({x:-100,y:-100}),{activeMagneticId:u,setActiveMagneticId:h,followerPos:d,musicButtonRect:m}=Jt.useContext(Mc);return Jt.useEffect(()=>{const p=_=>{l.current={x:_.clientX,y:_.clientY}};return window.addEventListener("mousemove",p),()=>window.removeEventListener("mousemove",p)},[]),Jt.useEffect(()=>{const p=()=>{s.current&&(m.current=s.current.getBoundingClientRect())};return p(),window.addEventListener("resize",p),window.addEventListener("scroll",p),()=>{window.removeEventListener("resize",p),window.removeEventListener("scroll",p)}},[m,o]),Jt.useEffect(()=>{if(!s.current)return;let p;const _=()=>{if(!s.current){p=requestAnimationFrame(_);return}m.current=s.current.getBoundingClientRect();const g=m.current,x=g.left+g.width/2,M=g.top+g.height/2,b=l.current.x,T=l.current.y,y=Math.hypot(b-x,T-M),v=Math.min(window.innerWidth,window.innerHeight)*.05,U="music-button";y<v?u!==U&&h(U):u===U&&h(null),p=requestAnimationFrame(_)};return _(),()=>cancelAnimationFrame(p)},[u,h,m,o]),me.jsxs("div",{className:"min-h-screen p-8 transition-opacity",style:{backgroundColor:pe.colors.background,opacity:o?1:0,transitionDuration:`${pe.animations.contentFadeIn}ms`},children:[me.jsx(vR,{}),me.jsx(bR,{}),o&&me.jsx("button",{ref:s,onClick:t,className:"fixed top-[8vmin] right-[8vmin] rounded-full backdrop-blur-sm transition-all hover:scale-110 active:scale-95 z-50 shadow-lg flex items-center justify-center",style:{backgroundColor:`${pe.colors.primary}40`,border:`2px solid ${pe.colors.primary}`,width:"clamp(45px, 8vmin, 100px)",height:"clamp(45px, 8vmin, 100px)",padding:0},children:i?me.jsx(eR,{size:"1.5vmax",style:{color:pe.colors.text,minWidth:"16px",minHeight:"20px"}}):me.jsx(iR,{size:"1.5vmax",style:{color:pe.colors.text,minWidth:"16px",minHeight:"20px"}})})]})};function AR(){const[o,t]=Jt.useState(0),[i,s]=Jt.useState(0),[l,u]=Jt.useState(!0),[h,d]=Jt.useState(!1),[m,p]=Jt.useState(!1),[_,g]=Jt.useState(!1),[x,M]=Jt.useState(null),b=Jt.useRef({x:-100,y:-100}),T=Jt.useRef(null),y=Jt.useRef(null),v=Jt.useRef(-1),U=Jt.useRef(null),L=(B,O)=>{if(!y.current)return;U.current&&clearInterval(U.current);const P=B?pe.music.volume:0,k=y.current.volume,C=25,w=pe.music.fadeDuration/C,V=(P-k)/C;let J=0;U.current=setInterval(()=>{J++;const it=k+V*J;y.current&&(y.current.volume=Math.max(0,Math.min(1,it))),J>=C&&(clearInterval(U.current),U.current=null,O&&O())},w)},D=()=>{if(pe.music.playlist.length===0)return;let B;do B=Math.floor(Math.random()*pe.music.playlist.length);while(B===v.current&&pe.music.playlist.length>1);v.current=B;const O=pe.music.playlist[B];console.log("Loading music file:",O),y.current&&(y.current.src=O,y.current.load())};return Jt.useEffect(()=>(pe.music.playlist.length>0&&(console.log("Initializing music player with playlist:",pe.music.playlist),y.current=new Audio,y.current.volume=0,y.current.addEventListener("ended",()=>{D(),y.current.volume=0,y.current.play().then(()=>L(!0)).catch(()=>g(!1))}),y.current.addEventListener("error",B=>{console.error("Audio loading error:",B,"Current src:",y.current?.src)}),y.current.addEventListener("canplay",()=>{console.log("Audio can play:",y.current?.src)}),D()),()=>{U.current&&clearInterval(U.current),y.current&&(y.current.pause(),y.current=null)}),[]),Jt.useEffect(()=>{h&&y.current&&(y.current.volume=0,y.current.play().then(()=>{g(!0),L(!0)}).catch(B=>{console.log("Auto-play prevented:",B),g(!1)}))},[h]),Jt.useEffect(()=>{if(!m)return;const B=pe.loading.duration,O=50,k=100/(B/O),C=setInterval(()=>{t(w=>{const V=Math.min(w+k,100),J=Math.floor(V/100*pe.loading.messages.length);return s(Math.min(J,pe.loading.messages.length-1)),V>=100&&clearInterval(C),V})},O);return()=>clearInterval(C)},[m]),me.jsx(Mc.Provider,{value:{activeMagneticId:x,setActiveMagneticId:M,followerPos:b,musicButtonRect:T},children:me.jsxs("div",{className:"relative",style:{backgroundColor:pe.colors.background},children:[l&&me.jsx(MR,{progress:Math.round(o),message:pe.loading.messages[i],onComplete:()=>{u(!1),d(!0)},startLoading:()=>p(!0)}),me.jsx(TR,{isVisible:h,onMusicToggle:()=>{_?(L(!1,()=>y.current.pause()),g(!1)):(y.current.volume=0,y.current.play().then(()=>{L(!0),g(!0)}))},isPlaying:_})]})})}Ty.createRoot(document.getElementById("root")).render(me.jsx(Jt.StrictMode,{children:me.jsx(AR,{})}));
